...
public class RastreioHivAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public RastreioHivAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO rastreio_hiv_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		RastreioHivAuxSrcQueryDsQueryResultVO copy = new RastreioHivAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "rastreio_hiv_aux_src_query_ds";
	}
