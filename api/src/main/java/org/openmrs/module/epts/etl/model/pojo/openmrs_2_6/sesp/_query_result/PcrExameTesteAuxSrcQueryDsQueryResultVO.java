...
public class PcrExameTesteAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public PcrExameTesteAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO pcr_exame_teste_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		PcrExameTesteAuxSrcQueryDsQueryResultVO copy = new PcrExameTesteAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "pcr_exame_teste_aux_src_query_ds";
	}
