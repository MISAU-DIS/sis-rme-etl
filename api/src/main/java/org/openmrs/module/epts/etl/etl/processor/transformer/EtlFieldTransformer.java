...
public interface EtlFieldTransformer extends EtlDataConfiguration {
	...
	FieldTransformingInfo transform(EtlProcessor processor, EtlDatabaseObject srcObject,
	...
	default void performFieldTransformation(EtlProcessor processor, EtlDatabaseObject srcObject,
		...
		if (field.isMapToNullValue()) {
			...
			try {
				fieldTransformingInfo = this.transform(processor, srcObject, transformedRecord, additionalSrcObjects,
	...
	public static Object tryToLoadDefaultValue(TransformableField transformableField,
			List<EtlDatabaseObject> srcObjects) {
		if (transformableField.getDefaultValue() != null) {
			return EtlFieldTransformer.tryToReplaceParametersOnSrcValue(
					transformableField.getTransformationTargetObject().getRelatedEtlConf(), srcObjects,
	...
	public static Object tryToReplaceParametersOnSrcValue(EtlConfiguration etlConf,
			final List<EtlDatabaseObject> srcObjects, final Object srcValue) throws EtlTransformationException {
