...
public class ProvidermanagementProviderRoleVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE providermanagement_provider_role SET `provider_role_id` = ?, `name` = ?, `description` = ?, `creator` = ?, `date_created` = ?, `changed_by` = ?, `date_changed` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `uuid` = ? WHERE providermanagement_provider_role_3.provider_role_id = ? "; 
	} 
