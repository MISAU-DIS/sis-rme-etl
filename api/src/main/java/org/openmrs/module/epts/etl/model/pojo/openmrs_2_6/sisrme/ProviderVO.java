...
public class ProviderVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String providerIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "provider_id", "_" );

		this.providerId.setValue(BaseVO.retrieveFieldValue(providerIdAttName, "INT", rs));

			String encounterRoleIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "encounter_role_id", "_" );
		...
		this.name.setValue(BaseVO.retrieveFieldValue(nameAttName, "VARCHAR", rs));
			...
			String identifierAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "identifier", "_" );
		...
		this.uuid = AttDefinedElements.removeStrangeCharactersOnString(rs.getString(uuidAttName) != null ? rs.getString(uuidAttName).trim() : null);
			...
			String providerRoleIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "provider_role_id", "_" );

		this.providerRoleId.setValue(BaseVO.retrieveFieldValue(providerRoleIdAttName, "INT", rs));

			String roleIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "role_id", "_" );

		this.roleId.setValue(BaseVO.retrieveFieldValue(roleIdAttName, "INT", rs));

	String specialityIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "speciality_id", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.encounterRoleId.getValue(), this.personId.getValue(), this.name.getValue(), this.identifier.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.providerRoleId.getValue(), this.roleId.getValue(), this.specialityId.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.providerId.getValue(), this.encounterRoleId.getValue(), this.personId.getValue(), this.name.getValue(), this.identifier.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.providerRoleId.getValue(), this.roleId.getValue(), this.specialityId.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.providerId.getValue(), this.encounterRoleId.getValue(), this.personId.getValue(), this.name.getValue(), this.identifier.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.providerRoleId.getValue(), this.roleId.getValue(), this.specialityId.getValue(), this.providerId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE provider SET `provider_id` = ?, `encounter_role_id` = ?, `person_id` = ?, `name` = ?, `identifier` = ?, `creator` = ?, `date_created` = ?, `changed_by` = ?, `date_changed` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `uuid` = ?, `provider_role_id` = ?, `role_id` = ?, `speciality_id` = ? WHERE provider_2.provider_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.encounterRoleId.getValue()) + "," + (this.personId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.identifier.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.identifier.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.providerRoleId.getValue()) + "," + (this.roleId.getValue()) + "," + (this.specialityId.getValue()); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.providerId.getValue()) + "," + (this.encounterRoleId.getValue()) + "," + (this.personId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.identifier.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.identifier.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.providerRoleId.getValue()) + "," + (this.roleId.getValue()) + "," + (this.specialityId.getValue()); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof ProviderVO){
	    	ProviderVO toCopyFromAsProviderVO = (ProviderVO)toCopyFrom;

			this.providerId = copyGeneratedField(toCopyFromAsProviderVO.providerId);
			this.encounterRoleId = copyGeneratedField(toCopyFromAsProviderVO.encounterRoleId);
			this.personId = copyGeneratedField(toCopyFromAsProviderVO.personId);
			this.name = copyGeneratedField(toCopyFromAsProviderVO.name);
			this.identifier = copyGeneratedField(toCopyFromAsProviderVO.identifier);
			this.creator = copyGeneratedField(toCopyFromAsProviderVO.creator);
			this.dateCreated = toCopyFromAsProviderVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsProviderVO.changedBy);
			this.dateChanged = toCopyFromAsProviderVO.dateChanged;
			this.retired = copyGeneratedField(toCopyFromAsProviderVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsProviderVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsProviderVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsProviderVO.retireReason);
			this.uuid = toCopyFromAsProviderVO.uuid;
			this.providerRoleId = copyGeneratedField(toCopyFromAsProviderVO.providerRoleId);
			this.roleId = copyGeneratedField(toCopyFromAsProviderVO.roleId);
	...
	public boolean hasParents() {
		if (this.roleId.getValue() != null) return true;

		if (this.specialityId.getValue() != null) return true;

		if (this.encounterRoleId.getValue() != null) return true;

		if (this.personId.getValue() != null) return true;

		if (this.providerRoleId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("roleId")) return this.roleId.getValue();		
		if (parentAttName.equals("specialityId")) return this.specialityId.getValue();		
		if (parentAttName.equals("encounterRoleId")) return this.encounterRoleId.getValue();		
		if (parentAttName.equals("personId")) return this.personId.getValue();		
		if (parentAttName.equals("providerRoleId")) return this.providerRoleId.getValue();		
