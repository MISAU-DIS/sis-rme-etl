...
public class VisitTypeVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.name.getValue(), this.description.getValue(), this.uuid, this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.visitTypeId.getValue(), this.name.getValue(), this.description.getValue(), this.uuid, this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.visitTypeId.getValue(), this.name.getValue(), this.description.getValue(), this.uuid, this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.visitTypeId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE visit_type SET `visit_type_id` = ?, `name` = ?, `description` = ?, `uuid` = ?, `creator` = ?, `date_created` = ?, `changed_by` = ?, `date_changed` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ? WHERE visit_type_5.visit_type_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue()) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.visitTypeId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue()) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof VisitTypeVO){
	    	VisitTypeVO toCopyFromAsVisitTypeVO = (VisitTypeVO)toCopyFrom;

			this.visitTypeId = copyGeneratedField(toCopyFromAsVisitTypeVO.visitTypeId);
			this.name = copyGeneratedField(toCopyFromAsVisitTypeVO.name);
			this.description = copyGeneratedField(toCopyFromAsVisitTypeVO.description);
			this.uuid = toCopyFromAsVisitTypeVO.uuid;
			this.creator = copyGeneratedField(toCopyFromAsVisitTypeVO.creator);
			this.dateCreated = toCopyFromAsVisitTypeVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsVisitTypeVO.changedBy);
			this.dateChanged = toCopyFromAsVisitTypeVO.dateChanged;
			this.retired = copyGeneratedField(toCopyFromAsVisitTypeVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsVisitTypeVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsVisitTypeVO.dateRetired);
