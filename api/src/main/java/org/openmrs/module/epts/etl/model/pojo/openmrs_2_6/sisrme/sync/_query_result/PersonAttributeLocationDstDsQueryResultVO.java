...
public class PersonAttributeLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public PersonAttributeLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO person_attribute_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		PersonAttributeLocationDstDsQueryResultVO copy = new PersonAttributeLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "person_attribute_location_dst_ds";
	}
