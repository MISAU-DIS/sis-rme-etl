...
public class ExameSegmentarAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public ExameSegmentarAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO exame_segmentar_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		ExameSegmentarAuxSrcQueryDsQueryResultVO copy = new ExameSegmentarAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "exame_segmentar_aux_src_query_ds";
	}
