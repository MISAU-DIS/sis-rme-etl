...
public class OrderGroupVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.orderGroupId.setValue(BaseVO.retrieveFieldValue(orderGroupIdAttName, "INT", rs));
			...
			String orderSetIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "order_set_id", "_" );
	...
	public String getInsertSQLWithoutObjectId(){ 
 		return "INSERT INTO order_group(`order_set_id`, `patient_id`, `encounter_id`, `creator`, `date_created`, `voided`, `voided_by`, `date_voided`, `void_reason`, `changed_by`, `date_changed`, `uuid`, `notes`) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	@Override
	public String getInsertSQLWithObjectId(){ 
 		return "INSERT INTO order_group(`order_group_id`, `order_set_id`, `patient_id`, `encounter_id`, `creator`, `date_created`, `voided`, `voided_by`, `date_voided`, `void_reason`, `changed_by`, `date_changed`, `uuid`, `notes`) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	@Override
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.orderSetId.getValue(), this.patientId.getValue(), this.encounterId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid, this.notes.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.orderGroupId.getValue(), this.orderSetId.getValue(), this.patientId.getValue(), this.encounterId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid, this.notes.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.orderGroupId.getValue(), this.orderSetId.getValue(), this.patientId.getValue(), this.encounterId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid, this.notes.getValue(), this.orderGroupId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE order_group SET `order_group_id` = ?, `order_set_id` = ?, `patient_id` = ?, `encounter_id` = ?, `creator` = ?, `date_created` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `changed_by` = ?, `date_changed` = ?, `uuid` = ?, `notes` = ? WHERE order_group_2.order_group_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.orderSetId.getValue()) + "," + (this.patientId.getValue()) + "," + (this.encounterId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.notes.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.notes.getValue().toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.orderGroupId.getValue()) + "," + (this.orderSetId.getValue()) + "," + (this.patientId.getValue()) + "," + (this.encounterId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.notes.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.notes.getValue().toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof OrderGroupVO){
	    	OrderGroupVO toCopyFromAsOrderGroupVO = (OrderGroupVO)toCopyFrom;

			this.orderGroupId = copyGeneratedField(toCopyFromAsOrderGroupVO.orderGroupId);
			this.orderSetId = copyGeneratedField(toCopyFromAsOrderGroupVO.orderSetId);
			this.patientId = copyGeneratedField(toCopyFromAsOrderGroupVO.patientId);
			this.encounterId = copyGeneratedField(toCopyFromAsOrderGroupVO.encounterId);
			this.creator = copyGeneratedField(toCopyFromAsOrderGroupVO.creator);
			this.dateCreated = toCopyFromAsOrderGroupVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsOrderGroupVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsOrderGroupVO.voidedBy);
			this.dateVoided = toCopyFromAsOrderGroupVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsOrderGroupVO.voidReason);
			this.changedBy = copyGeneratedField(toCopyFromAsOrderGroupVO.changedBy);
			this.dateChanged = toCopyFromAsOrderGroupVO.dateChanged;
			this.uuid = toCopyFromAsOrderGroupVO.uuid;
	...
	public boolean hasParents() {
		...
		if (this.orderSetId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		...
		if (parentAttName.equals("orderSetId")) return this.orderSetId.getValue();		
