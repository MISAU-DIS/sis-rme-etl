...
public class DrugOrderLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public DrugOrderLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO drug_order_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		DrugOrderLocationDstDsQueryResultVO copy = new DrugOrderLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "drug_order_location_dst_ds";
	}
