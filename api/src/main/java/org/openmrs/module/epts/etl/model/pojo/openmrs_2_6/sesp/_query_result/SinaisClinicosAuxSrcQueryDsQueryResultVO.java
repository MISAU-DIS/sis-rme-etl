...
public class SinaisClinicosAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public SinaisClinicosAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO sinais_clinicos_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		SinaisClinicosAuxSrcQueryDsQueryResultVO copy = new SinaisClinicosAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "sinais_clinicos_aux_src_query_ds";
	}
