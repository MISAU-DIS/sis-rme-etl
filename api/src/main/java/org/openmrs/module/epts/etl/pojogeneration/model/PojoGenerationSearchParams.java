...
public class PojoGenerationSearchParams extends AbstractEtlSearchParams<PojoGenerationRecord> {
	...
	@Override
	public List<PojoGenerationRecord> search(IntervalExtremeRecord intervalExtremeRecord,
	...
	@Override
	public int countAllRecords(OperationController<PojoGenerationRecord> controller, Connection conn)
			throws DBException {
		return 1;
	}

	@Override
	public synchronized int countNotProcessedRecords(OperationController<PojoGenerationRecord> controller,
			Connection conn) throws DBException {

		return processor != null && processor.isPojoGenerated() ? 0 : 1;
	}
