...
public class ProgramWorkflowStateVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String programWorkflowStateIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "program_workflow_state_id", "_" );

		this.programWorkflowStateId.setValue(BaseVO.retrieveFieldValue(programWorkflowStateIdAttName, "INT", rs));

			String programWorkflowIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "program_workflow_id", "_" );
		...
		this.conceptId.setValue(BaseVO.retrieveFieldValue(conceptIdAttName, "INT", rs));
			...
			String initialAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "initial", "_" );

		this.initial.setValue(BaseVO.retrieveFieldValue(initialAttName, "BIT", rs));

			String terminalAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "terminal", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.programWorkflowId.getValue(), this.conceptId.getValue(), this.initial.getValue(), this.terminal.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.programWorkflowStateId.getValue(), this.programWorkflowId.getValue(), this.conceptId.getValue(), this.initial.getValue(), this.terminal.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.programWorkflowStateId.getValue(), this.programWorkflowId.getValue(), this.conceptId.getValue(), this.initial.getValue(), this.terminal.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid, this.programWorkflowStateId.getValue()};
		return params; 
	} 
	...
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.programWorkflowId.getValue()) + "," + (this.conceptId.getValue()) + "," + (this.initial.getValue() != null ? "\""+this.initial.getValue()+"\"" : null) + "," + (this.terminal.getValue() != null ? "\""+this.terminal.getValue()+"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.programWorkflowStateId.getValue()) + "," + (this.programWorkflowId.getValue()) + "," + (this.conceptId.getValue()) + "," + (this.initial.getValue() != null ? "\""+this.initial.getValue()+"\"" : null) + "," + (this.terminal.getValue() != null ? "\""+this.terminal.getValue()+"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof ProgramWorkflowStateVO){
	    	ProgramWorkflowStateVO toCopyFromAsProgramWorkflowStateVO = (ProgramWorkflowStateVO)toCopyFrom;

			this.programWorkflowStateId = copyGeneratedField(toCopyFromAsProgramWorkflowStateVO.programWorkflowStateId);
			this.programWorkflowId = copyGeneratedField(toCopyFromAsProgramWorkflowStateVO.programWorkflowId);
			this.conceptId = copyGeneratedField(toCopyFromAsProgramWorkflowStateVO.conceptId);
			this.initial = copyGeneratedField(toCopyFromAsProgramWorkflowStateVO.initial);
			this.terminal = copyGeneratedField(toCopyFromAsProgramWorkflowStateVO.terminal);
			this.creator = copyGeneratedField(toCopyFromAsProgramWorkflowStateVO.creator);
			this.dateCreated = toCopyFromAsProgramWorkflowStateVO.dateCreated;
			this.retired = copyGeneratedField(toCopyFromAsProgramWorkflowStateVO.retired);
			this.changedBy = copyGeneratedField(toCopyFromAsProgramWorkflowStateVO.changedBy);
			this.dateChanged = toCopyFromAsProgramWorkflowStateVO.dateChanged;
	...
	public boolean hasParents() {
		...
		if (this.programWorkflowId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		...
		if (parentAttName.equals("programWorkflowId")) return this.programWorkflowId.getValue();		
