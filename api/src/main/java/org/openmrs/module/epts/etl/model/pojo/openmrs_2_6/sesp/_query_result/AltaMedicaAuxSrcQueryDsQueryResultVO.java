...
public class AltaMedicaAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public AltaMedicaAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO alta_medica_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		AltaMedicaAuxSrcQueryDsQueryResultVO copy = new AltaMedicaAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "alta_medica_aux_src_query_ds";
	}
