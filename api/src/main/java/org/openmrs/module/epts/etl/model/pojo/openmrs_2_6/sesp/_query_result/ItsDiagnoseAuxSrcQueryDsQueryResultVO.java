...
public class ItsDiagnoseAuxSrcQueryDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	private Field value = Field.fastCreateWithType("value", "BIGINT");
 
	private EtlDatabaseObjectConfiguration relatedConfiguration;

	public ItsDiagnoseAuxSrcQueryDsQueryResultVO() { 
		this.metadata = false;
	} 
...
String valueAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value", "_" );
	...
	public String getInsertSQLWithoutObjectId(){ 
 		return "INSERT INTO its_diagnose_aux_src_query_ds(`value`) VALUES( ?);"; 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof ItsDiagnoseAuxSrcQueryDsQueryResultVO){
	    	ItsDiagnoseAuxSrcQueryDsQueryResultVO toCopyFromAsItsDiagnoseAuxSrcQueryDsQueryResultVO = (ItsDiagnoseAuxSrcQueryDsQueryResultVO)toCopyFrom;
	...
	public String generateTableName() {
		return "its_diagnose_aux_src_query_ds";
	}
