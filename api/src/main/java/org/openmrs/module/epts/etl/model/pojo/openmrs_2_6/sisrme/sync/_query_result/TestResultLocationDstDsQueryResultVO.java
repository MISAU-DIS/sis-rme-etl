...
public class TestResultLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public TestResultLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO test_result_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		TestResultLocationDstDsQueryResultVO copy = new TestResultLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "test_result_location_dst_ds";
	}
