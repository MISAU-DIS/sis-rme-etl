...
public class PersonAddressLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public PersonAddressLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO person_address_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		PersonAddressLocationDstDsQueryResultVO copy = new PersonAddressLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "person_address_location_dst_ds";
	}
