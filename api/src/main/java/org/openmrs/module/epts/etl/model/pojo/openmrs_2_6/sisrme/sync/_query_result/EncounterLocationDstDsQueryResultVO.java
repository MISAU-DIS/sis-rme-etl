...
public class EncounterLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public EncounterLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO encounter_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		EncounterLocationDstDsQueryResultVO copy = new EncounterLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "encounter_location_dst_ds";
	}
