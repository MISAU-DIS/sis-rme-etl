...
public class EncounterDiagnosisLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public EncounterDiagnosisLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO encounter_diagnosis_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		EncounterDiagnosisLocationDstDsQueryResultVO copy = new EncounterDiagnosisLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "encounter_diagnosis_location_dst_ds";
	}
