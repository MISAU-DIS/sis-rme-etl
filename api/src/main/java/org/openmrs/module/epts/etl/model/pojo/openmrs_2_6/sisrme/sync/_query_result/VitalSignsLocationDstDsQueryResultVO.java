...
public class VitalSignsLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public VitalSignsLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO vital_signs_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		VitalSignsLocationDstDsQueryResultVO copy = new VitalSignsLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "vital_signs_location_dst_ds";
	}
