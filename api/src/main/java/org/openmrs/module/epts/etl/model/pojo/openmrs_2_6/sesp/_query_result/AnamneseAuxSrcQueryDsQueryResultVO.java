...
public class AnamneseAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public AnamneseAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO anamnese_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		AnamneseAuxSrcQueryDsQueryResultVO copy = new AnamneseAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "anamnese_aux_src_query_ds";
	}
