...
public class PharmacyDeliveryNoteVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		String transactionDateAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "transaction_date", "_" );
...
String voidedByAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "voided_by", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.uuid, this.documentNumber.getValue(), this.origin.getValue(), this.locationId.getValue(), this.transactionDate.getValue(), this.subscriber.getValue(), this.notes.getValue(), this.creator.getValue(), this.dateCreated, this.dateChanged, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.deliveryNoteId.getValue(), this.uuid, this.documentNumber.getValue(), this.origin.getValue(), this.locationId.getValue(), this.transactionDate.getValue(), this.subscriber.getValue(), this.notes.getValue(), this.creator.getValue(), this.dateCreated, this.dateChanged, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.deliveryNoteId.getValue(), this.uuid, this.documentNumber.getValue(), this.origin.getValue(), this.locationId.getValue(), this.transactionDate.getValue(), this.subscriber.getValue(), this.notes.getValue(), this.creator.getValue(), this.dateCreated, this.dateChanged, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.deliveryNoteId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE pharmacy_delivery_note SET `delivery_note_id` = ?, `uuid` = ?, `document_number` = ?, `origin` = ?, `location_id` = ?, `transaction_date` = ?, `subscriber` = ?, `notes` = ?, `creator` = ?, `date_created` = ?, `date_changed` = ?, `voided` = ?, `void_reason` = ?, `voided_by` = ? WHERE pharmacy_delivery_note_1.delivery_note_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.documentNumber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.documentNumber.getValue().toString())  +"\"" : null) + "," + (this.origin.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.origin.getValue().toString())  +"\"" : null) + "," + (this.locationId.getValue()) + "," + (this.transactionDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.transactionDate.getValue())  +"\"" : null) + "," + (this.subscriber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.subscriber.getValue().toString())  +"\"" : null) + "," + (this.notes.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.notes.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.voidedBy.getValue()); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.deliveryNoteId.getValue()) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.documentNumber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.documentNumber.getValue().toString())  +"\"" : null) + "," + (this.origin.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.origin.getValue().toString())  +"\"" : null) + "," + (this.locationId.getValue()) + "," + (this.transactionDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.transactionDate.getValue())  +"\"" : null) + "," + (this.subscriber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.subscriber.getValue().toString())  +"\"" : null) + "," + (this.notes.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.notes.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.voidedBy.getValue()); 
	} 
	...
	public EtlDatabaseObject createACopy(){ 
		...
		copy.transactionDate = copyGeneratedField(this.transactionDate);
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PharmacyDeliveryNoteVO){
	    	PharmacyDeliveryNoteVO toCopyFromAsPharmacyDeliveryNoteVO = (PharmacyDeliveryNoteVO)toCopyFrom;

			this.deliveryNoteId = copyGeneratedField(toCopyFromAsPharmacyDeliveryNoteVO.deliveryNoteId);
			this.uuid = toCopyFromAsPharmacyDeliveryNoteVO.uuid;
			this.documentNumber = copyGeneratedField(toCopyFromAsPharmacyDeliveryNoteVO.documentNumber);
			this.origin = copyGeneratedField(toCopyFromAsPharmacyDeliveryNoteVO.origin);
			this.locationId = copyGeneratedField(toCopyFromAsPharmacyDeliveryNoteVO.locationId);
			this.transactionDate = copyGeneratedField(toCopyFromAsPharmacyDeliveryNoteVO.transactionDate);
			this.subscriber = copyGeneratedField(toCopyFromAsPharmacyDeliveryNoteVO.subscriber);
			this.notes = copyGeneratedField(toCopyFromAsPharmacyDeliveryNoteVO.notes);
			this.creator = copyGeneratedField(toCopyFromAsPharmacyDeliveryNoteVO.creator);
			this.dateCreated = toCopyFromAsPharmacyDeliveryNoteVO.dateCreated;
			this.dateChanged = toCopyFromAsPharmacyDeliveryNoteVO.dateChanged;
			this.voided = copyGeneratedField(toCopyFromAsPharmacyDeliveryNoteVO.voided);
			this.voidReason = copyGeneratedField(toCopyFromAsPharmacyDeliveryNoteVO.voidReason);
