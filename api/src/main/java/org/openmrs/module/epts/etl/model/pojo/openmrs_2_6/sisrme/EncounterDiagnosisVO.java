...
public class EncounterDiagnosisVO extends AbstractGeneratedDatabaseObject {
	...
	public void setFieldValue(String fieldName, Object value) {
		...
		if (utilities.equalsFieldsName(fieldName, "diagnosis_coded")) {
			this.diagnosisCoded.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "diagnosis_non_coded")) {
			this.diagnosisNonCoded.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "diagnosis_coded_name")) {
		...
		if (utilities.equalsFieldsName(fieldName, "certainty")) {
			this.certainty.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "rank")) {
			this.rank.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "creator")) {
	...
	public void loadWithDefaultValues(Connection srcConn, Connection dstConn) throws DBException {
		...
		loadGeneratedFieldWithDefaultValue(this.certainty, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.rank, srcConn, dstConn);
