...
public class EncounterTypeVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.viewPrivilege.getValue(), this.editPrivilege.getValue(), this.changedBy.getValue(), this.dateChanged};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterTypeId.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.viewPrivilege.getValue(), this.editPrivilege.getValue(), this.changedBy.getValue(), this.dateChanged, this.encounterTypeId.getValue()};
		return params; 
	} 
