...
public class VitalSignsVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		String vitalSignsIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "vital_signs_id", "_" );
		...
		String temperatureAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "temperature", "_" );

		this.temperature.setValue(BaseVO.retrieveFieldValue(temperatureAttName, "DECIMAL", rs));

		String bloodPressureSystolicAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "blood_pressure_systolic", "_" );

		this.bloodPressureSystolic.setValue(BaseVO.retrieveFieldValue(bloodPressureSystolicAttName, "INT", rs));

		String bloodPressureDiastolicAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "blood_pressure_diastolic", "_" );
...
String uuidAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "uuid", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.patientId.getValue(), this.encounterId.getValue(), this.locationId.getValue(), this.temperature.getValue(), this.bloodPressureSystolic.getValue(), this.bloodPressureDiastolic.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.voidReason.getValue(), this.dateVoided, this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.vitalSignsId.getValue(), this.patientId.getValue(), this.encounterId.getValue(), this.locationId.getValue(), this.temperature.getValue(), this.bloodPressureSystolic.getValue(), this.bloodPressureDiastolic.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.voidReason.getValue(), this.dateVoided, this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.vitalSignsId.getValue(), this.patientId.getValue(), this.encounterId.getValue(), this.locationId.getValue(), this.temperature.getValue(), this.bloodPressureSystolic.getValue(), this.bloodPressureDiastolic.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.voidReason.getValue(), this.dateVoided, this.uuid, this.vitalSignsId.getValue()};
		return params; 
	} 
	...
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.patientId.getValue()) + "," + (this.encounterId.getValue()) + "," + (this.locationId.getValue()) + "," + (this.temperature.getValue()) + "," + (this.bloodPressureSystolic.getValue()) + "," + (this.bloodPressureDiastolic.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.vitalSignsId.getValue()) + "," + (this.patientId.getValue()) + "," + (this.encounterId.getValue()) + "," + (this.locationId.getValue()) + "," + (this.temperature.getValue()) + "," + (this.bloodPressureSystolic.getValue()) + "," + (this.bloodPressureDiastolic.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof VitalSignsVO){
	    	VitalSignsVO toCopyFromAsVitalSignsVO = (VitalSignsVO)toCopyFrom;

			this.vitalSignsId = copyGeneratedField(toCopyFromAsVitalSignsVO.vitalSignsId);
			this.patientId = copyGeneratedField(toCopyFromAsVitalSignsVO.patientId);
			this.encounterId = copyGeneratedField(toCopyFromAsVitalSignsVO.encounterId);
			this.locationId = copyGeneratedField(toCopyFromAsVitalSignsVO.locationId);
			this.temperature = copyGeneratedField(toCopyFromAsVitalSignsVO.temperature);
			this.bloodPressureSystolic = copyGeneratedField(toCopyFromAsVitalSignsVO.bloodPressureSystolic);
			this.bloodPressureDiastolic = copyGeneratedField(toCopyFromAsVitalSignsVO.bloodPressureDiastolic);
			this.creator = copyGeneratedField(toCopyFromAsVitalSignsVO.creator);
			this.dateCreated = toCopyFromAsVitalSignsVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsVitalSignsVO.changedBy);
			this.dateChanged = toCopyFromAsVitalSignsVO.dateChanged;
			this.voided = copyGeneratedField(toCopyFromAsVitalSignsVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsVitalSignsVO.voidedBy);
			this.voidReason = copyGeneratedField(toCopyFromAsVitalSignsVO.voidReason);
			this.dateVoided = toCopyFromAsVitalSignsVO.dateVoided;
