...
public class SaudeReprodutivaAuxSrcQueryDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	private EtlDatabaseObjectConfiguration relatedConfiguration;

	public SaudeReprodutivaAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	}
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO saude_reprodutiva_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom) {
		if (toCopyFrom instanceof SaudeReprodutivaAuxSrcQueryDsQueryResultVO) {
			SaudeReprodutivaAuxSrcQueryDsQueryResultVO toCopyFromAsSaudeReprodutivaAuxSrcQueryDsQueryResultVO = (SaudeReprodutivaAuxSrcQueryDsQueryResultVO) toCopyFrom;
	...
	public String generateTableName() {
		return "saude_reprodutiva_aux_src_query_ds";
	}
