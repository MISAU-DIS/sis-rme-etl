...
public class DateFieldTransformer extends AbstractEtlFieldTransformer {
	...
	public DateFieldTransformer(List<Object> parameters, EtlTransformTarget relatedEtlTargedConf,
	...
	private Date parseDate(String value) throws ParseException {
		...
		if (inputFormat == null) {
			throw new EtlExceptionImpl("Unable to determine the date input_format for value '" + value
					+ "'. Please define the input_format manualy.");
		}
