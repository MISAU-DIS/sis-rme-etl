...
public class ConsultaInicialAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public ConsultaInicialAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO consulta_inicial_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		ConsultaInicialAuxSrcQueryDsQueryResultVO copy = new ConsultaInicialAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "consulta_inicial_aux_src_query_ds";
	}
