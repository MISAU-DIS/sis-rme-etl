...
public interface MainJoiningEntity extends TableConfiguration {
	...
	/**
	 * Tells whether this main join entity is also joinable or not. Example of known
	 * main joinable entities are {@link AuxExtractTable}
	 * 
	 * @return
	 */
	Boolean isJoinable();
	 ...
	 * @throws ForbiddenOperationException if this main joining entity is not
	 *                                     joinable
	 */
