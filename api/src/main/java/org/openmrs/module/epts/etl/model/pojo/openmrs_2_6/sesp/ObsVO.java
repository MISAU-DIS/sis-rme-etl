...
public class ObsVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String obsIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "obs_id", "_" );

		this.obsId.setValue(BaseVO.retrieveFieldValue(obsIdAttName, "INT", rs));

			String personIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "person_id", "_" );
		...
		this.orderId.setValue(BaseVO.retrieveFieldValue(orderIdAttName, "INT", rs));
			...
			String obsDatetimeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "obs_datetime", "_" );
		...
		this.locationId.setValue(BaseVO.retrieveFieldValue(locationIdAttName, "INT", rs));
			...
			String obsGroupIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "obs_group_id", "_" );
		...
		this.accessionNumber.setValue(BaseVO.retrieveFieldValue(accessionNumberAttName, "VARCHAR", rs));
			...
			String valueGroupIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value_group_id", "_" );

		this.valueGroupId.setValue(BaseVO.retrieveFieldValue(valueGroupIdAttName, "INT", rs));

			String valueCodedAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value_coded", "_" );

		this.valueCoded.setValue(BaseVO.retrieveFieldValue(valueCodedAttName, "INT", rs));

			String valueCodedNameIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value_coded_name_id", "_" );

		this.valueCodedNameId.setValue(BaseVO.retrieveFieldValue(valueCodedNameIdAttName, "INT", rs));

			String valueDrugAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value_drug", "_" );

		this.valueDrug.setValue(BaseVO.retrieveFieldValue(valueDrugAttName, "INT", rs));

			String valueDatetimeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value_datetime", "_" );

		this.valueDatetime.setValue(BaseVO.retrieveFieldValue(valueDatetimeAttName, "DATETIME", rs));

			String valueNumericAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value_numeric", "_" );

		this.valueNumeric.setValue(BaseVO.retrieveFieldValue(valueNumericAttName, "DOUBLE", rs));

			String valueModifierAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value_modifier", "_" );

		this.valueModifier.setValue(BaseVO.retrieveFieldValue(valueModifierAttName, "VARCHAR", rs));

			String valueTextAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value_text", "_" );

		this.valueText.setValue(BaseVO.retrieveFieldValue(valueTextAttName, "TEXT", rs));

			String commentsAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "comments", "_" );
		...
		this.voidReason.setValue(BaseVO.retrieveFieldValue(voidReasonAttName, "VARCHAR", rs));
			...
			String valueComplexAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value_complex", "_" );
		...
		this.uuid = AttDefinedElements.removeStrangeCharactersOnString(rs.getString(uuidAttName) != null ? rs.getString(uuidAttName).trim() : null);
			...
			String previousVersionAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "previous_version", "_" );

		this.previousVersion.setValue(BaseVO.retrieveFieldValue(previousVersionAttName, "INT", rs));

			String formNamespaceAndPathAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "form_namespace_and_path", "_" );

		this.formNamespaceAndPath.setValue(BaseVO.retrieveFieldValue(formNamespaceAndPathAttName, "VARCHAR", rs));

			String statusAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "status", "_" );

		this.status.setValue(BaseVO.retrieveFieldValue(statusAttName, "VARCHAR", rs));

	String interpretationAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "interpretation", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.personId.getValue(), this.conceptId.getValue(), this.encounterId.getValue(), this.orderId.getValue(), this.obsDatetime.getValue(), this.locationId.getValue(), this.obsGroupId.getValue(), this.accessionNumber.getValue(), this.valueGroupId.getValue(), this.valueCoded.getValue(), this.valueCodedNameId.getValue(), this.valueDrug.getValue(), this.valueDatetime.getValue(), this.valueNumeric.getValue(), this.valueModifier.getValue(), this.valueText.getValue(), this.comments.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.valueComplex.getValue(), this.uuid, this.previousVersion.getValue(), this.formNamespaceAndPath.getValue(), this.status.getValue(), this.interpretation.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.obsId.getValue(), this.personId.getValue(), this.conceptId.getValue(), this.encounterId.getValue(), this.orderId.getValue(), this.obsDatetime.getValue(), this.locationId.getValue(), this.obsGroupId.getValue(), this.accessionNumber.getValue(), this.valueGroupId.getValue(), this.valueCoded.getValue(), this.valueCodedNameId.getValue(), this.valueDrug.getValue(), this.valueDatetime.getValue(), this.valueNumeric.getValue(), this.valueModifier.getValue(), this.valueText.getValue(), this.comments.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.valueComplex.getValue(), this.uuid, this.previousVersion.getValue(), this.formNamespaceAndPath.getValue(), this.status.getValue(), this.interpretation.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE obs SET `obs_id` = ?, `person_id` = ?, `concept_id` = ?, `encounter_id` = ?, `order_id` = ?, `obs_datetime` = ?, `location_id` = ?, `obs_group_id` = ?, `accession_number` = ?, `value_group_id` = ?, `value_coded` = ?, `value_coded_name_id` = ?, `value_drug` = ?, `value_datetime` = ?, `value_numeric` = ?, `value_modifier` = ?, `value_text` = ?, `comments` = ?, `creator` = ?, `date_created` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `value_complex` = ?, `uuid` = ?, `previous_version` = ?, `form_namespace_and_path` = ?, `status` = ?, `interpretation` = ? WHERE prep_data_proxima_consulta_obs_src_ds.obs_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.personId.getValue()) + "," + (this.conceptId.getValue()) + "," + (this.encounterId.getValue()) + "," + (this.orderId.getValue()) + "," + (this.obsDatetime.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.obsDatetime.getValue())  +"\"" : null) + "," + (this.locationId.getValue()) + "," + (this.obsGroupId.getValue()) + "," + (this.accessionNumber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.accessionNumber.getValue().toString())  +"\"" : null) + "," + (this.valueGroupId.getValue()) + "," + (this.valueCoded.getValue()) + "," + (this.valueCodedNameId.getValue()) + "," + (this.valueDrug.getValue()) + "," + (this.valueDatetime.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.valueDatetime.getValue())  +"\"" : null) + "," + (this.valueNumeric.getValue()) + "," + (this.valueModifier.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueModifier.getValue().toString())  +"\"" : null) + "," + (this.valueText.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueText.getValue().toString())  +"\"" : null) + "," + (this.comments.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.comments.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.valueComplex.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueComplex.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.previousVersion.getValue()) + "," + (this.formNamespaceAndPath.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.formNamespaceAndPath.getValue().toString())  +"\"" : null) + "," + (this.status.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.status.getValue().toString())  +"\"" : null) + "," + (this.interpretation.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.interpretation.getValue().toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.obsId.getValue()) + "," + (this.personId.getValue()) + "," + (this.conceptId.getValue()) + "," + (this.encounterId.getValue()) + "," + (this.orderId.getValue()) + "," + (this.obsDatetime.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.obsDatetime.getValue())  +"\"" : null) + "," + (this.locationId.getValue()) + "," + (this.obsGroupId.getValue()) + "," + (this.accessionNumber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.accessionNumber.getValue().toString())  +"\"" : null) + "," + (this.valueGroupId.getValue()) + "," + (this.valueCoded.getValue()) + "," + (this.valueCodedNameId.getValue()) + "," + (this.valueDrug.getValue()) + "," + (this.valueDatetime.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.valueDatetime.getValue())  +"\"" : null) + "," + (this.valueNumeric.getValue()) + "," + (this.valueModifier.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueModifier.getValue().toString())  +"\"" : null) + "," + (this.valueText.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueText.getValue().toString())  +"\"" : null) + "," + (this.comments.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.comments.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.valueComplex.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueComplex.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.previousVersion.getValue()) + "," + (this.formNamespaceAndPath.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.formNamespaceAndPath.getValue().toString())  +"\"" : null) + "," + (this.status.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.status.getValue().toString())  +"\"" : null) + "," + (this.interpretation.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.interpretation.getValue().toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof ObsVO){
	    	ObsVO toCopyFromAsObsVO = (ObsVO)toCopyFrom;

			this.obsId = copyGeneratedField(toCopyFromAsObsVO.obsId);
			this.personId = copyGeneratedField(toCopyFromAsObsVO.personId);
			this.conceptId = copyGeneratedField(toCopyFromAsObsVO.conceptId);
			this.encounterId = copyGeneratedField(toCopyFromAsObsVO.encounterId);
			this.orderId = copyGeneratedField(toCopyFromAsObsVO.orderId);
			this.obsDatetime = copyGeneratedField(toCopyFromAsObsVO.obsDatetime);
			this.locationId = copyGeneratedField(toCopyFromAsObsVO.locationId);
			this.obsGroupId = copyGeneratedField(toCopyFromAsObsVO.obsGroupId);
			this.accessionNumber = copyGeneratedField(toCopyFromAsObsVO.accessionNumber);
			this.valueGroupId = copyGeneratedField(toCopyFromAsObsVO.valueGroupId);
			this.valueCoded = copyGeneratedField(toCopyFromAsObsVO.valueCoded);
			this.valueCodedNameId = copyGeneratedField(toCopyFromAsObsVO.valueCodedNameId);
			this.valueDrug = copyGeneratedField(toCopyFromAsObsVO.valueDrug);
			this.valueDatetime = copyGeneratedField(toCopyFromAsObsVO.valueDatetime);
			this.valueNumeric = copyGeneratedField(toCopyFromAsObsVO.valueNumeric);
			this.valueModifier = copyGeneratedField(toCopyFromAsObsVO.valueModifier);
			this.valueText = copyGeneratedField(toCopyFromAsObsVO.valueText);
			this.comments = copyGeneratedField(toCopyFromAsObsVO.comments);
			this.creator = copyGeneratedField(toCopyFromAsObsVO.creator);
			this.dateCreated = toCopyFromAsObsVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsObsVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsObsVO.voidedBy);
			this.dateVoided = toCopyFromAsObsVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsObsVO.voidReason);
			this.valueComplex = copyGeneratedField(toCopyFromAsObsVO.valueComplex);
			this.uuid = toCopyFromAsObsVO.uuid;
			this.previousVersion = copyGeneratedField(toCopyFromAsObsVO.previousVersion);
			this.formNamespaceAndPath = copyGeneratedField(toCopyFromAsObsVO.formNamespaceAndPath);
			this.status = copyGeneratedField(toCopyFromAsObsVO.status);
	...
	public boolean hasParents() {
		if (this.valueCoded.getValue() != null) return true;

		if (this.conceptId.getValue() != null) return true;

		if (this.valueCodedNameId.getValue() != null) return true;

		if (this.valueDrug.getValue() != null) return true;

		if (this.encounterId.getValue() != null) return true;

		if (this.locationId.getValue() != null) return true;

		if (this.obsGroupId.getValue() != null) return true;

		if (this.previousVersion.getValue() != null) return true;

		if (this.orderId.getValue() != null) return true;

		if (this.personId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("valueCoded")) return this.valueCoded.getValue();		
		if (parentAttName.equals("conceptId")) return this.conceptId.getValue();		
		if (parentAttName.equals("valueCodedNameId")) return this.valueCodedNameId.getValue();		
		if (parentAttName.equals("valueDrug")) return this.valueDrug.getValue();		
		...
		if (parentAttName.equals("obsGroupId")) return this.obsGroupId.getValue();		
		if (parentAttName.equals("previousVersion")) return this.previousVersion.getValue();		
		if (parentAttName.equals("orderId")) return this.orderId.getValue();		
		if (parentAttName.equals("personId")) return this.personId.getValue();		
