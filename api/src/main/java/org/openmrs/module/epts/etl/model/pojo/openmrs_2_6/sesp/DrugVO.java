...
public class DrugVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.name.setValue(BaseVO.retrieveFieldValue(nameAttName, "VARCHAR", rs));
			...
			String combinationAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "combination", "_" );

		this.combination.setValue(BaseVO.retrieveFieldValue(combinationAttName, "BIT", rs));

			String dosageFormAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "dosage_form", "_" );

		this.dosageForm.setValue(BaseVO.retrieveFieldValue(dosageFormAttName, "INT", rs));

			String maximumDailyDoseAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "maximum_daily_dose", "_" );

		this.maximumDailyDose.setValue(BaseVO.retrieveFieldValue(maximumDailyDoseAttName, "DOUBLE", rs));

			String minimumDailyDoseAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "minimum_daily_dose", "_" );

		this.minimumDailyDose.setValue(BaseVO.retrieveFieldValue(minimumDailyDoseAttName, "DOUBLE", rs));

			String routeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "route", "_" );
		...
		this.changedBy.setValue(BaseVO.retrieveFieldValue(changedByAttName, "INT", rs));
			...
			String strengthAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "strength", "_" );

		this.strength.setValue(BaseVO.retrieveFieldValue(strengthAttName, "VARCHAR", rs));

	String doseLimitUnitsAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "dose_limit_units", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.conceptId.getValue(), this.name.getValue(), this.combination.getValue(), this.dosageForm.getValue(), this.maximumDailyDose.getValue(), this.minimumDailyDose.getValue(), this.route.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.dateChanged, this.changedBy.getValue(), this.strength.getValue(), this.doseLimitUnits.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.drugId.getValue(), this.conceptId.getValue(), this.name.getValue(), this.combination.getValue(), this.dosageForm.getValue(), this.maximumDailyDose.getValue(), this.minimumDailyDose.getValue(), this.route.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.dateChanged, this.changedBy.getValue(), this.strength.getValue(), this.doseLimitUnits.getValue(), this.drugId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE drug SET `drug_id` = ?, `concept_id` = ?, `name` = ?, `combination` = ?, `dosage_form` = ?, `maximum_daily_dose` = ?, `minimum_daily_dose` = ?, `route` = ?, `creator` = ?, `date_created` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `uuid` = ?, `date_changed` = ?, `changed_by` = ?, `strength` = ?, `dose_limit_units` = ? WHERE drug_1.drug_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.conceptId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.combination.getValue() != null ? "\""+this.combination.getValue()+"\"" : null) + "," + (this.dosageForm.getValue()) + "," + (this.maximumDailyDose.getValue()) + "," + (this.minimumDailyDose.getValue()) + "," + (this.route.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.strength.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.strength.getValue().toString())  +"\"" : null) + "," + (this.doseLimitUnits.getValue()); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.drugId.getValue()) + "," + (this.conceptId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.combination.getValue() != null ? "\""+this.combination.getValue()+"\"" : null) + "," + (this.dosageForm.getValue()) + "," + (this.maximumDailyDose.getValue()) + "," + (this.minimumDailyDose.getValue()) + "," + (this.route.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.strength.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.strength.getValue().toString())  +"\"" : null) + "," + (this.doseLimitUnits.getValue()); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof DrugVO){
	    	DrugVO toCopyFromAsDrugVO = (DrugVO)toCopyFrom;

			this.drugId = copyGeneratedField(toCopyFromAsDrugVO.drugId);
			this.conceptId = copyGeneratedField(toCopyFromAsDrugVO.conceptId);
			this.name = copyGeneratedField(toCopyFromAsDrugVO.name);
			this.combination = copyGeneratedField(toCopyFromAsDrugVO.combination);
			this.dosageForm = copyGeneratedField(toCopyFromAsDrugVO.dosageForm);
			this.maximumDailyDose = copyGeneratedField(toCopyFromAsDrugVO.maximumDailyDose);
			this.minimumDailyDose = copyGeneratedField(toCopyFromAsDrugVO.minimumDailyDose);
			this.route = copyGeneratedField(toCopyFromAsDrugVO.route);
			this.creator = copyGeneratedField(toCopyFromAsDrugVO.creator);
			this.dateCreated = toCopyFromAsDrugVO.dateCreated;
			this.retired = copyGeneratedField(toCopyFromAsDrugVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsDrugVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsDrugVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsDrugVO.retireReason);
			this.uuid = toCopyFromAsDrugVO.uuid;
			this.dateChanged = toCopyFromAsDrugVO.dateChanged;
			this.changedBy = copyGeneratedField(toCopyFromAsDrugVO.changedBy);
			this.strength = copyGeneratedField(toCopyFromAsDrugVO.strength);
	...
	public boolean hasParents() {
		if (this.dosageForm.getValue() != null) return true;

		if (this.doseLimitUnits.getValue() != null) return true;

		if (this.conceptId.getValue() != null) return true;

		if (this.route.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("dosageForm")) return this.dosageForm.getValue();		
		if (parentAttName.equals("doseLimitUnits")) return this.doseLimitUnits.getValue();		
		if (parentAttName.equals("conceptId")) return this.conceptId.getValue();		
		if (parentAttName.equals("route")) return this.route.getValue();		
