...
public class TestResultVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String testResultIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "test_result_id", "_" );
		...
		this.locationId.setValue(BaseVO.retrieveFieldValue(locationIdAttName, "INT", rs));
			...
			String resultDateAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "result_date", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.orderId.getValue(), this.conceptId.getValue(), this.patientId.getValue(), this.encounterId.getValue(), this.locationId.getValue(), this.resultDate.getValue(), this.valueNumeric.getValue(), this.valueCoded.getValue(), this.valueText.getValue(), this.valueDatetime.getValue(), this.valueComplex.getValue(), this.valueModifier.getValue(), this.status.getValue(), this.interpretation.getValue(), this.comments.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.testResultId.getValue(), this.orderId.getValue(), this.conceptId.getValue(), this.patientId.getValue(), this.encounterId.getValue(), this.locationId.getValue(), this.resultDate.getValue(), this.valueNumeric.getValue(), this.valueCoded.getValue(), this.valueText.getValue(), this.valueDatetime.getValue(), this.valueComplex.getValue(), this.valueModifier.getValue(), this.status.getValue(), this.interpretation.getValue(), this.comments.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.testResultId.getValue(), this.orderId.getValue(), this.conceptId.getValue(), this.patientId.getValue(), this.encounterId.getValue(), this.locationId.getValue(), this.resultDate.getValue(), this.valueNumeric.getValue(), this.valueCoded.getValue(), this.valueText.getValue(), this.valueDatetime.getValue(), this.valueComplex.getValue(), this.valueModifier.getValue(), this.status.getValue(), this.interpretation.getValue(), this.comments.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.testResultId.getValue()};
		return params; 
	} 
	...
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.orderId.getValue()) + "," + (this.conceptId.getValue()) + "," + (this.patientId.getValue()) + "," + (this.encounterId.getValue()) + "," + (this.locationId.getValue()) + "," + (this.resultDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.resultDate.getValue())  +"\"" : null) + "," + (this.valueNumeric.getValue()) + "," + (this.valueCoded.getValue()) + "," + (this.valueText.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueText.getValue().toString())  +"\"" : null) + "," + (this.valueDatetime.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.valueDatetime.getValue())  +"\"" : null) + "," + (this.valueComplex.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueComplex.getValue().toString())  +"\"" : null) + "," + (this.valueModifier.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueModifier.getValue().toString())  +"\"" : null) + "," + (this.status.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.status.getValue().toString())  +"\"" : null) + "," + (this.interpretation.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.interpretation.getValue().toString())  +"\"" : null) + "," + (this.comments.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.comments.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue()) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.testResultId.getValue()) + "," + (this.orderId.getValue()) + "," + (this.conceptId.getValue()) + "," + (this.patientId.getValue()) + "," + (this.encounterId.getValue()) + "," + (this.locationId.getValue()) + "," + (this.resultDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.resultDate.getValue())  +"\"" : null) + "," + (this.valueNumeric.getValue()) + "," + (this.valueCoded.getValue()) + "," + (this.valueText.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueText.getValue().toString())  +"\"" : null) + "," + (this.valueDatetime.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.valueDatetime.getValue())  +"\"" : null) + "," + (this.valueComplex.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueComplex.getValue().toString())  +"\"" : null) + "," + (this.valueModifier.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.valueModifier.getValue().toString())  +"\"" : null) + "," + (this.status.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.status.getValue().toString())  +"\"" : null) + "," + (this.interpretation.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.interpretation.getValue().toString())  +"\"" : null) + "," + (this.comments.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.comments.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue()) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof TestResultVO){
	    	TestResultVO toCopyFromAsTestResultVO = (TestResultVO)toCopyFrom;

			this.testResultId = copyGeneratedField(toCopyFromAsTestResultVO.testResultId);
			this.orderId = copyGeneratedField(toCopyFromAsTestResultVO.orderId);
			this.conceptId = copyGeneratedField(toCopyFromAsTestResultVO.conceptId);
			this.patientId = copyGeneratedField(toCopyFromAsTestResultVO.patientId);
			this.encounterId = copyGeneratedField(toCopyFromAsTestResultVO.encounterId);
			this.locationId = copyGeneratedField(toCopyFromAsTestResultVO.locationId);
			this.resultDate = copyGeneratedField(toCopyFromAsTestResultVO.resultDate);
			this.valueNumeric = copyGeneratedField(toCopyFromAsTestResultVO.valueNumeric);
			this.valueCoded = copyGeneratedField(toCopyFromAsTestResultVO.valueCoded);
			this.valueText = copyGeneratedField(toCopyFromAsTestResultVO.valueText);
			this.valueDatetime = copyGeneratedField(toCopyFromAsTestResultVO.valueDatetime);
			this.valueComplex = copyGeneratedField(toCopyFromAsTestResultVO.valueComplex);
			this.valueModifier = copyGeneratedField(toCopyFromAsTestResultVO.valueModifier);
			this.status = copyGeneratedField(toCopyFromAsTestResultVO.status);
			this.interpretation = copyGeneratedField(toCopyFromAsTestResultVO.interpretation);
			this.comments = copyGeneratedField(toCopyFromAsTestResultVO.comments);
			this.creator = copyGeneratedField(toCopyFromAsTestResultVO.creator);
			this.dateCreated = toCopyFromAsTestResultVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsTestResultVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsTestResultVO.voidedBy);
			this.dateVoided = toCopyFromAsTestResultVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsTestResultVO.voidReason);
