...
public class TipoDeAleitamentoAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public TipoDeAleitamentoAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO tipo_de_aleitamento_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		TipoDeAleitamentoAuxSrcQueryDsQueryResultVO copy = new TipoDeAleitamentoAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "tipo_de_aleitamento_aux_src_query_ds";
	}
