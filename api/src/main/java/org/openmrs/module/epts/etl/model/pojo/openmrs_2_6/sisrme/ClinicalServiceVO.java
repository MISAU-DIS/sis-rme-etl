...
public class ClinicalServiceVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String clinicalServiceIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "clinical_service_id", "_" );
		...
		this.locationId.setValue(BaseVO.retrieveFieldValue(locationIdAttName, "INT", rs));
			...
			String serviceConceptIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "service_concept_id", "_" );

		this.serviceConceptId.setValue(BaseVO.retrieveFieldValue(serviceConceptIdAttName, "INT", rs));

			String activeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "active", "_" );

		this.active.setValue(BaseVO.retrieveFieldValue(activeAttName, "BIT", rs));

			String hasQueueAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "has_queue", "_" );

		this.hasQueue.setValue(BaseVO.retrieveFieldValue(hasQueueAttName, "BIT", rs));

			String hasPharmacyAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "has_pharmacy", "_" );

		this.hasPharmacy.setValue(BaseVO.retrieveFieldValue(hasPharmacyAttName, "BIT", rs));

			String isOneStopAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "is_one_stop", "_" );

		this.isOneStop.setValue(BaseVO.retrieveFieldValue(isOneStopAttName, "BIT", rs));

			String pharmacyLocationIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "pharmacy_location_id", "_" );

		this.pharmacyLocationId.setValue(BaseVO.retrieveFieldValue(pharmacyLocationIdAttName, "INT", rs));

			String displayOrderAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "display_order", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.locationId.getValue(), this.serviceConceptId.getValue(), this.active.getValue(), this.hasQueue.getValue(), this.hasPharmacy.getValue(), this.isOneStop.getValue(), this.pharmacyLocationId.getValue(), this.displayOrder.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.clinicalServiceId.getValue(), this.locationId.getValue(), this.serviceConceptId.getValue(), this.active.getValue(), this.hasQueue.getValue(), this.hasPharmacy.getValue(), this.isOneStop.getValue(), this.pharmacyLocationId.getValue(), this.displayOrder.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.clinicalServiceId.getValue(), this.locationId.getValue(), this.serviceConceptId.getValue(), this.active.getValue(), this.hasQueue.getValue(), this.hasPharmacy.getValue(), this.isOneStop.getValue(), this.pharmacyLocationId.getValue(), this.displayOrder.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.clinicalServiceId.getValue()};
		return params; 
	} 
	...
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.locationId.getValue()) + "," + (this.serviceConceptId.getValue()) + "," + (this.active.getValue() != null ? "\""+this.active.getValue()+"\"" : null) + "," + (this.hasQueue.getValue() != null ? "\""+this.hasQueue.getValue()+"\"" : null) + "," + (this.hasPharmacy.getValue() != null ? "\""+this.hasPharmacy.getValue()+"\"" : null) + "," + (this.isOneStop.getValue() != null ? "\""+this.isOneStop.getValue()+"\"" : null) + "," + (this.pharmacyLocationId.getValue()) + "," + (this.displayOrder.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.clinicalServiceId.getValue()) + "," + (this.locationId.getValue()) + "," + (this.serviceConceptId.getValue()) + "," + (this.active.getValue() != null ? "\""+this.active.getValue()+"\"" : null) + "," + (this.hasQueue.getValue() != null ? "\""+this.hasQueue.getValue()+"\"" : null) + "," + (this.hasPharmacy.getValue() != null ? "\""+this.hasPharmacy.getValue()+"\"" : null) + "," + (this.isOneStop.getValue() != null ? "\""+this.isOneStop.getValue()+"\"" : null) + "," + (this.pharmacyLocationId.getValue()) + "," + (this.displayOrder.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof ClinicalServiceVO){
	    	ClinicalServiceVO toCopyFromAsClinicalServiceVO = (ClinicalServiceVO)toCopyFrom;

			this.clinicalServiceId = copyGeneratedField(toCopyFromAsClinicalServiceVO.clinicalServiceId);
			this.locationId = copyGeneratedField(toCopyFromAsClinicalServiceVO.locationId);
			this.serviceConceptId = copyGeneratedField(toCopyFromAsClinicalServiceVO.serviceConceptId);
			this.active = copyGeneratedField(toCopyFromAsClinicalServiceVO.active);
			this.hasQueue = copyGeneratedField(toCopyFromAsClinicalServiceVO.hasQueue);
			this.hasPharmacy = copyGeneratedField(toCopyFromAsClinicalServiceVO.hasPharmacy);
			this.isOneStop = copyGeneratedField(toCopyFromAsClinicalServiceVO.isOneStop);
			this.pharmacyLocationId = copyGeneratedField(toCopyFromAsClinicalServiceVO.pharmacyLocationId);
			this.displayOrder = copyGeneratedField(toCopyFromAsClinicalServiceVO.displayOrder);
			this.creator = copyGeneratedField(toCopyFromAsClinicalServiceVO.creator);
			this.dateCreated = toCopyFromAsClinicalServiceVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsClinicalServiceVO.changedBy);
			this.dateChanged = toCopyFromAsClinicalServiceVO.dateChanged;
			this.retired = copyGeneratedField(toCopyFromAsClinicalServiceVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsClinicalServiceVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsClinicalServiceVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsClinicalServiceVO.retireReason);
