...
public class IdadeDeDesmameAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public IdadeDeDesmameAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO idade_de_desmame_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		IdadeDeDesmameAuxSrcQueryDsQueryResultVO copy = new IdadeDeDesmameAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "idade_de_desmame_aux_src_query_ds";
	}
