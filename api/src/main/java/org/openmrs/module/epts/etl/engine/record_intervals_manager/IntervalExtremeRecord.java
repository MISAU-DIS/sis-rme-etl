...
/**
 * Indicate the min and max dstRecord id to be processed in a certain thread or
 * thread iteration
 */
	...
	public IntervalExtremeRecord(long minRecordId, long maxRecordId) {
		...
		if (minRecordId > maxRecordId)
			throw new ForbiddenOperationException(
					"The minRecordId cannot be greater that the maxRecordId [minRecordId: " + minRecordId
