...
public class PrescriptionAuxSrcQueryDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public String getInsertSQLWithoutObjectId(){ 
 		return "INSERT INTO prescription_aux_src_query_ds(`value`) VALUES( ?);"; 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PrescriptionAuxSrcQueryDsQueryResultVO){
	    	PrescriptionAuxSrcQueryDsQueryResultVO toCopyFromAsPrescriptionAuxSrcQueryDsQueryResultVO = (PrescriptionAuxSrcQueryDsQueryResultVO)toCopyFrom;
	...
	public String generateTableName() {
		return "prescription_aux_src_query_ds";
	}
