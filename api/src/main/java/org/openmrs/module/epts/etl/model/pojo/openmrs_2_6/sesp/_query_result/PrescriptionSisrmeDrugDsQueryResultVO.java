...
public class PrescriptionSisrmeDrugDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject {
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom) {
		if (toCopyFrom instanceof PrescriptionSisrmeDrugDsQueryResultVO) {
			PrescriptionSisrmeDrugDsQueryResultVO toCopyFromAsPrescriptionSisrmeDrugDsQueryResultVO = (PrescriptionSisrmeDrugDsQueryResultVO) toCopyFrom;

			this.drugId = copyGeneratedField(toCopyFromAsPrescriptionSisrmeDrugDsQueryResultVO.drugId);
