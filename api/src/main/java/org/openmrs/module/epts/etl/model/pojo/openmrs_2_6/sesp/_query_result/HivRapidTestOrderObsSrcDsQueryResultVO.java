...
public class HivRapidTestOrderObsSrcDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	...
	public HivRapidTestOrderObsSrcDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO hiv_rapid_test_order_obs_src_ds(`concept_id`, `value_coded`, `obs_datetime`) VALUES( ?, ?, ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		HivRapidTestOrderObsSrcDsQueryResultVO copy = new HivRapidTestOrderObsSrcDsQueryResultVO();
	...
	public String generateTableName() {
		return "hiv_rapid_test_order_obs_src_ds";
	}
