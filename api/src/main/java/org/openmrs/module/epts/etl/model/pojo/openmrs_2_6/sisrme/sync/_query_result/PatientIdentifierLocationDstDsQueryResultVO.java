...
public class PatientIdentifierLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public PatientIdentifierLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO patient_identifier_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		PatientIdentifierLocationDstDsQueryResultVO copy = new PatientIdentifierLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "patient_identifier_location_dst_ds";
	}
