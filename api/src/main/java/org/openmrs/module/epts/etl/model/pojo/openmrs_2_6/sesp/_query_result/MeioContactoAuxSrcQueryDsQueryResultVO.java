...
public class MeioContactoAuxSrcQueryDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	private Field value = Field.fastCreateWithType("value", "BIGINT");
 
	private EtlDatabaseObjectConfiguration relatedConfiguration;

	public MeioContactoAuxSrcQueryDsQueryResultVO() { 
		this.metadata = false;
	} 
	...
	public String getInsertSQLWithoutObjectId(){ 
 		return "INSERT INTO meio_contacto_aux_src_query_ds(`value`) VALUES( ?);"; 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof MeioContactoAuxSrcQueryDsQueryResultVO){
	    	MeioContactoAuxSrcQueryDsQueryResultVO toCopyFromAsMeioContactoAuxSrcQueryDsQueryResultVO = (MeioContactoAuxSrcQueryDsQueryResultVO)toCopyFrom;
	...
	public String generateTableName() {
		return "meio_contacto_aux_src_query_ds";
	}
