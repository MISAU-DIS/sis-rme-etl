...
public class EncounterVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.formId.setValue(BaseVO.retrieveFieldValue(formIdAttName, "INT", rs));
			...
			String encounterDatetimeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "encounter_datetime", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.encounterType.getValue(), this.patientId.getValue(), this.locationId.getValue(), this.formId.getValue(), this.encounterDatetime.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.changedBy.getValue(), this.dateChanged, this.visitId.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.encounterId.getValue(), this.encounterType.getValue(), this.patientId.getValue(), this.locationId.getValue(), this.formId.getValue(), this.encounterDatetime.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.changedBy.getValue(), this.dateChanged, this.visitId.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterId.getValue(), this.encounterType.getValue(), this.patientId.getValue(), this.locationId.getValue(), this.formId.getValue(), this.encounterDatetime.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.changedBy.getValue(), this.dateChanged, this.visitId.getValue(), this.encounterId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE encounter SET `encounter_id` = ?, `encounter_type` = ?, `patient_id` = ?, `location_id` = ?, `form_id` = ?, `encounter_datetime` = ?, `creator` = ?, `date_created` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `uuid` = ?, `changed_by` = ?, `date_changed` = ?, `visit_id` = ? WHERE saude_reprodutiva_encounter_src_ds.encounter_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.encounterType.getValue()) + "," + (this.patientId.getValue()) + "," + (this.locationId.getValue()) + "," + (this.formId.getValue()) + "," + (this.encounterDatetime.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.encounterDatetime.getValue())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.visitId.getValue()); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.encounterId.getValue()) + "," + (this.encounterType.getValue()) + "," + (this.patientId.getValue()) + "," + (this.locationId.getValue()) + "," + (this.formId.getValue()) + "," + (this.encounterDatetime.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.encounterDatetime.getValue())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.visitId.getValue()); 
	} 
	...
	public EtlDatabaseObject createACopy(){ 
		...
		copy.encounterDatetime = copyGeneratedField(this.encounterDatetime);
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof EncounterVO){
	    	EncounterVO toCopyFromAsEncounterVO = (EncounterVO)toCopyFrom;

			this.encounterId = copyGeneratedField(toCopyFromAsEncounterVO.encounterId);
			this.encounterType = copyGeneratedField(toCopyFromAsEncounterVO.encounterType);
			this.patientId = copyGeneratedField(toCopyFromAsEncounterVO.patientId);
			this.locationId = copyGeneratedField(toCopyFromAsEncounterVO.locationId);
			this.formId = copyGeneratedField(toCopyFromAsEncounterVO.formId);
			this.encounterDatetime = copyGeneratedField(toCopyFromAsEncounterVO.encounterDatetime);
			this.creator = copyGeneratedField(toCopyFromAsEncounterVO.creator);
			this.dateCreated = toCopyFromAsEncounterVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsEncounterVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsEncounterVO.voidedBy);
			this.dateVoided = toCopyFromAsEncounterVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsEncounterVO.voidReason);
			this.uuid = toCopyFromAsEncounterVO.uuid;
			this.changedBy = copyGeneratedField(toCopyFromAsEncounterVO.changedBy);
			this.dateChanged = toCopyFromAsEncounterVO.dateChanged;
	...
	public boolean hasParents() {
		...
		if (this.formId.getValue() != null) return true;
		...
		if (this.visitId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		...
		if (parentAttName.equals("formId")) return this.formId.getValue();		
		...
		if (parentAttName.equals("visitId")) return this.visitId.getValue();
