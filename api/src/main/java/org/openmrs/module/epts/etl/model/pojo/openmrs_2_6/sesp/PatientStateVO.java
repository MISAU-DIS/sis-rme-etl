...
public class PatientStateVO extends AbstractGeneratedDatabaseObject {
	...
	private Field endDate = Field.fastCreateWithType("end_date", "DATE");
	...
	public PatientStateVO() {
		this.metadata = false;
		this.fields.add(this.patientStateId);
	...
	public void tryToReplaceFieldValueWithKeyValue(Key k) {
		if (utilities.equalsFieldsName(k.getName(), "patient_state_id")) {
			this.patientStateId.setValue(k.getValue());
		}
	}

	@Override
	public Object getFieldValue(String fieldName) {
		if (utilities.equalsFieldsName(fieldName, "patient_state_id")) {
			return this.patientStateId.getValue();
		}
	...
	public void setFieldValue(String fieldName, Object value) {
		if (utilities.equalsFieldsName(fieldName, "patient_state_id")) {
			this.patientStateId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
	...
	public void loadWithDefaultValues(Connection srcConn, Connection dstConn) throws DBException {
		...
		loadGeneratedFieldWithDefaultValue(this.patientStateId, srcConn, dstConn);
	...
	public void load(ResultSet rs) throws SQLException {
		...
		if (getRelatedConfiguration().containsField("encounter_id")) {
		...
		this.endDate.setValue(BaseVO.retrieveFieldValue(endDateAttName, "DATE", rs));
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.patientProgramId.getValue(), this.state.getValue(), this.startDate.getValue(),
				this.endDate.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(),
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.patientStateId.getValue(), this.patientProgramId.getValue(), this.state.getValue(),
				this.startDate.getValue(), this.endDate.getValue(), this.creator.getValue(), this.dateCreated,
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.patientStateId.getValue(), this.patientProgramId.getValue(), this.state.getValue(),
				this.startDate.getValue(), this.endDate.getValue(), this.creator.getValue(), this.dateCreated,
				this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(),
				this.dateVoided, this.voidReason.getValue(), this.uuid, this.patientStateId.getValue() };
		return params;
	}
	...
	public String getUpdateSQL() {
		return "UPDATE patient_state SET `patient_state_id` = ?, `patient_program_id` = ?, `state` = ?, `start_date` = ?, `end_date` = ?, `creator` = ?, `date_created` = ?, `changed_by` = ?, `date_changed` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `uuid` = ? WHERE patient_state_id = ? ";
	}
