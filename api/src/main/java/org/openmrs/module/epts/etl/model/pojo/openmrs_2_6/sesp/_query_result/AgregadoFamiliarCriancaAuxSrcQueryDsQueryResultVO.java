...
public class AgregadoFamiliarCriancaAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	...
	public AgregadoFamiliarCriancaAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO agregado_familiar_crianca_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		AgregadoFamiliarCriancaAuxSrcQueryDsQueryResultVO copy = new AgregadoFamiliarCriancaAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "agregado_familiar_crianca_aux_src_query_ds";
	}
