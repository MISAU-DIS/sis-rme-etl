...
public class PersonAttributeVO extends AbstractGeneratedDatabaseObject {
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.personAttributeId.getValue(), this.personId.getValue(), this.value.getValue(),
				this.personAttributeTypeId.getValue(), this.creator.getValue(), this.dateCreated,
				this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(),
				this.dateVoided, this.voidReason.getValue(), this.uuid, this.personAttributeId.getValue() };
		return params;
	}
	...
	public String getUpdateSQL() {
		return "UPDATE person_attribute SET `person_attribute_id` = ?, `person_id` = ?, `value` = ?, `person_attribute_type_id` = ?, `creator` = ?, `date_created` = ?, `changed_by` = ?, `date_changed` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `uuid` = ? WHERE person_attribute_id = ? ";
	}
