...
public enum DBConnectionIsolationLevel {
	 ...
	 * This level includes the prohibitions in {@code TRANSACTION_REPEATABLE_READ} and further
	...
	DBConnectionIsolationLevel(int level) {
		this.level = level;
	}
