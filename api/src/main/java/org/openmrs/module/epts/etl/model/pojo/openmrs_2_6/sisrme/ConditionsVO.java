...
public class ConditionsVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		String conditionCodedAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "condition_coded", "_" );

		this.conditionCoded.setValue(BaseVO.retrieveFieldValue(conditionCodedAttName, "INT", rs));

		String conditionNonCodedAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "condition_non_coded", "_" );

		this.conditionNonCoded.setValue(BaseVO.retrieveFieldValue(conditionNonCodedAttName, "VARCHAR", rs));

		String clinicalStatusAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "clinical_status", "_" );

		this.clinicalStatus.setValue(BaseVO.retrieveFieldValue(clinicalStatusAttName, "VARCHAR", rs));

		String onsetDateAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "onset_date", "_" );
...
String formNamespaceAndPathAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "form_namespace_and_path", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.conditionCoded.getValue(), this.conditionNonCoded.getValue(), this.clinicalStatus.getValue(), this.onsetDate.getValue(), this.dateCreated, this.voided.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.creator.getValue(), this.voidedBy.getValue(), this.changedBy.getValue(), this.patientId.getValue(), this.dateChanged, this.encounterId.getValue(), this.formNamespaceAndPath.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.conditionId.getValue(), this.conditionCoded.getValue(), this.conditionNonCoded.getValue(), this.clinicalStatus.getValue(), this.onsetDate.getValue(), this.dateCreated, this.voided.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.creator.getValue(), this.voidedBy.getValue(), this.changedBy.getValue(), this.patientId.getValue(), this.dateChanged, this.encounterId.getValue(), this.formNamespaceAndPath.getValue()};
		return params; 
	} 
	...
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.conditionCoded.getValue()) + "," + (this.conditionNonCoded.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.conditionNonCoded.getValue().toString())  +"\"" : null) + "," + (this.clinicalStatus.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.clinicalStatus.getValue().toString())  +"\"" : null) + "," + (this.onsetDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.onsetDate.getValue())  +"\"" : null) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.voidedBy.getValue()) + "," + (this.changedBy.getValue()) + "," + (this.patientId.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.encounterId.getValue()) + "," + (this.formNamespaceAndPath.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.formNamespaceAndPath.getValue().toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.conditionId.getValue()) + "," + (this.conditionCoded.getValue()) + "," + (this.conditionNonCoded.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.conditionNonCoded.getValue().toString())  +"\"" : null) + "," + (this.clinicalStatus.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.clinicalStatus.getValue().toString())  +"\"" : null) + "," + (this.onsetDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.onsetDate.getValue())  +"\"" : null) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.voidedBy.getValue()) + "," + (this.changedBy.getValue()) + "," + (this.patientId.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.encounterId.getValue()) + "," + (this.formNamespaceAndPath.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.formNamespaceAndPath.getValue().toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof ConditionsVO){
	    	ConditionsVO toCopyFromAsConditionsVO = (ConditionsVO)toCopyFrom;

			this.conditionId = copyGeneratedField(toCopyFromAsConditionsVO.conditionId);
			this.conditionCoded = copyGeneratedField(toCopyFromAsConditionsVO.conditionCoded);
			this.conditionNonCoded = copyGeneratedField(toCopyFromAsConditionsVO.conditionNonCoded);
			this.clinicalStatus = copyGeneratedField(toCopyFromAsConditionsVO.clinicalStatus);
			this.onsetDate = copyGeneratedField(toCopyFromAsConditionsVO.onsetDate);
			this.dateCreated = toCopyFromAsConditionsVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsConditionsVO.voided);
			this.dateVoided = toCopyFromAsConditionsVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsConditionsVO.voidReason);
			this.uuid = toCopyFromAsConditionsVO.uuid;
			this.creator = copyGeneratedField(toCopyFromAsConditionsVO.creator);
			this.voidedBy = copyGeneratedField(toCopyFromAsConditionsVO.voidedBy);
			this.changedBy = copyGeneratedField(toCopyFromAsConditionsVO.changedBy);
			this.patientId = copyGeneratedField(toCopyFromAsConditionsVO.patientId);
			this.dateChanged = toCopyFromAsConditionsVO.dateChanged;
			this.encounterId = copyGeneratedField(toCopyFromAsConditionsVO.encounterId);
	...
	public boolean hasParents() {
		if (this.conditionCoded.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("conditionCoded")) return this.conditionCoded.getValue();		
