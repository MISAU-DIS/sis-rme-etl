...
public class FonteDeAguaAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public FonteDeAguaAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO fonte_de_agua_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		FonteDeAguaAuxSrcQueryDsQueryResultVO copy = new FonteDeAguaAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "fonte_de_agua_aux_src_query_ds";
	}
