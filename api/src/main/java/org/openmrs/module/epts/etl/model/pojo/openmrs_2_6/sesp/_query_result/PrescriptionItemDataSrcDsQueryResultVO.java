...
public class PrescriptionItemDataSrcDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject {
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom) {
		if (toCopyFrom instanceof PrescriptionItemDataSrcDsQueryResultVO) {
			PrescriptionItemDataSrcDsQueryResultVO toCopyFromAsPrescriptionItemDataSrcDsQueryResultVO = (PrescriptionItemDataSrcDsQueryResultVO) toCopyFrom;

			this.valueDrug = copyGeneratedField(toCopyFromAsPrescriptionItemDataSrcDsQueryResultVO.valueDrug);
			this.formulacaoConceptId = copyGeneratedField(
					toCopyFromAsPrescriptionItemDataSrcDsQueryResultVO.formulacaoConceptId);
			this.packageDatetime = copyGeneratedField(
					toCopyFromAsPrescriptionItemDataSrcDsQueryResultVO.packageDatetime);
			this.posologia = copyGeneratedField(toCopyFromAsPrescriptionItemDataSrcDsQueryResultVO.posologia);
			this.specifiedQty = copyGeneratedField(toCopyFromAsPrescriptionItemDataSrcDsQueryResultVO.specifiedQty);
