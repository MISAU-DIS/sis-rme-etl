...
public class ExameFisicoAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public ExameFisicoAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO exame_fisico_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		ExameFisicoAuxSrcQueryDsQueryResultVO copy = new ExameFisicoAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "exame_fisico_aux_src_query_ds";
	}
