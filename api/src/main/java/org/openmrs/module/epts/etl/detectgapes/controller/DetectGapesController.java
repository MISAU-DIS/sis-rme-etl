...
public class DetectGapesController extends EtlController {
	...
	private void tryToCreateTableGape() {
		...
		try {
			...
			String syncStageSchema = operationConfig.getRelatedEtlConf().getSyncStageSchema();
	...
	private void createGapesTable(Connection conn) throws DBException {
		String tableName = operationConfig.getRelatedEtlConf().getSyncStageSchema() + ".sync_table_gape";
		String sql = "";
