...
public class ProgramWorkflowVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.programId.getValue(), this.conceptId.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.programWorkflowId.getValue(), this.programId.getValue(), this.conceptId.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.programWorkflowId.getValue(), this.programId.getValue(), this.conceptId.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid, this.programWorkflowId.getValue()};
		return params; 
	} 
	...
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.programWorkflowId.getValue()) + "," + (this.programId.getValue()) + "," + (this.conceptId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof ProgramWorkflowVO){
	    	ProgramWorkflowVO toCopyFromAsProgramWorkflowVO = (ProgramWorkflowVO)toCopyFrom;

			this.programWorkflowId = copyGeneratedField(toCopyFromAsProgramWorkflowVO.programWorkflowId);
			this.programId = copyGeneratedField(toCopyFromAsProgramWorkflowVO.programId);
			this.conceptId = copyGeneratedField(toCopyFromAsProgramWorkflowVO.conceptId);
			this.creator = copyGeneratedField(toCopyFromAsProgramWorkflowVO.creator);
			this.dateCreated = toCopyFromAsProgramWorkflowVO.dateCreated;
			this.retired = copyGeneratedField(toCopyFromAsProgramWorkflowVO.retired);
			this.changedBy = copyGeneratedField(toCopyFromAsProgramWorkflowVO.changedBy);
			this.dateChanged = toCopyFromAsProgramWorkflowVO.dateChanged;
