...
public class ContactoTbAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public ContactoTbAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO contacto_tb_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		ContactoTbAuxSrcQueryDsQueryResultVO copy = new ContactoTbAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "contacto_tb_aux_src_query_ds";
	}
