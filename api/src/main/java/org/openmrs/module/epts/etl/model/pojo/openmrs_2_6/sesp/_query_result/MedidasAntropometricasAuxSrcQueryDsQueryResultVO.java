...
public class MedidasAntropometricasAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public MedidasAntropometricasAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO medidas_antropometricas_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		MedidasAntropometricasAuxSrcQueryDsQueryResultVO copy = new MedidasAntropometricasAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "medidas_antropometricas_aux_src_query_ds";
	}
