...
public class LabRequestAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public LabRequestAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO lab_request_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		LabRequestAuxSrcQueryDsQueryResultVO copy = new LabRequestAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "lab_request_aux_src_query_ds";
	}
