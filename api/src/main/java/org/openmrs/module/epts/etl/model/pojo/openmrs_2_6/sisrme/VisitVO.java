...
public class VisitVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String visitIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "visit_id", "_" );
		...
		this.patientId.setValue(BaseVO.retrieveFieldValue(patientIdAttName, "INT", rs));
			...
			String visitTypeIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "visit_type_id", "_" );

		this.visitTypeId.setValue(BaseVO.retrieveFieldValue(visitTypeIdAttName, "INT", rs));

			String dateStartedAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "date_started", "_" );
		...
		this.dateStopped.setValue(BaseVO.retrieveFieldValue(dateStoppedAttName, "DATETIME", rs));
			...
			String indicationConceptIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "indication_concept_id", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.patientId.getValue(), this.visitTypeId.getValue(), this.dateStarted.getValue(), this.dateStopped.getValue(), this.indicationConceptId.getValue(), this.locationId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.visitId.getValue(), this.patientId.getValue(), this.visitTypeId.getValue(), this.dateStarted.getValue(), this.dateStopped.getValue(), this.indicationConceptId.getValue(), this.locationId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.visitId.getValue(), this.patientId.getValue(), this.visitTypeId.getValue(), this.dateStarted.getValue(), this.dateStopped.getValue(), this.indicationConceptId.getValue(), this.locationId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.visitId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE visit SET `visit_id` = ?, `patient_id` = ?, `visit_type_id` = ?, `date_started` = ?, `date_stopped` = ?, `indication_concept_id` = ?, `location_id` = ?, `creator` = ?, `date_created` = ?, `changed_by` = ?, `date_changed` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `uuid` = ? WHERE visit_6.visit_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.patientId.getValue()) + "," + (this.visitTypeId.getValue()) + "," + (this.dateStarted.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateStarted.getValue())  +"\"" : null) + "," + (this.dateStopped.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateStopped.getValue())  +"\"" : null) + "," + (this.indicationConceptId.getValue()) + "," + (this.locationId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.visitId.getValue()) + "," + (this.patientId.getValue()) + "," + (this.visitTypeId.getValue()) + "," + (this.dateStarted.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateStarted.getValue())  +"\"" : null) + "," + (this.dateStopped.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateStopped.getValue())  +"\"" : null) + "," + (this.indicationConceptId.getValue()) + "," + (this.locationId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public EtlDatabaseObject createACopy(){ 
		...
		copy.visitId = copyGeneratedField(this.visitId);
		copy.patientId = copyGeneratedField(this.patientId);
		copy.visitTypeId = copyGeneratedField(this.visitTypeId);
		copy.dateStarted = copyGeneratedField(this.dateStarted);
		copy.dateStopped = copyGeneratedField(this.dateStopped);
		copy.indicationConceptId = copyGeneratedField(this.indicationConceptId);
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof VisitVO){
	    	VisitVO toCopyFromAsVisitVO = (VisitVO)toCopyFrom;

			this.visitId = copyGeneratedField(toCopyFromAsVisitVO.visitId);
			this.patientId = copyGeneratedField(toCopyFromAsVisitVO.patientId);
			this.visitTypeId = copyGeneratedField(toCopyFromAsVisitVO.visitTypeId);
			this.dateStarted = copyGeneratedField(toCopyFromAsVisitVO.dateStarted);
			this.dateStopped = copyGeneratedField(toCopyFromAsVisitVO.dateStopped);
			this.indicationConceptId = copyGeneratedField(toCopyFromAsVisitVO.indicationConceptId);
			this.locationId = copyGeneratedField(toCopyFromAsVisitVO.locationId);
			this.creator = copyGeneratedField(toCopyFromAsVisitVO.creator);
			this.dateCreated = toCopyFromAsVisitVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsVisitVO.changedBy);
			this.dateChanged = toCopyFromAsVisitVO.dateChanged;
			this.voided = copyGeneratedField(toCopyFromAsVisitVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsVisitVO.voidedBy);
			this.dateVoided = toCopyFromAsVisitVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsVisitVO.voidReason);
	...
	public boolean hasParents() {
		if (this.indicationConceptId.getValue() != null) return true;
		...
		if (this.visitTypeId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("indicationConceptId")) return this.indicationConceptId.getValue();		
		...
		if (parentAttName.equals("visitTypeId")) return this.visitTypeId.getValue();
