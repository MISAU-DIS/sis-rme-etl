...
public class ConceptVO extends AbstractGeneratedDatabaseObject {
	...
	public void setFieldValue(String fieldName, Object value) {
		...
		if (utilities.equalsFieldsName(fieldName, "short_name")) {
			this.shortName.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "description")) {
		...
		if (utilities.equalsFieldsName(fieldName, "form_text")) {
			this.formText.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "datatype_id")) {
			this.datatypeId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "class_id")) {
			this.classId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "is_set")) {
			this.isSet.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "creator")) {
	...
	public void loadWithDefaultValues(Connection srcConn, Connection dstConn) throws DBException {
		...
		loadGeneratedFieldWithDefaultValue(this.shortName, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.description, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.formText, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.datatypeId, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.classId, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.isSet, srcConn, dstConn);
