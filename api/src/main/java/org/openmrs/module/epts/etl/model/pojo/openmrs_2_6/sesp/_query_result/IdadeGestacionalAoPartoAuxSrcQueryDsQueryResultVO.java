...
public class IdadeGestacionalAoPartoAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public IdadeGestacionalAoPartoAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO idade_gestacional_ao_parto_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		IdadeGestacionalAoPartoAuxSrcQueryDsQueryResultVO copy = new IdadeGestacionalAoPartoAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "idade_gestacional_ao_parto_aux_src_query_ds";
	}
