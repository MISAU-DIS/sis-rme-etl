...
public class RapidTestOnDemandAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public RapidTestOnDemandAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO rapid_test_on_demand_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		RapidTestOnDemandAuxSrcQueryDsQueryResultVO copy = new RapidTestOnDemandAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "rapid_test_on_demand_aux_src_query_ds";
	}
