...
public class EncounterRoleVO extends AbstractGeneratedDatabaseObject {
	...
	public void tryToReplaceFieldValueWithKeyValue(Key k) {
		if (utilities.equalsFieldsName(k.getName(), "encounter_role_id")) {
			this.encounterRoleId.setValue(k.getValue());
		}
	}
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.encounterRoleId.getValue(), this.name.getValue(), this.description.getValue(),
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.encounterRoleId.getValue(), this.name.getValue(), this.description.getValue(),
				this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged,
				this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(),
				this.retireReason.getValue(), this.uuid, this.encounterRoleId.getValue() };
		return params;
	}
