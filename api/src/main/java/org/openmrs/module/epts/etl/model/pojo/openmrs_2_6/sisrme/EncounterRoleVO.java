...
public class EncounterRoleVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public String getInsertSQLWithObjectId(){ 
 		return "INSERT INTO encounter_role(`encounter_role_id`, `name`, `description`, `creator`, `date_created`, `changed_by`, `date_changed`, `retired`, `retired_by`, `date_retired`, `retire_reason`, `uuid`) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.encounterRoleId.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterRoleId.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.encounterRoleId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE encounter_role SET `encounter_role_id` = ?, `name` = ?, `description` = ?, `creator` = ?, `date_created` = ?, `changed_by` = ?, `date_changed` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `uuid` = ? WHERE encounter_role_2.encounter_role_id = ? "; 
	} 
	...
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.encounterRoleId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public EtlDatabaseObject createACopy(){ 
 		EncounterRoleVO copy = new EncounterRoleVO();
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof EncounterRoleVO){
	    	EncounterRoleVO toCopyFromAsEncounterRoleVO = (EncounterRoleVO)toCopyFrom;

			this.encounterRoleId = copyGeneratedField(toCopyFromAsEncounterRoleVO.encounterRoleId);
			this.name = copyGeneratedField(toCopyFromAsEncounterRoleVO.name);
			this.description = copyGeneratedField(toCopyFromAsEncounterRoleVO.description);
			this.creator = copyGeneratedField(toCopyFromAsEncounterRoleVO.creator);
			this.dateCreated = toCopyFromAsEncounterRoleVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsEncounterRoleVO.changedBy);
			this.dateChanged = toCopyFromAsEncounterRoleVO.dateChanged;
			this.retired = copyGeneratedField(toCopyFromAsEncounterRoleVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsEncounterRoleVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsEncounterRoleVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsEncounterRoleVO.retireReason);
