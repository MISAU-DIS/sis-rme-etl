...
public class OrderGroupVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.orderSetId.getValue(), this.patientId.getValue(), this.encounterId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.orderGroupId.getValue(), this.orderSetId.getValue(), this.patientId.getValue(), this.encounterId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.orderGroupId.getValue(), this.orderSetId.getValue(), this.patientId.getValue(), this.encounterId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid, this.orderGroupId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE order_group SET `order_group_id` = ?, `order_set_id` = ?, `patient_id` = ?, `encounter_id` = ?, `creator` = ?, `date_created` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `changed_by` = ?, `date_changed` = ?, `uuid` = ? WHERE order_group_1.order_group_id = ? "; 
	} 
