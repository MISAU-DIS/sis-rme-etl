...
public class ConceptClassVO extends AbstractGeneratedDatabaseObject {
	...
	public void tryToReplaceFieldValueWithKeyValue(Key k) {
		if (utilities.equalsFieldsName(k.getName(), "concept_class_id")) {
			this.conceptClassId.setValue(k.getValue());
		}
	}

	@Override
	public Object getFieldValue(String fieldName) {
		if (utilities.equalsFieldsName(fieldName, "concept_class_id")) {
	...
	public void setFieldValue(String fieldName, Object value) {
		if (utilities.equalsFieldsName(fieldName, "concept_class_id")) {
			this.conceptClassId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
	...
	public void loadWithDefaultValues(Connection srcConn, Connection dstConn) throws DBException {
		...
		loadGeneratedFieldWithDefaultValue(this.conceptClassId, srcConn, dstConn);
	...
	public String getUpdateSQL() {
		return "UPDATE concept_class SET `concept_class_id` = ?, `name` = ?, `description` = ?, `creator` = ?, `date_created` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `uuid` = ?, `date_changed` = ?, `changed_by` = ? WHERE concept_class_id = ? ";
	}
