...
public class HivPcrTestOnDemandAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public HivPcrTestOnDemandAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO hiv_pcr_test_on_demand_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		HivPcrTestOnDemandAuxSrcQueryDsQueryResultVO copy = new HivPcrTestOnDemandAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "hiv_pcr_test_on_demand_aux_src_query_ds";
	}
