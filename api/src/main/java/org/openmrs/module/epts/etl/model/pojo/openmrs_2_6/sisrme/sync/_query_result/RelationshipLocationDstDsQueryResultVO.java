...
public class RelationshipLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public RelationshipLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO relationship_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		RelationshipLocationDstDsQueryResultVO copy = new RelationshipLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "relationship_location_dst_ds";
	}
