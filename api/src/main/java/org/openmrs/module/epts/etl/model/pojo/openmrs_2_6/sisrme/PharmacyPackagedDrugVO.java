...
public class PharmacyPackagedDrugVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		String pharmacyPackagedDrugIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "pharmacy_packaged_drug_id", "_" );

		this.pharmacyPackagedDrugId.setValue(BaseVO.retrieveFieldValue(pharmacyPackagedDrugIdAttName, "INT", rs));

		String pharmacyPackageIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "pharmacy_package_id", "_" );
		...
		String quantityDispensedAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "quantity_dispensed", "_" );

		this.quantityDispensed.setValue(BaseVO.retrieveFieldValue(quantityDispensedAttName, "INT", rs));

		String nextPickupDateAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "next_pickup_date", "_" );
...
String uuidAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "uuid", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.pharmacyPackageId.getValue(), this.orderId.getValue(), this.pharmacyTransactionId.getValue(), this.quantityDispensed.getValue(), this.nextPickupDate.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.pharmacyPackagedDrugId.getValue(), this.pharmacyPackageId.getValue(), this.orderId.getValue(), this.pharmacyTransactionId.getValue(), this.quantityDispensed.getValue(), this.nextPickupDate.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.pharmacyPackagedDrugId.getValue(), this.pharmacyPackageId.getValue(), this.orderId.getValue(), this.pharmacyTransactionId.getValue(), this.quantityDispensed.getValue(), this.nextPickupDate.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid, this.pharmacyPackagedDrugId.getValue()};
		return params; 
	} 
	...
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.pharmacyPackageId.getValue()) + "," + (this.orderId.getValue()) + "," + (this.pharmacyTransactionId.getValue()) + "," + (this.quantityDispensed.getValue()) + "," + (this.nextPickupDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.nextPickupDate.getValue())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.pharmacyPackagedDrugId.getValue()) + "," + (this.pharmacyPackageId.getValue()) + "," + (this.orderId.getValue()) + "," + (this.pharmacyTransactionId.getValue()) + "," + (this.quantityDispensed.getValue()) + "," + (this.nextPickupDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.nextPickupDate.getValue())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PharmacyPackagedDrugVO){
	    	PharmacyPackagedDrugVO toCopyFromAsPharmacyPackagedDrugVO = (PharmacyPackagedDrugVO)toCopyFrom;

			this.pharmacyPackagedDrugId = copyGeneratedField(toCopyFromAsPharmacyPackagedDrugVO.pharmacyPackagedDrugId);
			this.pharmacyPackageId = copyGeneratedField(toCopyFromAsPharmacyPackagedDrugVO.pharmacyPackageId);
			this.orderId = copyGeneratedField(toCopyFromAsPharmacyPackagedDrugVO.orderId);
			this.pharmacyTransactionId = copyGeneratedField(toCopyFromAsPharmacyPackagedDrugVO.pharmacyTransactionId);
			this.quantityDispensed = copyGeneratedField(toCopyFromAsPharmacyPackagedDrugVO.quantityDispensed);
			this.nextPickupDate = copyGeneratedField(toCopyFromAsPharmacyPackagedDrugVO.nextPickupDate);
			this.creator = copyGeneratedField(toCopyFromAsPharmacyPackagedDrugVO.creator);
			this.dateCreated = toCopyFromAsPharmacyPackagedDrugVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsPharmacyPackagedDrugVO.voided);
			this.voidReason = copyGeneratedField(toCopyFromAsPharmacyPackagedDrugVO.voidReason);
			this.voidedBy = copyGeneratedField(toCopyFromAsPharmacyPackagedDrugVO.voidedBy);
	...
	public boolean hasParents() {
		...
		if (this.pharmacyPackageId.getValue() != null) return true;

		if (this.pharmacyTransactionId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		...
		if (parentAttName.equals("pharmacyPackageId")) return this.pharmacyPackageId.getValue();		
		if (parentAttName.equals("pharmacyTransactionId")) return this.pharmacyTransactionId.getValue();
