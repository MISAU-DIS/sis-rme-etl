...
public class MotivoDeConsultaCriancaEmRiscoAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public MotivoDeConsultaCriancaEmRiscoAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO motivo_de_consulta_crianca_em_risco_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		MotivoDeConsultaCriancaEmRiscoAuxSrcQueryDsQueryResultVO copy = new MotivoDeConsultaCriancaEmRiscoAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "motivo_de_consulta_crianca_em_risco_aux_src_query_ds";
	}
