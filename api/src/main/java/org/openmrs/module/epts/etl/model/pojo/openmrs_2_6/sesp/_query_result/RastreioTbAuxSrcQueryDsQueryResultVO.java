...
public class RastreioTbAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public RastreioTbAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO rastreio_tb_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		RastreioTbAuxSrcQueryDsQueryResultVO copy = new RastreioTbAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "rastreio_tb_aux_src_query_ds";
	}
