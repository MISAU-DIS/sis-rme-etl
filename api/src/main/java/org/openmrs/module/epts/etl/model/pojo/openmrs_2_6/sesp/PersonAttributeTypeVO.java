...
public class PersonAttributeTypeVO extends AbstractGeneratedDatabaseObject {
	...
	public PersonAttributeTypeVO() {
		...
		this.fields.add(this.foreignKey);
		this.fields.add(this.searchable);
	...
	public void tryToReplaceFieldValueWithKeyValue(Key k) {
		if (utilities.equalsFieldsName(k.getName(), "person_attribute_type_id")) {
			this.personAttributeTypeId.setValue(k.getValue());
		}
	}
	...
	public Object getFieldValue(String fieldName) {
		...
		if (utilities.equalsFieldsName(fieldName, "foreign_key")) {
			return this.foreignKey.getValue();
		}
		if (utilities.equalsFieldsName(fieldName, "searchable")) {
	...
	public void setFieldValue(String fieldName, Object value) {
		...
		if (utilities.equalsFieldsName(fieldName, "foreign_key")) {
			this.foreignKey.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "searchable")) {
			this.searchable.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "creator")) {
		...
		if (utilities.equalsFieldsName(fieldName, "edit_privilege")) {
			this.editPrivilege.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "sort_weight")) {
	...
	public void loadWithDefaultValues(Connection srcConn, Connection dstConn) throws DBException {
		...
		loadGeneratedFieldWithDefaultValue(this.personAttributeTypeId, srcConn, dstConn);
		...
		loadGeneratedFieldWithDefaultValue(this.foreignKey, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.searchable, srcConn, dstConn);
