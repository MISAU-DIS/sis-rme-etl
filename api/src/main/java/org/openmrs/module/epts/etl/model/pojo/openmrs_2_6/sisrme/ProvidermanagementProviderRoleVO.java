...
public class ProvidermanagementProviderRoleVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public String getInsertSQLWithObjectId(){ 
 		return "INSERT INTO providermanagement_provider_role(`provider_role_id`, `name`, `description`, `creator`, `date_created`, `changed_by`, `date_changed`, `retired`, `retired_by`, `date_retired`, `retire_reason`, `uuid`) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	@Override
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.providerRoleId.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.providerRoleId.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.providerRoleId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE providermanagement_provider_role SET `provider_role_id` = ?, `name` = ?, `description` = ?, `creator` = ?, `date_created` = ?, `changed_by` = ?, `date_changed` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `uuid` = ? WHERE providermanagement_provider_role_2.provider_role_id = ? "; 
	} 
	...
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.providerRoleId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public EtlDatabaseObject createACopy(){ 
 		ProvidermanagementProviderRoleVO copy = new ProvidermanagementProviderRoleVO();
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof ProvidermanagementProviderRoleVO){
	    	ProvidermanagementProviderRoleVO toCopyFromAsProvidermanagementProviderRoleVO = (ProvidermanagementProviderRoleVO)toCopyFrom;

			this.providerRoleId = copyGeneratedField(toCopyFromAsProvidermanagementProviderRoleVO.providerRoleId);
			this.name = copyGeneratedField(toCopyFromAsProvidermanagementProviderRoleVO.name);
			this.description = copyGeneratedField(toCopyFromAsProvidermanagementProviderRoleVO.description);
			this.creator = copyGeneratedField(toCopyFromAsProvidermanagementProviderRoleVO.creator);
			this.dateCreated = toCopyFromAsProvidermanagementProviderRoleVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsProvidermanagementProviderRoleVO.changedBy);
			this.dateChanged = toCopyFromAsProvidermanagementProviderRoleVO.dateChanged;
			this.retired = copyGeneratedField(toCopyFromAsProvidermanagementProviderRoleVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsProvidermanagementProviderRoleVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsProvidermanagementProviderRoleVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsProvidermanagementProviderRoleVO.retireReason);
	...
	public String generateTableName() {
		return "providermanagement_provider_role";
	}
