...
public class PersonNameLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public PersonNameLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO person_name_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		PersonNameLocationDstDsQueryResultVO copy = new PersonNameLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "person_name_location_dst_ds";
	}
