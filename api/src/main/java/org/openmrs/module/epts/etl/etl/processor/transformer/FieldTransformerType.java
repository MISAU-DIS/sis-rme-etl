...
public enum FieldTransformerType {
	...
	ARITHMETIC_TRANSFORMER(ArithmeticFieldTransformer.class.getCanonicalName(),
			ArithmeticFieldTransformer::getInstance),
	...
	PARENT_ON_DEMAND_TRANSFORMER(ParentOnDemandLoadTransformer.class.getCanonicalName(),
	...
	public boolean isNullValueTransformer() {
		return this == NULL_VALUE_TRANSFORMER;
	}
