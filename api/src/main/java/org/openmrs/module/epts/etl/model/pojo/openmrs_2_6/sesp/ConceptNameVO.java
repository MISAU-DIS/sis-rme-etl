...
public class ConceptNameVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.name.setValue(BaseVO.retrieveFieldValue(nameAttName, "VARCHAR", rs));
			...
			String localeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "locale", "_" );
		...
		this.dateCreated =  rs.getTimestamp(dateCreatedAttName) != null ? new java.util.Date( rs.getTimestamp(dateCreatedAttName).getTime() ) : null;
			...
			String conceptNameIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "concept_name_id", "_" );
		...
		this.uuid = AttDefinedElements.removeStrangeCharactersOnString(rs.getString(uuidAttName) != null ? rs.getString(uuidAttName).trim() : null);
			...
			String conceptNameTypeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "concept_name_type", "_" );

		this.conceptNameType.setValue(BaseVO.retrieveFieldValue(conceptNameTypeAttName, "VARCHAR", rs));

			String localePreferredAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "locale_preferred", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.conceptId.getValue(), this.name.getValue(), this.locale.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.conceptNameType.getValue(), this.localePreferred.getValue(), this.dateChanged, this.changedBy.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.conceptId.getValue(), this.name.getValue(), this.locale.getValue(), this.creator.getValue(), this.dateCreated, this.conceptNameId.getValue(), this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.conceptNameType.getValue(), this.localePreferred.getValue(), this.dateChanged, this.changedBy.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.conceptId.getValue(), this.name.getValue(), this.locale.getValue(), this.creator.getValue(), this.dateCreated, this.conceptNameId.getValue(), this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.conceptNameType.getValue(), this.localePreferred.getValue(), this.dateChanged, this.changedBy.getValue(), this.conceptNameId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE concept_name SET `concept_id` = ?, `name` = ?, `locale` = ?, `creator` = ?, `date_created` = ?, `concept_name_id` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `uuid` = ?, `concept_name_type` = ?, `locale_preferred` = ?, `date_changed` = ?, `changed_by` = ? WHERE concept_name_1.concept_name_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.conceptId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.locale.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.locale.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.conceptNameType.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.conceptNameType.getValue().toString())  +"\"" : null) + "," + (this.localePreferred.getValue() != null ? "\""+this.localePreferred.getValue()+"\"" : null) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.changedBy.getValue()); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.conceptId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.locale.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.locale.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.conceptNameId.getValue()) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.conceptNameType.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.conceptNameType.getValue().toString())  +"\"" : null) + "," + (this.localePreferred.getValue() != null ? "\""+this.localePreferred.getValue()+"\"" : null) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.changedBy.getValue()); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof ConceptNameVO){
	    	ConceptNameVO toCopyFromAsConceptNameVO = (ConceptNameVO)toCopyFrom;

			this.conceptId = copyGeneratedField(toCopyFromAsConceptNameVO.conceptId);
			this.name = copyGeneratedField(toCopyFromAsConceptNameVO.name);
			this.locale = copyGeneratedField(toCopyFromAsConceptNameVO.locale);
			this.creator = copyGeneratedField(toCopyFromAsConceptNameVO.creator);
			this.dateCreated = toCopyFromAsConceptNameVO.dateCreated;
			this.conceptNameId = copyGeneratedField(toCopyFromAsConceptNameVO.conceptNameId);
			this.voided = copyGeneratedField(toCopyFromAsConceptNameVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsConceptNameVO.voidedBy);
			this.dateVoided = toCopyFromAsConceptNameVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsConceptNameVO.voidReason);
			this.uuid = toCopyFromAsConceptNameVO.uuid;
			this.conceptNameType = copyGeneratedField(toCopyFromAsConceptNameVO.conceptNameType);
			this.localePreferred = copyGeneratedField(toCopyFromAsConceptNameVO.localePreferred);
			this.dateChanged = toCopyFromAsConceptNameVO.dateChanged;
