...
public class PatientStateLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public PatientStateLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO patient_state_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		PatientStateLocationDstDsQueryResultVO copy = new PatientStateLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "patient_state_location_dst_ds";
	}
