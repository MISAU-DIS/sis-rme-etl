...
public class HistoricoSocialEComportamentalAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public HistoricoSocialEComportamentalAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO historico_social_e_comportamental_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		HistoricoSocialEComportamentalAuxSrcQueryDsQueryResultVO copy = new HistoricoSocialEComportamentalAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "historico_social_e_comportamental_aux_src_query_ds";
	}
