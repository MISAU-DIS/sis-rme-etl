...
public class LocationVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.locationId.getValue(), this.name.getValue(), this.description.getValue(), this.address1.getValue(), this.address2.getValue(), this.cityVillage.getValue(), this.stateProvince.getValue(), this.postalCode.getValue(), this.country.getValue(), this.latitude.getValue(), this.longitude.getValue(), this.creator.getValue(), this.dateCreated, this.countyDistrict.getValue(), this.address3.getValue(), this.address6.getValue(), this.address5.getValue(), this.address4.getValue(), this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.parentLocation.getValue(), this.uuid, this.changedBy.getValue(), this.dateChanged, this.address7.getValue(), this.address8.getValue(), this.address9.getValue(), this.address10.getValue(), this.address11.getValue(), this.address12.getValue(), this.address13.getValue(), this.address14.getValue(), this.address15.getValue(), this.locationId.getValue()};
		return params; 
	} 
