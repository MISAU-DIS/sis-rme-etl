...
public class LabRequestOnDemandAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public LabRequestOnDemandAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO lab_request_on_demand_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		LabRequestOnDemandAuxSrcQueryDsQueryResultVO copy = new LabRequestOnDemandAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "lab_request_on_demand_aux_src_query_ds";
	}
