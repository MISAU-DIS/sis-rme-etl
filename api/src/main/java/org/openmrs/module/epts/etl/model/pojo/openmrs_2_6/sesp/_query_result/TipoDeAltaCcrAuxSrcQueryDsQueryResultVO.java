...
public class TipoDeAltaCcrAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public TipoDeAltaCcrAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO tipo_de_alta_ccr_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		TipoDeAltaCcrAuxSrcQueryDsQueryResultVO copy = new TipoDeAltaCcrAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "tipo_de_alta_ccr_aux_src_query_ds";
	}
