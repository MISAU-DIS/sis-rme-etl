...
public class TimeCountDown extends ScheduledOperation {
	...
	/**
	 * Initialize an instance of TimeCountDown which could be initialized using
	 * {@link #restart()}
	 * 
	 * @param initializer       the initializer where this {@link TimeCountDown} was
	 *                          initialized
	...
	@Override
	public void run() {
		if (this.intervalForMessage == 0)
			this.intervalForMessage = 10;
