...
public class Cd4FromFichaClinicaAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public Cd4FromFichaClinicaAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO cd4_from_ficha_clinica_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		Cd4FromFichaClinicaAuxSrcQueryDsQueryResultVO copy = new Cd4FromFichaClinicaAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "cd4_from_ficha_clinica_aux_src_query_ds";
	}
