...
public class PerimetroCranianoAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public PerimetroCranianoAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO perimetro_craniano_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		PerimetroCranianoAuxSrcQueryDsQueryResultVO copy = new PerimetroCranianoAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "perimetro_craniano_aux_src_query_ds";
	}
