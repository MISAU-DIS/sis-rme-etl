...
public class ProgramVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	String outcomesConceptIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "outcomes_concept_id", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.conceptId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.name.getValue(), this.description.getValue(), this.uuid, this.outcomesConceptId.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.programId.getValue(), this.conceptId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.name.getValue(), this.description.getValue(), this.uuid, this.outcomesConceptId.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.programId.getValue(), this.conceptId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.name.getValue(), this.description.getValue(), this.uuid, this.outcomesConceptId.getValue(), this.programId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE program SET `program_id` = ?, `concept_id` = ?, `creator` = ?, `date_created` = ?, `changed_by` = ?, `date_changed` = ?, `retired` = ?, `name` = ?, `description` = ?, `uuid` = ?, `outcomes_concept_id` = ? WHERE program_1.program_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.conceptId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.outcomesConceptId.getValue()); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.programId.getValue()) + "," + (this.conceptId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.outcomesConceptId.getValue()); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof ProgramVO){
	    	ProgramVO toCopyFromAsProgramVO = (ProgramVO)toCopyFrom;

			this.programId = copyGeneratedField(toCopyFromAsProgramVO.programId);
			this.conceptId = copyGeneratedField(toCopyFromAsProgramVO.conceptId);
			this.creator = copyGeneratedField(toCopyFromAsProgramVO.creator);
			this.dateCreated = toCopyFromAsProgramVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsProgramVO.changedBy);
			this.dateChanged = toCopyFromAsProgramVO.dateChanged;
			this.retired = copyGeneratedField(toCopyFromAsProgramVO.retired);
			this.name = copyGeneratedField(toCopyFromAsProgramVO.name);
			this.description = copyGeneratedField(toCopyFromAsProgramVO.description);
			this.uuid = toCopyFromAsProgramVO.uuid;
	...
	public boolean hasParents() {
		...
		if (this.outcomesConceptId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		...
		if (parentAttName.equals("outcomesConceptId")) return this.outcomesConceptId.getValue();		
