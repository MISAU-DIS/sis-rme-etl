...
public class AllergyLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public AllergyLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO allergy_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		AllergyLocationDstDsQueryResultVO copy = new AllergyLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "allergy_location_dst_ds";
	}
