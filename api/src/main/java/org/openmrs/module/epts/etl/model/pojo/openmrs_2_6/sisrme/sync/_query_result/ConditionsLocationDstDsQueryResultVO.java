...
public class ConditionsLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public ConditionsLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO conditions_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		ConditionsLocationDstDsQueryResultVO copy = new ConditionsLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "conditions_location_dst_ds";
	}
