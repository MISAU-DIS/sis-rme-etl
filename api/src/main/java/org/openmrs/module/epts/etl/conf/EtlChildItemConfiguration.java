...
public class EtlChildItemConfiguration extends EtlItemConfiguration implements EtlTransformTarget {
	...
	@Override
	public void fullLoad(EtlOperationConfig operationConfig, Connection srcConn, Connection dstConn)
			throws DBException {
	...
	public void loadDataSourceInfo(Connection conn) throws DBException {
		...
		synchronized (LOCK) {
			...
			this.addAllToAvaliableDataSource(
					this.getSrcConf().getParentItemConf().collectAllAvaliableDataSources(conn));
