...
public class PatientProgramVO extends AbstractGeneratedDatabaseObject {
	...
	public void load(ResultSet rs) throws SQLException {
		...
		if (getRelatedConfiguration().containsField("date_completed")) {
			String dateCompletedAttName = utilities
					.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "date_completed", "_");

			this.dateCompleted.setValue(BaseVO.retrieveFieldValue(dateCompletedAttName, "DATETIME", rs));
		}

		if (getRelatedConfiguration().containsField("outcome_concept_id")) {
			String outcomeConceptIdAttName = utilities
					.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "outcome_concept_id", "_");

			this.outcomeConceptId.setValue(BaseVO.retrieveFieldValue(outcomeConceptIdAttName, "INT", rs));
		}

		if (getRelatedConfiguration().containsField("idart")) {
			String idartAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(),
					"idart", "_");
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.patientId.getValue(), this.programId.getValue(), this.dateEnrolled.getValue(),
				...
				this.uuid, this.locationId.getValue() };
		return params;
	}
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.patientProgramId.getValue(), this.patientId.getValue(), this.programId.getValue(),
				this.dateEnrolled.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(),
				this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided,
				this.voidReason.getValue(), this.uuid, this.locationId.getValue() };
		return params;
	}
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.patientProgramId.getValue(), this.patientId.getValue(), this.programId.getValue(),
				this.dateEnrolled.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(),
				this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided,
				this.voidReason.getValue(), this.uuid, this.locationId.getValue(), this.patientProgramId.getValue() };
		return params;
	}
