...
public class HivRapidTestOnDemandAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public HivRapidTestOnDemandAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO hiv_rapid_test_on_demand_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		HivRapidTestOnDemandAuxSrcQueryDsQueryResultVO copy = new HivRapidTestOnDemandAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "hiv_rapid_test_on_demand_aux_src_query_ds";
	}
