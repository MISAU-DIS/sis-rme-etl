...
public class RapidTestOrderObsSrcDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	...
	public RapidTestOrderObsSrcDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO rapid_test_order_obs_src_ds(`concept_id`, `value_coded`, `obs_datetime`) VALUES( ?, ?, ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		RapidTestOrderObsSrcDsQueryResultVO copy = new RapidTestOrderObsSrcDsQueryResultVO();
	...
	public String generateTableName() {
		return "rapid_test_order_obs_src_ds";
	}
