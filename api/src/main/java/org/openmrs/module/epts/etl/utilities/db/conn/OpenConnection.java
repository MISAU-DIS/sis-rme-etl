...
public class OpenConnection implements Connection, Closeable {
	...
	/**
	 * Modifica o valor do atributo {@link #connection} para o valor fornecido pelo
	 * par�metro <code>connection</code>
	 * 
	...
	/**
	 * Modifica o valor do atributo {@link #operationTerminatedSuccessifully} para o
	 * valor fornecido pelo par�metro <code>operationTerminatedSuccessifully</code>
	 * 
