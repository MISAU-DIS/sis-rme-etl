...
public class PatientLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public PatientLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO patient_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		PatientLocationDstDsQueryResultVO copy = new PatientLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "patient_location_dst_ds";
	}
