...
public class LatrinaSanitarioAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public LatrinaSanitarioAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO latrina_sanitario_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		LatrinaSanitarioAuxSrcQueryDsQueryResultVO copy = new LatrinaSanitarioAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "latrina_sanitario_aux_src_query_ds";
	}
