...
public class HivPcrTestAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public HivPcrTestAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO hiv_pcr_test_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		HivPcrTestAuxSrcQueryDsQueryResultVO copy = new HivPcrTestAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "hiv_pcr_test_aux_src_query_ds";
	}
