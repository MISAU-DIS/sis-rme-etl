...
public class Cd4FromFichaResumoAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public Cd4FromFichaResumoAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO cd4_from_ficha_resumo_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		Cd4FromFichaResumoAuxSrcQueryDsQueryResultVO copy = new Cd4FromFichaResumoAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "cd4_from_ficha_resumo_aux_src_query_ds";
	}
