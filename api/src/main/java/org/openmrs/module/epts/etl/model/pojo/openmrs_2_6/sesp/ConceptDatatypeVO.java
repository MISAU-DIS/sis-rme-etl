...
public class ConceptDatatypeVO extends AbstractDatabaseObject implements EtlDatabaseObject {
	...
	public String getUpdateSQL() {
		return "UPDATE concept_datatype SET `concept_datatype_id` = ?, `name` = ?, `hl7_abbreviation` = ?, `description` = ?, `creator` = ?, `date_created` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `uuid` = ? WHERE concept_datatype_1.concept_datatype_id = ? ";
	}
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom) {
		if (toCopyFrom instanceof ConceptDatatypeVO) {
			ConceptDatatypeVO toCopyFromAsConceptDatatypeVO = (ConceptDatatypeVO) toCopyFrom;

			this.conceptDatatypeId = copyGeneratedField(toCopyFromAsConceptDatatypeVO.conceptDatatypeId);
			this.name = copyGeneratedField(toCopyFromAsConceptDatatypeVO.name);
			this.hl7Abbreviation = copyGeneratedField(toCopyFromAsConceptDatatypeVO.hl7Abbreviation);
			this.description = copyGeneratedField(toCopyFromAsConceptDatatypeVO.description);
			this.creator = copyGeneratedField(toCopyFromAsConceptDatatypeVO.creator);
			this.dateCreated = toCopyFromAsConceptDatatypeVO.dateCreated;
			this.retired = copyGeneratedField(toCopyFromAsConceptDatatypeVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsConceptDatatypeVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsConceptDatatypeVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsConceptDatatypeVO.retireReason);
