...
public class PatientStateVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String patientStateIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "patient_state_id", "_" );
		...
		this.patientProgramId.setValue(BaseVO.retrieveFieldValue(patientProgramIdAttName, "INT", rs));
			...
			String stateAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "state", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.patientProgramId.getValue(), this.state.getValue(), this.startDate.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.patientStateId.getValue(), this.patientProgramId.getValue(), this.state.getValue(), this.startDate.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.patientStateId.getValue(), this.patientProgramId.getValue(), this.state.getValue(), this.startDate.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.patientStateId.getValue()};
		return params; 
	} 
	...
	public EtlDatabaseObject createACopy(){ 
		...
		copy.patientStateId = copyGeneratedField(this.patientStateId);
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PatientStateVO){
	    	PatientStateVO toCopyFromAsPatientStateVO = (PatientStateVO)toCopyFrom;

			this.patientStateId = copyGeneratedField(toCopyFromAsPatientStateVO.patientStateId);
			this.patientProgramId = copyGeneratedField(toCopyFromAsPatientStateVO.patientProgramId);
			this.state = copyGeneratedField(toCopyFromAsPatientStateVO.state);
			this.startDate = copyGeneratedField(toCopyFromAsPatientStateVO.startDate);
			this.creator = copyGeneratedField(toCopyFromAsPatientStateVO.creator);
			this.dateCreated = toCopyFromAsPatientStateVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsPatientStateVO.changedBy);
			this.dateChanged = toCopyFromAsPatientStateVO.dateChanged;
			this.voided = copyGeneratedField(toCopyFromAsPatientStateVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsPatientStateVO.voidedBy);
			this.dateVoided = toCopyFromAsPatientStateVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsPatientStateVO.voidReason);
	...
	public boolean hasParents() {
		if (this.patientProgramId.getValue() != null) return true;

		if (this.state.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("patientProgramId")) return this.patientProgramId.getValue();		
		if (parentAttName.equals("state")) return this.state.getValue();		
