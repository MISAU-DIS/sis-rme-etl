...
public class Cd4FromFichaResumoOrderObsSrcDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	...
	public Cd4FromFichaResumoOrderObsSrcDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO cd4_from_ficha_resumo_order_obs_src_ds(`concept_id`, `value_coded`, `obs_datetime`) VALUES( ?, ?, ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		Cd4FromFichaResumoOrderObsSrcDsQueryResultVO copy = new Cd4FromFichaResumoOrderObsSrcDsQueryResultVO();
	...
	public String generateTableName() {
		return "cd4_from_ficha_resumo_order_obs_src_ds";
	}
