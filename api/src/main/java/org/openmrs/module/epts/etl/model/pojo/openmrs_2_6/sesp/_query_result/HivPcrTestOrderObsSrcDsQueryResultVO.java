...
public class HivPcrTestOrderObsSrcDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	...
	public HivPcrTestOrderObsSrcDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO hiv_pcr_test_order_obs_src_ds(`concept_id`, `value_coded`, `obs_datetime`) VALUES( ?, ?, ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		HivPcrTestOrderObsSrcDsQueryResultVO copy = new HivPcrTestOrderObsSrcDsQueryResultVO();
	...
	public String generateTableName() {
		return "hiv_pcr_test_order_obs_src_ds";
	}
