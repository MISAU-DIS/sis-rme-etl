...
public class PersonAttributeVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String personAttributeIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "person_attribute_id", "_" );
		...
		this.personId.setValue(BaseVO.retrieveFieldValue(personIdAttName, "INT", rs));
			...
			String valueAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.personId.getValue(), this.value.getValue(), this.personAttributeTypeId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.personAttributeId.getValue(), this.personId.getValue(), this.value.getValue(), this.personAttributeTypeId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.personAttributeId.getValue(), this.personId.getValue(), this.value.getValue(), this.personAttributeTypeId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.personAttributeId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE person_attribute SET `person_attribute_id` = ?, `person_id` = ?, `value` = ?, `person_attribute_type_id` = ?, `creator` = ?, `date_created` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `uuid` = ? WHERE prep_target_group_person_attribute_dst_ds.person_attribute_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.personId.getValue()) + "," + (this.value.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.value.getValue().toString())  +"\"" : null) + "," + (this.personAttributeTypeId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.personAttributeId.getValue()) + "," + (this.personId.getValue()) + "," + (this.value.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.value.getValue().toString())  +"\"" : null) + "," + (this.personAttributeTypeId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public EtlDatabaseObject createACopy(){ 
		...
		copy.personAttributeId = copyGeneratedField(this.personAttributeId);
		copy.personId = copyGeneratedField(this.personId);
		copy.value = copyGeneratedField(this.value);
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PersonAttributeVO){
	    	PersonAttributeVO toCopyFromAsPersonAttributeVO = (PersonAttributeVO)toCopyFrom;

			this.personAttributeId = copyGeneratedField(toCopyFromAsPersonAttributeVO.personAttributeId);
			this.personId = copyGeneratedField(toCopyFromAsPersonAttributeVO.personId);
			this.value = copyGeneratedField(toCopyFromAsPersonAttributeVO.value);
			this.personAttributeTypeId = copyGeneratedField(toCopyFromAsPersonAttributeVO.personAttributeTypeId);
			this.creator = copyGeneratedField(toCopyFromAsPersonAttributeVO.creator);
			this.dateCreated = toCopyFromAsPersonAttributeVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsPersonAttributeVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsPersonAttributeVO.voidedBy);
			this.dateVoided = toCopyFromAsPersonAttributeVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsPersonAttributeVO.voidReason);
	...
	public boolean hasParents() {
		...
		if (this.personAttributeTypeId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		...
		if (parentAttName.equals("personAttributeTypeId")) return this.personAttributeTypeId.getValue();		
