...
public class IncricaoOnDemandAuxSrcQueryDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public String getInsertSQLWithoutObjectId(){ 
 		return "INSERT INTO incricao_on_demand_aux_src_query_ds(`value`) VALUES( ?);"; 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof IncricaoOnDemandAuxSrcQueryDsQueryResultVO){
	    	IncricaoOnDemandAuxSrcQueryDsQueryResultVO toCopyFromAsIncricaoOnDemandAuxSrcQueryDsQueryResultVO = (IncricaoOnDemandAuxSrcQueryDsQueryResultVO)toCopyFrom;
	...
	public String generateTableName() {
		return "incricao_on_demand_aux_src_query_ds";
	}
