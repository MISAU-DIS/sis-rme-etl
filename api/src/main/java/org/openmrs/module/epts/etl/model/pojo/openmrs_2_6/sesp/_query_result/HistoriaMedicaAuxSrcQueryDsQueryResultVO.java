...
public class HistoriaMedicaAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public HistoriaMedicaAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO historia_medica_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		HistoriaMedicaAuxSrcQueryDsQueryResultVO copy = new HistoriaMedicaAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "historia_medica_aux_src_query_ds";
	}
