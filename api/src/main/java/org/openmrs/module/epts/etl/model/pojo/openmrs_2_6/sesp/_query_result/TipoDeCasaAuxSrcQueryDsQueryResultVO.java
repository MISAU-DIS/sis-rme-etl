...
public class TipoDeCasaAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public TipoDeCasaAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO tipo_de_casa_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		TipoDeCasaAuxSrcQueryDsQueryResultVO copy = new TipoDeCasaAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "tipo_de_casa_aux_src_query_ds";
	}
