...
public class EncounterProviderVO extends AbstractGeneratedDatabaseObject {
	...
	public EncounterProviderVO() {
		...
		this.fields.add(this.encounterProviderId);
		this.fields.add(this.encounterId);
		this.fields.add(this.providerId);
		this.fields.add(this.encounterRoleId);
	...
	public void tryToReplaceFieldValueWithKeyValue(Key k) {
		if (utilities.equalsFieldsName(k.getName(), "encounter_provider_id")) {
			this.encounterProviderId.setValue(k.getValue());
		}
	}

	@Override
	public Object getFieldValue(String fieldName) {
		if (utilities.equalsFieldsName(fieldName, "encounter_provider_id")) {
			return this.encounterProviderId.getValue();
		}
		...
		if (utilities.equalsFieldsName(fieldName, "encounter_role_id")) {
	...
	public void setFieldValue(String fieldName, Object value) {
		if (utilities.equalsFieldsName(fieldName, "encounter_provider_id")) {
			this.encounterProviderId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
		...
		if (utilities.equalsFieldsName(fieldName, "encounter_role_id")) {
			this.encounterRoleId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "creator")) {
	...
	public void loadWithDefaultValues(Connection srcConn, Connection dstConn) throws DBException {
		...
		loadGeneratedFieldWithDefaultValue(this.encounterProviderId, srcConn, dstConn);
		...
		loadGeneratedFieldWithDefaultValue(this.encounterRoleId, srcConn, dstConn);
	...
	public void load(ResultSet rs) throws SQLException {
		...
		String encounterProviderIdAttName = utilities
				.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "encounter_provider_id", "_");
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.encounterId.getValue(), this.providerId.getValue(), this.encounterRoleId.getValue(),
				this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged,
				this.voided.getValue(), this.dateVoided, this.voidedBy.getValue(), this.voidReason.getValue(),
				this.uuid };
		return params;
	}
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.encounterProviderId.getValue(), this.encounterId.getValue(),
				this.providerId.getValue(), this.encounterRoleId.getValue(), this.creator.getValue(), this.dateCreated,
				this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.dateVoided,
				this.voidedBy.getValue(), this.voidReason.getValue(), this.uuid };
		return params;
	}
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.encounterProviderId.getValue(), this.encounterId.getValue(),
				this.providerId.getValue(), this.encounterRoleId.getValue(), this.creator.getValue(), this.dateCreated,
				this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.dateVoided,
				this.voidedBy.getValue(), this.voidReason.getValue(), this.uuid, this.encounterProviderId.getValue() };
		return params;
	}
	...
	public String generateInsertValuesWithoutObjectId() {
		return "" + (this.encounterId.getValue()) + "," + (this.providerId.getValue()) + ","
				+ (this.encounterRoleId.getValue()) + "," + (this.creator.getValue()) + ","
	...
	public String generateInsertValuesWithObjectId() {
		return "" + (this.encounterProviderId.getValue()) + "," + (this.encounterId.getValue()) + ","
				+ (this.providerId.getValue()) + "," + (this.encounterRoleId.getValue()) + ","
