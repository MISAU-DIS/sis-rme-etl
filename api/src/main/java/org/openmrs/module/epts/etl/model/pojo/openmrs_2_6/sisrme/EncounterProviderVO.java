...
public class EncounterProviderVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	private Field encounterProviderId = Field.fastCreateWithType("encounter_provider_id", "INT");
	...
	public void setEncounterProviderId(Field encounterProviderId){ 
	 	this.encounterProviderId = encounterProviderId;
	}

	public void setEncounterProviderIdValue(Integer value){ 
		this.encounterProviderId.setValue(value);
	}
 
	public Field getEncounterProviderId(){ 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String encounterProviderIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "encounter_provider_id", "_" );

		this.encounterProviderId.setValue(BaseVO.retrieveFieldValue(encounterProviderIdAttName, "INT", rs));
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.encounterId.getValue(), this.providerId.getValue(), this.encounterRoleId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.dateVoided, this.voidedBy.getValue(), this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.encounterProviderId.getValue(), this.encounterId.getValue(), this.providerId.getValue(), this.encounterRoleId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.dateVoided, this.voidedBy.getValue(), this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterProviderId.getValue(), this.encounterId.getValue(), this.providerId.getValue(), this.encounterRoleId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.dateVoided, this.voidedBy.getValue(), this.voidReason.getValue(), this.uuid, this.encounterProviderId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE encounter_provider SET `encounter_provider_id` = ?, `encounter_id` = ?, `provider_id` = ?, `encounter_role_id` = ?, `creator` = ?, `date_created` = ?, `changed_by` = ?, `date_changed` = ?, `voided` = ?, `date_voided` = ?, `voided_by` = ?, `void_reason` = ?, `uuid` = ? WHERE incricao_on_demand_encounter_provider_dst_ds.encounter_provider_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.encounterId.getValue()) + "," + (this.providerId.getValue()) + "," + (this.encounterRoleId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.encounterProviderId.getValue()) + "," + (this.encounterId.getValue()) + "," + (this.providerId.getValue()) + "," + (this.encounterRoleId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof EncounterProviderVO){
	    	EncounterProviderVO toCopyFromAsEncounterProviderVO = (EncounterProviderVO)toCopyFrom;

			this.encounterProviderId = copyGeneratedField(toCopyFromAsEncounterProviderVO.encounterProviderId);
			this.encounterId = copyGeneratedField(toCopyFromAsEncounterProviderVO.encounterId);
			this.providerId = copyGeneratedField(toCopyFromAsEncounterProviderVO.providerId);
			this.encounterRoleId = copyGeneratedField(toCopyFromAsEncounterProviderVO.encounterRoleId);
			this.creator = copyGeneratedField(toCopyFromAsEncounterProviderVO.creator);
			this.dateCreated = toCopyFromAsEncounterProviderVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsEncounterProviderVO.changedBy);
			this.dateChanged = toCopyFromAsEncounterProviderVO.dateChanged;
			this.voided = copyGeneratedField(toCopyFromAsEncounterProviderVO.voided);
			this.dateVoided = toCopyFromAsEncounterProviderVO.dateVoided;
			this.voidedBy = copyGeneratedField(toCopyFromAsEncounterProviderVO.voidedBy);
			this.voidReason = copyGeneratedField(toCopyFromAsEncounterProviderVO.voidReason);
	...
	public boolean hasParents() {
		...
		if (this.providerId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		...
		if (parentAttName.equals("providerId")) return this.providerId.getValue();		
