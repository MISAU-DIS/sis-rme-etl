...
public class OrderTypeVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.uuid = AttDefinedElements.removeStrangeCharactersOnString(rs.getString(uuidAttName) != null ? rs.getString(uuidAttName).trim() : null);
			...
			String javaClassNameAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "java_class_name", "_" );

		this.javaClassName.setValue(BaseVO.retrieveFieldValue(javaClassNameAttName, "VARCHAR", rs));

			String parentAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "parent", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.javaClassName.getValue(), this.parent.getValue(), this.changedBy.getValue(), this.dateChanged};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.orderTypeId.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.javaClassName.getValue(), this.parent.getValue(), this.changedBy.getValue(), this.dateChanged};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.orderTypeId.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.javaClassName.getValue(), this.parent.getValue(), this.changedBy.getValue(), this.dateChanged, this.orderTypeId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE order_type SET `order_type_id` = ?, `name` = ?, `description` = ?, `creator` = ?, `date_created` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `uuid` = ?, `java_class_name` = ?, `parent` = ?, `changed_by` = ?, `date_changed` = ? WHERE order_type_2.order_type_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.javaClassName.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.javaClassName.getValue().toString())  +"\"" : null) + "," + (this.parent.getValue()) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.orderTypeId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.javaClassName.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.javaClassName.getValue().toString())  +"\"" : null) + "," + (this.parent.getValue()) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof OrderTypeVO){
	    	OrderTypeVO toCopyFromAsOrderTypeVO = (OrderTypeVO)toCopyFrom;

			this.orderTypeId = copyGeneratedField(toCopyFromAsOrderTypeVO.orderTypeId);
			this.name = copyGeneratedField(toCopyFromAsOrderTypeVO.name);
			this.description = copyGeneratedField(toCopyFromAsOrderTypeVO.description);
			this.creator = copyGeneratedField(toCopyFromAsOrderTypeVO.creator);
			this.dateCreated = toCopyFromAsOrderTypeVO.dateCreated;
			this.retired = copyGeneratedField(toCopyFromAsOrderTypeVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsOrderTypeVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsOrderTypeVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsOrderTypeVO.retireReason);
			this.uuid = toCopyFromAsOrderTypeVO.uuid;
			this.javaClassName = copyGeneratedField(toCopyFromAsOrderTypeVO.javaClassName);
			this.parent = copyGeneratedField(toCopyFromAsOrderTypeVO.parent);
			this.changedBy = copyGeneratedField(toCopyFromAsOrderTypeVO.changedBy);
	...
	public boolean hasParents() {
		if (this.parent.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("parent")) return this.parent.getValue();		
