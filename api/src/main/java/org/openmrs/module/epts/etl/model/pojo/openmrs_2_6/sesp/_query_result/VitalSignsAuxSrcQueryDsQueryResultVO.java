...
public class VitalSignsAuxSrcQueryDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	private EtlDatabaseObjectConfiguration relatedConfiguration;

	public VitalSignsAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	}
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO vital_signs_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom) {
		if (toCopyFrom instanceof VitalSignsAuxSrcQueryDsQueryResultVO) {
			VitalSignsAuxSrcQueryDsQueryResultVO toCopyFromAsVitalSignsAuxSrcQueryDsQueryResultVO = (VitalSignsAuxSrcQueryDsQueryResultVO) toCopyFrom;
	...
	public String generateTableName() {
		return "vital_signs_aux_src_query_ds";
	}
