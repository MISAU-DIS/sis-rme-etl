...
public class LabResultAuxSrcQueryDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	private Field value = Field.fastCreateWithType("value", "BIGINT");
 
	private EtlDatabaseObjectConfiguration relatedConfiguration;

	public LabResultAuxSrcQueryDsQueryResultVO() { 
		this.metadata = false;
	} 
...
String valueAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value", "_" );
	...
	public String getInsertSQLWithoutObjectId(){ 
 		return "INSERT INTO lab_result_aux_src_query_ds(`value`) VALUES( ?);"; 
	} 
	...
	public EtlDatabaseObject createACopy(){ 
 		LabResultAuxSrcQueryDsQueryResultVO copy = new LabResultAuxSrcQueryDsQueryResultVO();
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof LabResultAuxSrcQueryDsQueryResultVO){
	    	LabResultAuxSrcQueryDsQueryResultVO toCopyFromAsLabResultAuxSrcQueryDsQueryResultVO = (LabResultAuxSrcQueryDsQueryResultVO)toCopyFrom;
	...
	public String generateTableName() {
		return "lab_result_aux_src_query_ds";
	}
