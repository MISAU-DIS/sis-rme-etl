...
public class LocationVO extends AbstractGeneratedDatabaseObject {
	...
	public LocationVO() {
		...
		this.fields.add(this.locationTypeConceptId);
	}
	...
	public void setFieldValue(String fieldName, Object value) {
		...
		if (utilities.equalsFieldsName(fieldName, "parent_location")) {
			this.parentLocation.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "changed_by")) {
		...
		if (utilities.equalsFieldsName(fieldName, "location_type_concept_id")) {
			this.locationTypeConceptId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
	...
	public void load(ResultSet rs) throws SQLException {
		...
		String locationTypeConceptIdAttName = utilities
				.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "location_type_concept_id", "_");
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.name.getValue(), this.description.getValue(), this.address1.getValue(),
				...
				this.locationTypeConceptId.getValue() };
		return params;
	}
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.locationId.getValue(), this.name.getValue(), this.description.getValue(),
				...
				this.address15.getValue(), this.locationTypeConceptId.getValue() };
		return params;
	}
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.locationId.getValue(), this.name.getValue(), this.description.getValue(),
				...
				this.address9.getValue(), this.address10.getValue(), this.address11.getValue(),
				this.address12.getValue(), this.address13.getValue(), this.address14.getValue(),
				this.address15.getValue(), this.locationTypeConceptId.getValue(), this.locationId.getValue() };
		return params;
	}
