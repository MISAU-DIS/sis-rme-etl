...
public class LocationVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void setLocationTypeConceptId(Field locationTypeConceptId){ 
	 	this.locationTypeConceptId = locationTypeConceptId;
	}

	public void setLocationTypeConceptIdValue(Integer value){ 
		this.locationTypeConceptId.setValue(value);
	}


 
	public Field getLocationTypeConceptId(){ 
		return this.locationTypeConceptId;
	}
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.description.setValue(BaseVO.retrieveFieldValue(descriptionAttName, "VARCHAR", rs));
			...
			String address1AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address1", "_" );

		this.address1.setValue(BaseVO.retrieveFieldValue(address1AttName, "VARCHAR", rs));

			String address2AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address2", "_" );

		this.address2.setValue(BaseVO.retrieveFieldValue(address2AttName, "VARCHAR", rs));

			String cityVillageAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "city_village", "_" );

		this.cityVillage.setValue(BaseVO.retrieveFieldValue(cityVillageAttName, "VARCHAR", rs));

			String stateProvinceAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "state_province", "_" );

		this.stateProvince.setValue(BaseVO.retrieveFieldValue(stateProvinceAttName, "VARCHAR", rs));

			String postalCodeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "postal_code", "_" );

		this.postalCode.setValue(BaseVO.retrieveFieldValue(postalCodeAttName, "VARCHAR", rs));

			String countryAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "country", "_" );

		this.country.setValue(BaseVO.retrieveFieldValue(countryAttName, "VARCHAR", rs));

			String latitudeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "latitude", "_" );

		this.latitude.setValue(BaseVO.retrieveFieldValue(latitudeAttName, "VARCHAR", rs));

			String longitudeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "longitude", "_" );
		...
		this.dateCreated =  rs.getTimestamp(dateCreatedAttName) != null ? new java.util.Date( rs.getTimestamp(dateCreatedAttName).getTime() ) : null;
			...
			String countyDistrictAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "county_district", "_" );

		this.countyDistrict.setValue(BaseVO.retrieveFieldValue(countyDistrictAttName, "VARCHAR", rs));

			String address3AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address3", "_" );

		this.address3.setValue(BaseVO.retrieveFieldValue(address3AttName, "VARCHAR", rs));

			String address6AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address6", "_" );

		this.address6.setValue(BaseVO.retrieveFieldValue(address6AttName, "VARCHAR", rs));

			String address5AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address5", "_" );

		this.address5.setValue(BaseVO.retrieveFieldValue(address5AttName, "VARCHAR", rs));

			String address4AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address4", "_" );
		...
		this.dateRetired.setValue(BaseVO.retrieveFieldValue(dateRetiredAttName, "DATETIME", rs));
			...
			String retireReasonAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "retire_reason", "_" );

		this.retireReason.setValue(BaseVO.retrieveFieldValue(retireReasonAttName, "VARCHAR", rs));

			String parentLocationAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "parent_location", "_" );
		...
		this.dateChanged =  rs.getTimestamp(dateChangedAttName) != null ? new java.util.Date( rs.getTimestamp(dateChangedAttName).getTime() ) : null;
			...
			String address7AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address7", "_" );

		this.address7.setValue(BaseVO.retrieveFieldValue(address7AttName, "VARCHAR", rs));

			String address8AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address8", "_" );

		this.address8.setValue(BaseVO.retrieveFieldValue(address8AttName, "VARCHAR", rs));

			String address9AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address9", "_" );

		this.address9.setValue(BaseVO.retrieveFieldValue(address9AttName, "VARCHAR", rs));

			String address10AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address10", "_" );

		this.address10.setValue(BaseVO.retrieveFieldValue(address10AttName, "VARCHAR", rs));

			String address11AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address11", "_" );

		this.address11.setValue(BaseVO.retrieveFieldValue(address11AttName, "VARCHAR", rs));

			String address12AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address12", "_" );

		this.address12.setValue(BaseVO.retrieveFieldValue(address12AttName, "VARCHAR", rs));

			String address13AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address13", "_" );

		this.address13.setValue(BaseVO.retrieveFieldValue(address13AttName, "VARCHAR", rs));

			String address14AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address14", "_" );

		this.address14.setValue(BaseVO.retrieveFieldValue(address14AttName, "VARCHAR", rs));

			String address15AttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "address15", "_" );

		this.address15.setValue(BaseVO.retrieveFieldValue(address15AttName, "VARCHAR", rs));

	String locationTypeConceptIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "location_type_concept_id", "_" );

		this.locationTypeConceptId.setValue(BaseVO.retrieveFieldValue(locationTypeConceptIdAttName, "INT", rs));
	} 
 
	@JsonIgnore
	@Override
	public String getInsertSQLWithoutObjectId(){ 
 		return "INSERT INTO location(`name`, `description`, `address1`, `address2`, `city_village`, `state_province`, `postal_code`, `country`, `latitude`, `longitude`, `creator`, `date_created`, `county_district`, `address3`, `address6`, `address5`, `address4`, `retired`, `retired_by`, `date_retired`, `retire_reason`, `parent_location`, `uuid`, `changed_by`, `date_changed`, `address7`, `address8`, `address9`, `address10`, `address11`, `address12`, `address13`, `address14`, `address15`, `location_type_concept_id`) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.name.getValue(), this.description.getValue(), this.address1.getValue(), this.address2.getValue(), this.cityVillage.getValue(), this.stateProvince.getValue(), this.postalCode.getValue(), this.country.getValue(), this.latitude.getValue(), this.longitude.getValue(), this.creator.getValue(), this.dateCreated, this.countyDistrict.getValue(), this.address3.getValue(), this.address6.getValue(), this.address5.getValue(), this.address4.getValue(), this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.parentLocation.getValue(), this.uuid, this.changedBy.getValue(), this.dateChanged, this.address7.getValue(), this.address8.getValue(), this.address9.getValue(), this.address10.getValue(), this.address11.getValue(), this.address12.getValue(), this.address13.getValue(), this.address14.getValue(), this.address15.getValue(), this.locationTypeConceptId.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.locationId.getValue(), this.name.getValue(), this.description.getValue(), this.address1.getValue(), this.address2.getValue(), this.cityVillage.getValue(), this.stateProvince.getValue(), this.postalCode.getValue(), this.country.getValue(), this.latitude.getValue(), this.longitude.getValue(), this.creator.getValue(), this.dateCreated, this.countyDistrict.getValue(), this.address3.getValue(), this.address6.getValue(), this.address5.getValue(), this.address4.getValue(), this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.parentLocation.getValue(), this.uuid, this.changedBy.getValue(), this.dateChanged, this.address7.getValue(), this.address8.getValue(), this.address9.getValue(), this.address10.getValue(), this.address11.getValue(), this.address12.getValue(), this.address13.getValue(), this.address14.getValue(), this.address15.getValue(), this.locationTypeConceptId.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.locationId.getValue(), this.name.getValue(), this.description.getValue(), this.address1.getValue(), this.address2.getValue(), this.cityVillage.getValue(), this.stateProvince.getValue(), this.postalCode.getValue(), this.country.getValue(), this.latitude.getValue(), this.longitude.getValue(), this.creator.getValue(), this.dateCreated, this.countyDistrict.getValue(), this.address3.getValue(), this.address6.getValue(), this.address5.getValue(), this.address4.getValue(), this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.parentLocation.getValue(), this.uuid, this.changedBy.getValue(), this.dateChanged, this.address7.getValue(), this.address8.getValue(), this.address9.getValue(), this.address10.getValue(), this.address11.getValue(), this.address12.getValue(), this.address13.getValue(), this.address14.getValue(), this.address15.getValue(), this.locationTypeConceptId.getValue(), this.locationId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE location SET `location_id` = ?, `name` = ?, `description` = ?, `address1` = ?, `address2` = ?, `city_village` = ?, `state_province` = ?, `postal_code` = ?, `country` = ?, `latitude` = ?, `longitude` = ?, `creator` = ?, `date_created` = ?, `county_district` = ?, `address3` = ?, `address6` = ?, `address5` = ?, `address4` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `parent_location` = ?, `uuid` = ?, `changed_by` = ?, `date_changed` = ?, `address7` = ?, `address8` = ?, `address9` = ?, `address10` = ?, `address11` = ?, `address12` = ?, `address13` = ?, `address14` = ?, `address15` = ?, `location_type_concept_id` = ? WHERE location_6.location_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.address1.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address1.getValue().toString())  +"\"" : null) + "," + (this.address2.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address2.getValue().toString())  +"\"" : null) + "," + (this.cityVillage.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.cityVillage.getValue().toString())  +"\"" : null) + "," + (this.stateProvince.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.stateProvince.getValue().toString())  +"\"" : null) + "," + (this.postalCode.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.postalCode.getValue().toString())  +"\"" : null) + "," + (this.country.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.country.getValue().toString())  +"\"" : null) + "," + (this.latitude.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.latitude.getValue().toString())  +"\"" : null) + "," + (this.longitude.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.longitude.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.countyDistrict.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.countyDistrict.getValue().toString())  +"\"" : null) + "," + (this.address3.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address3.getValue().toString())  +"\"" : null) + "," + (this.address6.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address6.getValue().toString())  +"\"" : null) + "," + (this.address5.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address5.getValue().toString())  +"\"" : null) + "," + (this.address4.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address4.getValue().toString())  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.parentLocation.getValue()) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.address7.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address7.getValue().toString())  +"\"" : null) + "," + (this.address8.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address8.getValue().toString())  +"\"" : null) + "," + (this.address9.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address9.getValue().toString())  +"\"" : null) + "," + (this.address10.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address10.getValue().toString())  +"\"" : null) + "," + (this.address11.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address11.getValue().toString())  +"\"" : null) + "," + (this.address12.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address12.getValue().toString())  +"\"" : null) + "," + (this.address13.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address13.getValue().toString())  +"\"" : null) + "," + (this.address14.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address14.getValue().toString())  +"\"" : null) + "," + (this.address15.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address15.getValue().toString())  +"\"" : null) + "," + (this.locationTypeConceptId.getValue()); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.locationId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.address1.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address1.getValue().toString())  +"\"" : null) + "," + (this.address2.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address2.getValue().toString())  +"\"" : null) + "," + (this.cityVillage.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.cityVillage.getValue().toString())  +"\"" : null) + "," + (this.stateProvince.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.stateProvince.getValue().toString())  +"\"" : null) + "," + (this.postalCode.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.postalCode.getValue().toString())  +"\"" : null) + "," + (this.country.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.country.getValue().toString())  +"\"" : null) + "," + (this.latitude.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.latitude.getValue().toString())  +"\"" : null) + "," + (this.longitude.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.longitude.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.countyDistrict.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.countyDistrict.getValue().toString())  +"\"" : null) + "," + (this.address3.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address3.getValue().toString())  +"\"" : null) + "," + (this.address6.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address6.getValue().toString())  +"\"" : null) + "," + (this.address5.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address5.getValue().toString())  +"\"" : null) + "," + (this.address4.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address4.getValue().toString())  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.parentLocation.getValue()) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.address7.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address7.getValue().toString())  +"\"" : null) + "," + (this.address8.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address8.getValue().toString())  +"\"" : null) + "," + (this.address9.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address9.getValue().toString())  +"\"" : null) + "," + (this.address10.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address10.getValue().toString())  +"\"" : null) + "," + (this.address11.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address11.getValue().toString())  +"\"" : null) + "," + (this.address12.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address12.getValue().toString())  +"\"" : null) + "," + (this.address13.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address13.getValue().toString())  +"\"" : null) + "," + (this.address14.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address14.getValue().toString())  +"\"" : null) + "," + (this.address15.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.address15.getValue().toString())  +"\"" : null) + "," + (this.locationTypeConceptId.getValue()); 
	} 
	...
	public EtlDatabaseObject createACopy(){ 
		...
		copy.address15 = copyGeneratedField(this.address15);
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof LocationVO){
	    	LocationVO toCopyFromAsLocationVO = (LocationVO)toCopyFrom;

			this.locationId = copyGeneratedField(toCopyFromAsLocationVO.locationId);
			this.name = copyGeneratedField(toCopyFromAsLocationVO.name);
			this.description = copyGeneratedField(toCopyFromAsLocationVO.description);
			this.address1 = copyGeneratedField(toCopyFromAsLocationVO.address1);
			this.address2 = copyGeneratedField(toCopyFromAsLocationVO.address2);
			this.cityVillage = copyGeneratedField(toCopyFromAsLocationVO.cityVillage);
			this.stateProvince = copyGeneratedField(toCopyFromAsLocationVO.stateProvince);
			this.postalCode = copyGeneratedField(toCopyFromAsLocationVO.postalCode);
			this.country = copyGeneratedField(toCopyFromAsLocationVO.country);
			this.latitude = copyGeneratedField(toCopyFromAsLocationVO.latitude);
			this.longitude = copyGeneratedField(toCopyFromAsLocationVO.longitude);
			this.creator = copyGeneratedField(toCopyFromAsLocationVO.creator);
			this.dateCreated = toCopyFromAsLocationVO.dateCreated;
			this.countyDistrict = copyGeneratedField(toCopyFromAsLocationVO.countyDistrict);
			this.address3 = copyGeneratedField(toCopyFromAsLocationVO.address3);
			this.address6 = copyGeneratedField(toCopyFromAsLocationVO.address6);
			this.address5 = copyGeneratedField(toCopyFromAsLocationVO.address5);
			this.address4 = copyGeneratedField(toCopyFromAsLocationVO.address4);
			this.retired = copyGeneratedField(toCopyFromAsLocationVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsLocationVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsLocationVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsLocationVO.retireReason);
			this.parentLocation = copyGeneratedField(toCopyFromAsLocationVO.parentLocation);
			this.uuid = toCopyFromAsLocationVO.uuid;
			this.changedBy = copyGeneratedField(toCopyFromAsLocationVO.changedBy);
			this.dateChanged = toCopyFromAsLocationVO.dateChanged;
			this.address7 = copyGeneratedField(toCopyFromAsLocationVO.address7);
			this.address8 = copyGeneratedField(toCopyFromAsLocationVO.address8);
			this.address9 = copyGeneratedField(toCopyFromAsLocationVO.address9);
			this.address10 = copyGeneratedField(toCopyFromAsLocationVO.address10);
			this.address11 = copyGeneratedField(toCopyFromAsLocationVO.address11);
			this.address12 = copyGeneratedField(toCopyFromAsLocationVO.address12);
			this.address13 = copyGeneratedField(toCopyFromAsLocationVO.address13);
			this.address14 = copyGeneratedField(toCopyFromAsLocationVO.address14);
			this.address15 = copyGeneratedField(toCopyFromAsLocationVO.address15);
	...
	public boolean hasParents() {
		if (this.parentLocation.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("parentLocation")) return this.parentLocation.getValue();		
