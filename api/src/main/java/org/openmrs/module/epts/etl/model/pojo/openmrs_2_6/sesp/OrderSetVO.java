...
public class OrderSetVO extends AbstractGeneratedDatabaseObject {
	...
	public void setFieldValue(String fieldName, Object value) {
		...
		if (utilities.equalsFieldsName(fieldName, "operator")) {
			this.operator.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "name")) {
		...
		if (utilities.equalsFieldsName(fieldName, "category")) {
			this.category.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
	...
	public void loadWithDefaultValues(Connection srcConn, Connection dstConn) throws DBException {
		...
		loadGeneratedFieldWithDefaultValue(this.operator, srcConn, dstConn);
		...
		loadGeneratedFieldWithDefaultValue(this.category, srcConn, dstConn);
	}
