...
public class OrderSetVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		this.orderSetId.setValue(BaseVO.retrieveFieldValue(orderSetIdAttName, "INT", rs));
			...
			String operatorAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "operator", "_" );
	...
	String categoryAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "category", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.operator.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid, this.category.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.orderSetId.getValue(), this.operator.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid, this.category.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.orderSetId.getValue(), this.operator.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid, this.category.getValue(), this.orderSetId.getValue()};
		return params; 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof OrderSetVO){
	    	OrderSetVO toCopyFromAsOrderSetVO = (OrderSetVO)toCopyFrom;

			this.orderSetId = copyGeneratedField(toCopyFromAsOrderSetVO.orderSetId);
			this.operator = copyGeneratedField(toCopyFromAsOrderSetVO.operator);
			this.name = copyGeneratedField(toCopyFromAsOrderSetVO.name);
			this.description = copyGeneratedField(toCopyFromAsOrderSetVO.description);
			this.creator = copyGeneratedField(toCopyFromAsOrderSetVO.creator);
			this.dateCreated = toCopyFromAsOrderSetVO.dateCreated;
			this.retired = copyGeneratedField(toCopyFromAsOrderSetVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsOrderSetVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsOrderSetVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsOrderSetVO.retireReason);
			this.changedBy = copyGeneratedField(toCopyFromAsOrderSetVO.changedBy);
			this.dateChanged = toCopyFromAsOrderSetVO.dateChanged;
			this.uuid = toCopyFromAsOrderSetVO.uuid;
	...
	public boolean hasParents() {
		if (this.category.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("category")) return this.category.getValue();		
