...
public class RapidTestAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public RapidTestAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO rapid_test_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		RapidTestAuxSrcQueryDsQueryResultVO copy = new RapidTestAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "rapid_test_aux_src_query_ds";
	}
