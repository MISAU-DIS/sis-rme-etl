...
public class ConditionsAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public ConditionsAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO conditions_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		ConditionsAuxSrcQueryDsQueryResultVO copy = new ConditionsAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "conditions_aux_src_query_ds";
	}
