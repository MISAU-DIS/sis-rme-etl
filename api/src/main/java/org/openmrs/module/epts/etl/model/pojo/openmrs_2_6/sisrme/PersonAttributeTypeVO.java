...
public class PersonAttributeTypeVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String personAttributeTypeIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "person_attribute_type_id", "_" );
		...
		this.description.setValue(BaseVO.retrieveFieldValue(descriptionAttName, "TEXT", rs));
			...
			String formatAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "format", "_" );

		this.format.setValue(BaseVO.retrieveFieldValue(formatAttName, "VARCHAR", rs));

			String foreignKeyAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "foreign_key", "_" );

		this.foreignKey.setValue(BaseVO.retrieveFieldValue(foreignKeyAttName, "INT", rs));

			String searchableAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "searchable", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.name.getValue(), this.description.getValue(), this.format.getValue(), this.foreignKey.getValue(), this.searchable.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.editPrivilege.getValue(), this.uuid, this.sortWeight.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.personAttributeTypeId.getValue(), this.name.getValue(), this.description.getValue(), this.format.getValue(), this.foreignKey.getValue(), this.searchable.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.editPrivilege.getValue(), this.uuid, this.sortWeight.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.personAttributeTypeId.getValue(), this.name.getValue(), this.description.getValue(), this.format.getValue(), this.foreignKey.getValue(), this.searchable.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.editPrivilege.getValue(), this.uuid, this.sortWeight.getValue(), this.personAttributeTypeId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE person_attribute_type SET `person_attribute_type_id` = ?, `name` = ?, `description` = ?, `format` = ?, `foreign_key` = ?, `searchable` = ?, `creator` = ?, `date_created` = ?, `changed_by` = ?, `date_changed` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `edit_privilege` = ?, `uuid` = ?, `sort_weight` = ? WHERE person_attribute_type_1.person_attribute_type_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.format.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.format.getValue().toString())  +"\"" : null) + "," + (this.foreignKey.getValue()) + "," + (this.searchable.getValue() != null ? "\""+this.searchable.getValue()+"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.editPrivilege.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.editPrivilege.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.sortWeight.getValue()); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.personAttributeTypeId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.format.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.format.getValue().toString())  +"\"" : null) + "," + (this.foreignKey.getValue()) + "," + (this.searchable.getValue() != null ? "\""+this.searchable.getValue()+"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.editPrivilege.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.editPrivilege.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.sortWeight.getValue()); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PersonAttributeTypeVO){
	    	PersonAttributeTypeVO toCopyFromAsPersonAttributeTypeVO = (PersonAttributeTypeVO)toCopyFrom;

			this.personAttributeTypeId = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.personAttributeTypeId);
			this.name = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.name);
			this.description = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.description);
			this.format = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.format);
			this.foreignKey = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.foreignKey);
			this.searchable = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.searchable);
			this.creator = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.creator);
			this.dateCreated = toCopyFromAsPersonAttributeTypeVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.changedBy);
			this.dateChanged = toCopyFromAsPersonAttributeTypeVO.dateChanged;
			this.retired = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.retireReason);
			this.editPrivilege = copyGeneratedField(toCopyFromAsPersonAttributeTypeVO.editPrivilege);
			this.uuid = toCopyFromAsPersonAttributeTypeVO.uuid;
