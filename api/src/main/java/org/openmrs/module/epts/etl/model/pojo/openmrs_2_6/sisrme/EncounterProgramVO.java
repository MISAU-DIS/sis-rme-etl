...
public class EncounterProgramVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.programId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.encounterId.getValue(), this.programId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterId.getValue(), this.programId.getValue(), this.creator.getValue(), this.dateCreated, this.changedBy.getValue(), this.dateChanged, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.encounterId.getValue()};
		return params; 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof EncounterProgramVO){
	    	EncounterProgramVO toCopyFromAsEncounterProgramVO = (EncounterProgramVO)toCopyFrom;

			this.encounterId = copyGeneratedField(toCopyFromAsEncounterProgramVO.encounterId);
			this.programId = copyGeneratedField(toCopyFromAsEncounterProgramVO.programId);
			this.creator = copyGeneratedField(toCopyFromAsEncounterProgramVO.creator);
			this.dateCreated = toCopyFromAsEncounterProgramVO.dateCreated;
			this.changedBy = copyGeneratedField(toCopyFromAsEncounterProgramVO.changedBy);
			this.dateChanged = toCopyFromAsEncounterProgramVO.dateChanged;
			this.voided = copyGeneratedField(toCopyFromAsEncounterProgramVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsEncounterProgramVO.voidedBy);
			this.dateVoided = toCopyFromAsEncounterProgramVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsEncounterProgramVO.voidReason);
