...
public class TbConditionAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public TbConditionAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO tb_condition_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		TbConditionAuxSrcQueryDsQueryResultVO copy = new TbConditionAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "tb_condition_aux_src_query_ds";
	}
