...
public class PharmacyBatchVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		String expiryDateAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "expiry_date", "_" );
		...
		String balanceAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "balance", "_" );
...
String uuidAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "uuid", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.drugId.getValue(), this.batchNumber.getValue(), this.expiryDate.getValue(), this.quantity.getValue(), this.balance.getValue(), this.locationId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.batchId.getValue(), this.drugId.getValue(), this.batchNumber.getValue(), this.expiryDate.getValue(), this.quantity.getValue(), this.balance.getValue(), this.locationId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.batchId.getValue(), this.drugId.getValue(), this.batchNumber.getValue(), this.expiryDate.getValue(), this.quantity.getValue(), this.balance.getValue(), this.locationId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid, this.batchId.getValue()};
		return params; 
	} 
	...
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.drugId.getValue()) + "," + (this.batchNumber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.batchNumber.getValue().toString())  +"\"" : null) + "," + (this.expiryDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.expiryDate.getValue())  +"\"" : null) + "," + (this.quantity.getValue()) + "," + (this.balance.getValue()) + "," + (this.locationId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.batchId.getValue()) + "," + (this.drugId.getValue()) + "," + (this.batchNumber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.batchNumber.getValue().toString())  +"\"" : null) + "," + (this.expiryDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.expiryDate.getValue())  +"\"" : null) + "," + (this.quantity.getValue()) + "," + (this.balance.getValue()) + "," + (this.locationId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PharmacyBatchVO){
	    	PharmacyBatchVO toCopyFromAsPharmacyBatchVO = (PharmacyBatchVO)toCopyFrom;

			this.batchId = copyGeneratedField(toCopyFromAsPharmacyBatchVO.batchId);
			this.drugId = copyGeneratedField(toCopyFromAsPharmacyBatchVO.drugId);
			this.batchNumber = copyGeneratedField(toCopyFromAsPharmacyBatchVO.batchNumber);
			this.expiryDate = copyGeneratedField(toCopyFromAsPharmacyBatchVO.expiryDate);
			this.quantity = copyGeneratedField(toCopyFromAsPharmacyBatchVO.quantity);
			this.balance = copyGeneratedField(toCopyFromAsPharmacyBatchVO.balance);
			this.locationId = copyGeneratedField(toCopyFromAsPharmacyBatchVO.locationId);
			this.creator = copyGeneratedField(toCopyFromAsPharmacyBatchVO.creator);
			this.dateCreated = toCopyFromAsPharmacyBatchVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsPharmacyBatchVO.voided);
			this.voidReason = copyGeneratedField(toCopyFromAsPharmacyBatchVO.voidReason);
			this.voidedBy = copyGeneratedField(toCopyFromAsPharmacyBatchVO.voidedBy);
	...
	public boolean hasParents() {
		if (this.drugId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("drugId")) return this.drugId.getValue();		
