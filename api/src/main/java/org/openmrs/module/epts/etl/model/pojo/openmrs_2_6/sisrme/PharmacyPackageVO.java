...
public class PharmacyPackageVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		String prescriptionEncounterIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "prescription_encounter_id", "_" );

		this.prescriptionEncounterId.setValue(BaseVO.retrieveFieldValue(prescriptionEncounterIdAttName, "INT", rs));

		String packageDatetimeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "package_datetime", "_" );
		...
		String dispenseModeIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "dispense_mode_id", "_" );
...
String uuidAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "uuid", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.locationId.getValue(), this.prescriptionEncounterId.getValue(), this.packageDatetime.getValue(), this.nextPickupDate.getValue(), this.dispenseModeId.getValue(), this.notes.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.pharmacyPackageId.getValue(), this.locationId.getValue(), this.prescriptionEncounterId.getValue(), this.packageDatetime.getValue(), this.nextPickupDate.getValue(), this.dispenseModeId.getValue(), this.notes.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.pharmacyPackageId.getValue(), this.locationId.getValue(), this.prescriptionEncounterId.getValue(), this.packageDatetime.getValue(), this.nextPickupDate.getValue(), this.dispenseModeId.getValue(), this.notes.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid, this.pharmacyPackageId.getValue()};
		return params; 
	} 
	...
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.locationId.getValue()) + "," + (this.prescriptionEncounterId.getValue()) + "," + (this.packageDatetime.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.packageDatetime.getValue())  +"\"" : null) + "," + (this.nextPickupDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.nextPickupDate.getValue())  +"\"" : null) + "," + (this.dispenseModeId.getValue()) + "," + (this.notes.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.notes.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.pharmacyPackageId.getValue()) + "," + (this.locationId.getValue()) + "," + (this.prescriptionEncounterId.getValue()) + "," + (this.packageDatetime.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.packageDatetime.getValue())  +"\"" : null) + "," + (this.nextPickupDate.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.nextPickupDate.getValue())  +"\"" : null) + "," + (this.dispenseModeId.getValue()) + "," + (this.notes.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.notes.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PharmacyPackageVO){
	    	PharmacyPackageVO toCopyFromAsPharmacyPackageVO = (PharmacyPackageVO)toCopyFrom;

			this.pharmacyPackageId = copyGeneratedField(toCopyFromAsPharmacyPackageVO.pharmacyPackageId);
			this.locationId = copyGeneratedField(toCopyFromAsPharmacyPackageVO.locationId);
			this.prescriptionEncounterId = copyGeneratedField(toCopyFromAsPharmacyPackageVO.prescriptionEncounterId);
			this.packageDatetime = copyGeneratedField(toCopyFromAsPharmacyPackageVO.packageDatetime);
			this.nextPickupDate = copyGeneratedField(toCopyFromAsPharmacyPackageVO.nextPickupDate);
			this.dispenseModeId = copyGeneratedField(toCopyFromAsPharmacyPackageVO.dispenseModeId);
			this.notes = copyGeneratedField(toCopyFromAsPharmacyPackageVO.notes);
			this.creator = copyGeneratedField(toCopyFromAsPharmacyPackageVO.creator);
			this.dateCreated = toCopyFromAsPharmacyPackageVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsPharmacyPackageVO.voided);
			this.voidReason = copyGeneratedField(toCopyFromAsPharmacyPackageVO.voidReason);
			this.voidedBy = copyGeneratedField(toCopyFromAsPharmacyPackageVO.voidedBy);
	...
	public boolean hasParents() {
		if (this.prescriptionEncounterId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("prescriptionEncounterId")) return this.prescriptionEncounterId.getValue();		
