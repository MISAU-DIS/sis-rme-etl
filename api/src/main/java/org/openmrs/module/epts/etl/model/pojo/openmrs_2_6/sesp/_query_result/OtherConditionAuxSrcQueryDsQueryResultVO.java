...
public class OtherConditionAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public OtherConditionAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO other_condition_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		OtherConditionAuxSrcQueryDsQueryResultVO copy = new OtherConditionAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "other_condition_aux_src_query_ds";
	}
