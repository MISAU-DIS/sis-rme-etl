...
public class LabResultOnDemandAuxSrcQueryDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof LabResultOnDemandAuxSrcQueryDsQueryResultVO){
	    	LabResultOnDemandAuxSrcQueryDsQueryResultVO toCopyFromAsLabResultOnDemandAuxSrcQueryDsQueryResultVO = (LabResultOnDemandAuxSrcQueryDsQueryResultVO)toCopyFrom;
