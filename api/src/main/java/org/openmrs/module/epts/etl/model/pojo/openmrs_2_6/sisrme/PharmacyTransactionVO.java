...
public class PharmacyTransactionVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		...
		String pharmacyTransactionIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "pharmacy_transaction_id", "_" );

		this.pharmacyTransactionId.setValue(BaseVO.retrieveFieldValue(pharmacyTransactionIdAttName, "INT", rs));

		String batchIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "batch_id", "_" );

		this.batchId.setValue(BaseVO.retrieveFieldValue(batchIdAttName, "INT", rs));

		String transactionTypeIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "transaction_type_id", "_" );
		...
		String deliveryNoteIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "delivery_note_id", "_" );

		this.deliveryNoteId.setValue(BaseVO.retrieveFieldValue(deliveryNoteIdAttName, "INT", rs));

		String documentNumberAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "document_number", "_" );

		this.documentNumber.setValue(BaseVO.retrieveFieldValue(documentNumberAttName, "VARCHAR", rs));

		String notesAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "notes", "_" );

		this.notes.setValue(BaseVO.retrieveFieldValue(notesAttName, "TEXT", rs));

		String subscriberAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "subscriber", "_" );

		this.subscriber.setValue(BaseVO.retrieveFieldValue(subscriberAttName, "VARCHAR", rs));

		String originAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "origin", "_" );
...
String uuidAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "uuid", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.batchId.getValue(), this.transactionTypeId.getValue(), this.quantity.getValue(), this.deliveryNoteId.getValue(), this.documentNumber.getValue(), this.notes.getValue(), this.subscriber.getValue(), this.origin.getValue(), this.locationId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.pharmacyTransactionId.getValue(), this.batchId.getValue(), this.transactionTypeId.getValue(), this.quantity.getValue(), this.deliveryNoteId.getValue(), this.documentNumber.getValue(), this.notes.getValue(), this.subscriber.getValue(), this.origin.getValue(), this.locationId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.pharmacyTransactionId.getValue(), this.batchId.getValue(), this.transactionTypeId.getValue(), this.quantity.getValue(), this.deliveryNoteId.getValue(), this.documentNumber.getValue(), this.notes.getValue(), this.subscriber.getValue(), this.origin.getValue(), this.locationId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidReason.getValue(), this.voidedBy.getValue(), this.uuid, this.pharmacyTransactionId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE pharmacy_transaction SET `pharmacy_transaction_id` = ?, `batch_id` = ?, `transaction_type_id` = ?, `quantity` = ?, `delivery_note_id` = ?, `document_number` = ?, `notes` = ?, `subscriber` = ?, `origin` = ?, `location_id` = ?, `creator` = ?, `date_created` = ?, `voided` = ?, `void_reason` = ?, `voided_by` = ?, `uuid` = ? WHERE pharmacy_transaction_1.pharmacy_transaction_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.batchId.getValue()) + "," + (this.transactionTypeId.getValue()) + "," + (this.quantity.getValue()) + "," + (this.deliveryNoteId.getValue()) + "," + (this.documentNumber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.documentNumber.getValue().toString())  +"\"" : null) + "," + (this.notes.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.notes.getValue().toString())  +"\"" : null) + "," + (this.subscriber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.subscriber.getValue().toString())  +"\"" : null) + "," + (this.origin.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.origin.getValue().toString())  +"\"" : null) + "," + (this.locationId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.pharmacyTransactionId.getValue()) + "," + (this.batchId.getValue()) + "," + (this.transactionTypeId.getValue()) + "," + (this.quantity.getValue()) + "," + (this.deliveryNoteId.getValue()) + "," + (this.documentNumber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.documentNumber.getValue().toString())  +"\"" : null) + "," + (this.notes.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.notes.getValue().toString())  +"\"" : null) + "," + (this.subscriber.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.subscriber.getValue().toString())  +"\"" : null) + "," + (this.origin.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.origin.getValue().toString())  +"\"" : null) + "," + (this.locationId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public EtlDatabaseObject createACopy(){ 
		...
		copy.transactionTypeId = copyGeneratedField(this.transactionTypeId);
		copy.quantity = copyGeneratedField(this.quantity);
		copy.deliveryNoteId = copyGeneratedField(this.deliveryNoteId);
		copy.documentNumber = copyGeneratedField(this.documentNumber);
		copy.notes = copyGeneratedField(this.notes);
		copy.subscriber = copyGeneratedField(this.subscriber);
		copy.origin = copyGeneratedField(this.origin);
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PharmacyTransactionVO){
	    	PharmacyTransactionVO toCopyFromAsPharmacyTransactionVO = (PharmacyTransactionVO)toCopyFrom;

			this.pharmacyTransactionId = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.pharmacyTransactionId);
			this.batchId = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.batchId);
			this.transactionTypeId = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.transactionTypeId);
			this.quantity = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.quantity);
			this.deliveryNoteId = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.deliveryNoteId);
			this.documentNumber = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.documentNumber);
			this.notes = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.notes);
			this.subscriber = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.subscriber);
			this.origin = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.origin);
			this.locationId = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.locationId);
			this.creator = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.creator);
			this.dateCreated = toCopyFromAsPharmacyTransactionVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.voided);
			this.voidReason = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.voidReason);
			this.voidedBy = copyGeneratedField(toCopyFromAsPharmacyTransactionVO.voidedBy);
	...
	public boolean hasParents() {
		...
		if (this.batchId.getValue() != null) return true;

		if (this.deliveryNoteId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		...
		if (parentAttName.equals("batchId")) return this.batchId.getValue();		
		if (parentAttName.equals("deliveryNoteId")) return this.deliveryNoteId.getValue();		
