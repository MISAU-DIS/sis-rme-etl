...
public class PharmacyTransactionVO extends AbstractGeneratedDatabaseObject {
	...
	public void setFieldValue(String fieldName, Object value) {
		...
		if (utilities.equalsFieldsName(fieldName, "batch_id")) {
			this.batchId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "transaction_type_id")) {
			this.transactionTypeId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "quantity")) {
		...
		if (utilities.equalsFieldsName(fieldName, "delivery_note_id")) {
			this.deliveryNoteId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "document_number")) {
			this.documentNumber.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "notes")) {
		...
		if (utilities.equalsFieldsName(fieldName, "subscriber")) {
			this.subscriber.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "origin")) {
			this.origin.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "location_id")) {
	...
	public void loadWithDefaultValues(Connection srcConn, Connection dstConn) throws DBException {
		...
		loadGeneratedFieldWithDefaultValue(this.transactionTypeId, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.quantity, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.deliveryNoteId, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.documentNumber, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.notes, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.subscriber, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.origin, srcConn, dstConn);
