...
public class FichaClinicaAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public FichaClinicaAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO ficha_clinica_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		FichaClinicaAuxSrcQueryDsQueryResultVO copy = new FichaClinicaAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "ficha_clinica_aux_src_query_ds";
	}
