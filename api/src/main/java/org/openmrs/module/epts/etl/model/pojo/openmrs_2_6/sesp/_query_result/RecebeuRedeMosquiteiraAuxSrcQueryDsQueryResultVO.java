...
public class RecebeuRedeMosquiteiraAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public RecebeuRedeMosquiteiraAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO recebeu_rede_mosquiteira_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		RecebeuRedeMosquiteiraAuxSrcQueryDsQueryResultVO copy = new RecebeuRedeMosquiteiraAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "recebeu_rede_mosquiteira_aux_src_query_ds";
	}
