...
public class AgregadoFamiliarAdultosAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public AgregadoFamiliarAdultosAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO agregado_familiar_adultos_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		AgregadoFamiliarAdultosAuxSrcQueryDsQueryResultVO copy = new AgregadoFamiliarAdultosAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "agregado_familiar_adultos_aux_src_query_ds";
	}
