...
public class PatientProgramLocationDstDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field locationId = Field.fastCreateWithType("location_id", "null");

	public PatientProgramLocationDstDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO patient_program_location_dst_ds(`location_id`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		PatientProgramLocationDstDsQueryResultVO copy = new PatientProgramLocationDstDsQueryResultVO();
	...
	public String generateTableName() {
		return "patient_program_location_dst_ds";
	}
