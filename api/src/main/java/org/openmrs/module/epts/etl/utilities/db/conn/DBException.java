...
public class DBException extends SQLException implements EtlException {
	...
	public static final int ORACLE_CHECK_CONSTRAINT_VIOLATION = 2290;
	...
	public static final int MYSQL_CHECK_CONSTRAINT_VIOLATION = 3819;
	...
	public DBException(String errorMessage, SQLException e) {
		...
		/*
		 * if (this.SQLCodeError == 0) { throw new
		 * ForbiddenOperationException("The SQLCodeError could not be zero", e); }
		 */
	}
	...
	/**
	 * Determina se o erro foi causado pela tentativa de duplicação de dados num
	 * campo chave ATENCAO: Este método é limitado, apenas retorna resultados se a
	 * base de dados for ORACLE, MYSQL, POSTGRES ou SQL Server
	 * 
	...
	public boolean isInconsistentDataException() {
		if (this.dataBaseName == null || this.dataBaseName.isEmpty())
			throw new ForbiddenOperationException(
					"Impossivel determinar o tipo de erro pois o nome da base de dados nao foi definido");
