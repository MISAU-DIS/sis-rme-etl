...
public class Cd4FromFichaClinicaOnDemandAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public Cd4FromFichaClinicaOnDemandAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO cd4_from_ficha_clinica_on_demand_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		Cd4FromFichaClinicaOnDemandAuxSrcQueryDsQueryResultVO copy = new Cd4FromFichaClinicaOnDemandAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "cd4_from_ficha_clinica_on_demand_aux_src_query_ds";
	}
