...
public class Cd4FromFichaClinicaOrderObsSrcDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	...
	public Cd4FromFichaClinicaOrderObsSrcDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO cd4_from_ficha_clinica_order_obs_src_ds(`concept_id`, `value_coded`, `obs_datetime`) VALUES( ?, ?, ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		Cd4FromFichaClinicaOrderObsSrcDsQueryResultVO copy = new Cd4FromFichaClinicaOrderObsSrcDsQueryResultVO();
	...
	public String generateTableName() {
		return "cd4_from_ficha_clinica_order_obs_src_ds";
	}
