...
public class EncounterTypeVO extends AbstractGeneratedDatabaseObject {
	...
	public void setFieldValue(String fieldName, Object value) {
		if (utilities.equalsFieldsName(fieldName, "encounter_type_id")) {
			this.encounterTypeId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
		...
		if (utilities.equalsFieldsName(fieldName, "view_privilege")) {
			this.viewPrivilege.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "edit_privilege")) {
		...
		if (utilities.equalsFieldsName(fieldName, "handler_class")) {
			this.handlerClass.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
	...
	public void loadWithDefaultValues(Connection srcConn, Connection dstConn) throws DBException {
		...
		loadGeneratedFieldWithDefaultValue(this.encounterTypeId, srcConn, dstConn);
