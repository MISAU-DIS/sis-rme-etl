...
public class EncounterTypeVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String encounterTypeIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "encounter_type_id", "_" );
		...
		this.uuid = AttDefinedElements.removeStrangeCharactersOnString(rs.getString(uuidAttName) != null ? rs.getString(uuidAttName).trim() : null);
			...
			String viewPrivilegeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "view_privilege", "_" );

		this.viewPrivilege.setValue(BaseVO.retrieveFieldValue(viewPrivilegeAttName, "VARCHAR", rs));

			String editPrivilegeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "edit_privilege", "_" );
	...
	String handlerClassAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "handler_class", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.viewPrivilege.getValue(), this.editPrivilege.getValue(), this.changedBy.getValue(), this.dateChanged, this.handlerClass.getValue()};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.encounterTypeId.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.viewPrivilege.getValue(), this.editPrivilege.getValue(), this.changedBy.getValue(), this.dateChanged, this.handlerClass.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterTypeId.getValue(), this.name.getValue(), this.description.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.uuid, this.viewPrivilege.getValue(), this.editPrivilege.getValue(), this.changedBy.getValue(), this.dateChanged, this.handlerClass.getValue(), this.encounterTypeId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE encounter_type SET `encounter_type_id` = ?, `name` = ?, `description` = ?, `creator` = ?, `date_created` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `uuid` = ?, `view_privilege` = ?, `edit_privilege` = ?, `changed_by` = ?, `date_changed` = ?, `handler_class` = ? WHERE encounter_type_6.encounter_type_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.viewPrivilege.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.viewPrivilege.getValue().toString())  +"\"" : null) + "," + (this.editPrivilege.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.editPrivilege.getValue().toString())  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.handlerClass.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.handlerClass.getValue().toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.encounterTypeId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null) + "," + (this.viewPrivilege.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.viewPrivilege.getValue().toString())  +"\"" : null) + "," + (this.editPrivilege.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.editPrivilege.getValue().toString())  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.handlerClass.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.handlerClass.getValue().toString())  +"\"" : null); 
	} 
	...
	public EtlDatabaseObject createACopy(){ 
		...
		copy.encounterTypeId = copyGeneratedField(this.encounterTypeId);
		...
		copy.uuid = this.uuid;
		copy.viewPrivilege = copyGeneratedField(this.viewPrivilege);
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof EncounterTypeVO){
	    	EncounterTypeVO toCopyFromAsEncounterTypeVO = (EncounterTypeVO)toCopyFrom;

			this.encounterTypeId = copyGeneratedField(toCopyFromAsEncounterTypeVO.encounterTypeId);
			this.name = copyGeneratedField(toCopyFromAsEncounterTypeVO.name);
			this.description = copyGeneratedField(toCopyFromAsEncounterTypeVO.description);
			this.creator = copyGeneratedField(toCopyFromAsEncounterTypeVO.creator);
			this.dateCreated = toCopyFromAsEncounterTypeVO.dateCreated;
			this.retired = copyGeneratedField(toCopyFromAsEncounterTypeVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsEncounterTypeVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsEncounterTypeVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsEncounterTypeVO.retireReason);
			this.uuid = toCopyFromAsEncounterTypeVO.uuid;
			this.viewPrivilege = copyGeneratedField(toCopyFromAsEncounterTypeVO.viewPrivilege);
			this.editPrivilege = copyGeneratedField(toCopyFromAsEncounterTypeVO.editPrivilege);
			this.changedBy = copyGeneratedField(toCopyFromAsEncounterTypeVO.changedBy);
			this.dateChanged = toCopyFromAsEncounterTypeVO.dateChanged;
	...
	public boolean hasParents() {
		if (this.editPrivilege.getValue() != null) return true;

		if (this.viewPrivilege.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("editPrivilege")) return this.editPrivilege.getValue();		
		if (parentAttName.equals("viewPrivilege")) return this.viewPrivilege.getValue();		
