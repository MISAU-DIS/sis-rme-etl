...
public class SyncJSONInfo {
	...
	public SyncJSONInfo(String tableName, List<EtlDatabaseObject> syncRecords, String recordOriginLocationCode,
		...
		/*
		 * this.qtyRecords = utilities.arraySize(syncRecords); this.syncInfo =
		 * EtlStageRecordVO.generateFromSyncRecord(syncRecords,
		 * recordOriginLocationCode, generateRecordJSON); this.dateGenerated =
		 * DateAndTimeUtilities.getCurrentDate(); this.originAppLocationCode =
		 * recordOriginLocationCode; this.tableName = tableName;
		 */
	}
	...
	public static SyncJSONInfo generate(String tableName, List<EtlDatabaseObject> syncRecords,
		...
		SyncJSONInfo syncJSONInfo = new SyncJSONInfo(tableName, syncRecords, recordOriginLocationCode,
				generateRecordJSON);
