...
public class OrderFrequencyVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	private Field orderFrequencyId = Field.fastCreateWithType("order_frequency_id", "INT");
	private Field conceptId = Field.fastCreateWithType("concept_id", "INT");
	private Field frequencyPerDay = Field.fastCreateWithType("frequency_per_day", "DOUBLE");
	...
	public void setOrderFrequencyId(Field orderFrequencyId){ 
	 	this.orderFrequencyId = orderFrequencyId;
	}

	public void setOrderFrequencyIdValue(Integer value){ 
		this.orderFrequencyId.setValue(value);
	}
 
	public Field getOrderFrequencyId(){ 
	...
	public void setFrequencyPerDay(Field frequencyPerDay){ 
	 	this.frequencyPerDay = frequencyPerDay;
	}

	public void setFrequencyPerDayValue(Double value){ 
		this.frequencyPerDay.setValue(value);
	}
 
	public Field getFrequencyPerDay(){ 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String orderFrequencyIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "order_frequency_id", "_" );

		this.orderFrequencyId.setValue(BaseVO.retrieveFieldValue(orderFrequencyIdAttName, "INT", rs));
		...
		this.conceptId.setValue(BaseVO.retrieveFieldValue(conceptIdAttName, "INT", rs));
			...
			String frequencyPerDayAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "frequency_per_day", "_" );

		this.frequencyPerDay.setValue(BaseVO.retrieveFieldValue(frequencyPerDayAttName, "DOUBLE", rs));
	...
	public String getInsertSQLWithObjectId(){ 
 		return "INSERT INTO order_frequency(`order_frequency_id`, `concept_id`, `frequency_per_day`, `creator`, `date_created`, `retired`, `retired_by`, `date_retired`, `retire_reason`, `changed_by`, `date_changed`, `uuid`) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	@Override
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.conceptId.getValue(), this.frequencyPerDay.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.orderFrequencyId.getValue(), this.conceptId.getValue(), this.frequencyPerDay.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.orderFrequencyId.getValue(), this.conceptId.getValue(), this.frequencyPerDay.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid, this.orderFrequencyId.getValue()};
		return params; 
	} 
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof OrderFrequencyVO){
	    	OrderFrequencyVO toCopyFromAsOrderFrequencyVO = (OrderFrequencyVO)toCopyFrom;

			this.orderFrequencyId = copyGeneratedField(toCopyFromAsOrderFrequencyVO.orderFrequencyId);
			this.conceptId = copyGeneratedField(toCopyFromAsOrderFrequencyVO.conceptId);
			this.frequencyPerDay = copyGeneratedField(toCopyFromAsOrderFrequencyVO.frequencyPerDay);
			this.creator = copyGeneratedField(toCopyFromAsOrderFrequencyVO.creator);
			this.dateCreated = toCopyFromAsOrderFrequencyVO.dateCreated;
			this.retired = copyGeneratedField(toCopyFromAsOrderFrequencyVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsOrderFrequencyVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsOrderFrequencyVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsOrderFrequencyVO.retireReason);
			this.changedBy = copyGeneratedField(toCopyFromAsOrderFrequencyVO.changedBy);
			this.dateChanged = toCopyFromAsOrderFrequencyVO.dateChanged;
