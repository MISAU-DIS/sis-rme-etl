...
public class OrderFrequencyVO extends AbstractGeneratedDatabaseObject {
	...
	public OrderFrequencyVO() {
		this.metadata = true;
		this.fields.add(this.orderFrequencyId);
		this.fields.add(this.conceptId);
		this.fields.add(this.frequencyPerDay);
	...
	public void tryToReplaceFieldValueWithKeyValue(Key k) {
		if (utilities.equalsFieldsName(k.getName(), "order_frequency_id")) {
			this.orderFrequencyId.setValue(k.getValue());
		}
	}

	@Override
	public Object getFieldValue(String fieldName) {
		if (utilities.equalsFieldsName(fieldName, "order_frequency_id")) {
			return this.orderFrequencyId.getValue();
		}
		if (utilities.equalsFieldsName(fieldName, "concept_id")) {
			return this.conceptId.getValue();
		}
		if (utilities.equalsFieldsName(fieldName, "frequency_per_day")) {
			return this.frequencyPerDay.getValue();
		}
	...
	public void setFieldValue(String fieldName, Object value) {
		if (utilities.equalsFieldsName(fieldName, "order_frequency_id")) {
			this.orderFrequencyId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
		...
		if (utilities.equalsFieldsName(fieldName, "frequency_per_day")) {
			this.frequencyPerDay.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "creator")) {
	...
	public void loadWithDefaultValues(Connection srcConn, Connection dstConn) throws DBException {
		...
		loadGeneratedFieldWithDefaultValue(this.orderFrequencyId, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.conceptId, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.frequencyPerDay, srcConn, dstConn);
	...
	public void load(ResultSet rs) throws SQLException {
		...
		String orderFrequencyIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(),
				"order_frequency_id", "_");
		...
		String frequencyPerDayAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(),
				"frequency_per_day", "_");
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.conceptId.getValue(), this.frequencyPerDay.getValue(), this.creator.getValue(),
				this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(),
				this.retireReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid };
		return params;
	}
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.orderFrequencyId.getValue(), this.conceptId.getValue(),
				this.frequencyPerDay.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(),
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.orderFrequencyId.getValue(), this.conceptId.getValue(),
				this.frequencyPerDay.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(),
				this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(),
				this.changedBy.getValue(), this.dateChanged, this.uuid, this.orderFrequencyId.getValue() };
		return params;
	}
	...
	public String generateInsertValuesWithoutObjectId() {
		return "" + (this.conceptId.getValue()) + "," + (this.frequencyPerDay.getValue()) + ","
	...
	public String generateInsertValuesWithObjectId() {
		return "" + (this.orderFrequencyId.getValue()) + "," + (this.conceptId.getValue()) + ","
				+ (this.frequencyPerDay.getValue()) + "," + (this.creator.getValue()) + ","
				+ (this.dateCreated != null
						? "\"" + DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated) + "\""
						: null)
				+ "," + (this.retired.getValue() != null ? "\"" + this.retired.getValue() + "\"" : null) + ","
