...
public class EncounterVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.encounterType.getValue(), this.patientId.getValue(), this.locationId.getValue(), this.encounterDatetime.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.changedBy.getValue(), this.dateChanged, this.visitId.getValue()};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.encounterId.getValue(), this.encounterType.getValue(), this.patientId.getValue(), this.locationId.getValue(), this.encounterDatetime.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.changedBy.getValue(), this.dateChanged, this.visitId.getValue(), this.encounterId.getValue()};
		return params; 
	} 
