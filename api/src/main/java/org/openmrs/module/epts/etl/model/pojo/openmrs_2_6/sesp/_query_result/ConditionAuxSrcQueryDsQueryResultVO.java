...
public class ConditionAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public ConditionAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO condition_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		ConditionAuxSrcQueryDsQueryResultVO copy = new ConditionAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "condition_aux_src_query_ds";
	}
