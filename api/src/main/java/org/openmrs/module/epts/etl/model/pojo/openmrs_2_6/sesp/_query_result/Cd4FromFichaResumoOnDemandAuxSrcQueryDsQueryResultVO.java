...
public class Cd4FromFichaResumoOnDemandAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public Cd4FromFichaResumoOnDemandAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO cd4_from_ficha_resumo_on_demand_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		Cd4FromFichaResumoOnDemandAuxSrcQueryDsQueryResultVO copy = new Cd4FromFichaResumoOnDemandAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "cd4_from_ficha_resumo_on_demand_aux_src_query_ds";
	}
