...
public class PersonComplexAttributeDetailVO extends AbstractGeneratedDatabaseObject {
	...
	public void setFieldValue(String fieldName, Object value) {
		if (utilities.equalsFieldsName(fieldName, "person_complex_attribute_detail_id")) {
			this.personComplexAttributeDetailId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
		...
		if (utilities.equalsFieldsName(fieldName, "attribute_key")) {
			this.attributeKey.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "attribute_value")) {
			this.attributeValue.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "creator")) {
