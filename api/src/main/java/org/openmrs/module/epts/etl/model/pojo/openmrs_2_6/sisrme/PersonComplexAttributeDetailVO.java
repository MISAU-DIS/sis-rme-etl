...
public class PersonComplexAttributeDetailVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	private Field personComplexAttributeDetailId = Field.fastCreateWithType("person_complex_attribute_detail_id", "BIGINT UNSIGNED");
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String personComplexAttributeDetailIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "person_complex_attribute_detail_id", "_" );

		this.personComplexAttributeDetailId.setValue(BaseVO.retrieveFieldValue(personComplexAttributeDetailIdAttName, "BIGINT UNSIGNED", rs));

			String personComplexAttributeIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "person_complex_attribute_id", "_" );

		this.personComplexAttributeId.setValue(BaseVO.retrieveFieldValue(personComplexAttributeIdAttName, "BIGINT UNSIGNED", rs));

			String attributeKeyAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "attribute_key", "_" );

		this.attributeKey.setValue(BaseVO.retrieveFieldValue(attributeKeyAttName, "VARCHAR", rs));

			String attributeValueAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "attribute_value", "_" );
	...
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.personComplexAttributeId.getValue(), this.attributeKey.getValue(), this.attributeValue.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.personComplexAttributeDetailId.getValue(), this.personComplexAttributeId.getValue(), this.attributeKey.getValue(), this.attributeValue.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.personComplexAttributeDetailId.getValue(), this.personComplexAttributeId.getValue(), this.attributeKey.getValue(), this.attributeValue.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.personComplexAttributeDetailId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE person_complex_attribute_detail SET `person_complex_attribute_detail_id` = ?, `person_complex_attribute_id` = ?, `attribute_key` = ?, `attribute_value` = ?, `creator` = ?, `date_created` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `uuid` = ? WHERE prep_target_group_concept_person_complex_attribute_detail_dst_ds.person_complex_attribute_detail_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.personComplexAttributeId.getValue()) + "," + (this.attributeKey.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.attributeKey.getValue().toString())  +"\"" : null) + "," + (this.attributeValue.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.attributeValue.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.personComplexAttributeDetailId.getValue()) + "," + (this.personComplexAttributeId.getValue()) + "," + (this.attributeKey.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.attributeKey.getValue().toString())  +"\"" : null) + "," + (this.attributeValue.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.attributeValue.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
	...
	public EtlDatabaseObject createACopy(){ 
		...
		copy.personComplexAttributeDetailId = copyGeneratedField(this.personComplexAttributeDetailId);
		copy.personComplexAttributeId = copyGeneratedField(this.personComplexAttributeId);
		copy.attributeKey = copyGeneratedField(this.attributeKey);
		copy.attributeValue = copyGeneratedField(this.attributeValue);
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PersonComplexAttributeDetailVO){
	    	PersonComplexAttributeDetailVO toCopyFromAsPersonComplexAttributeDetailVO = (PersonComplexAttributeDetailVO)toCopyFrom;

			this.personComplexAttributeDetailId = copyGeneratedField(toCopyFromAsPersonComplexAttributeDetailVO.personComplexAttributeDetailId);
			this.personComplexAttributeId = copyGeneratedField(toCopyFromAsPersonComplexAttributeDetailVO.personComplexAttributeId);
			this.attributeKey = copyGeneratedField(toCopyFromAsPersonComplexAttributeDetailVO.attributeKey);
			this.attributeValue = copyGeneratedField(toCopyFromAsPersonComplexAttributeDetailVO.attributeValue);
			this.creator = copyGeneratedField(toCopyFromAsPersonComplexAttributeDetailVO.creator);
			this.dateCreated = toCopyFromAsPersonComplexAttributeDetailVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsPersonComplexAttributeDetailVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsPersonComplexAttributeDetailVO.voidedBy);
			this.dateVoided = toCopyFromAsPersonComplexAttributeDetailVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsPersonComplexAttributeDetailVO.voidReason);
	...
	public boolean hasParents() {
		if (this.personComplexAttributeId.getValue() != null) return true;
	...
	public Object getParentValue(String parentAttName) {		
		if (parentAttName.equals("personComplexAttributeId")) return this.personComplexAttributeId.getValue();
