...
public class PrevencaoMulherGravidaAuxSrcQueryDsQueryResultVO extends AbstractGeneratedDatabaseObject {
	private Field value = Field.fastCreateWithType("value", "BIGINT");

	public PrevencaoMulherGravidaAuxSrcQueryDsQueryResultVO() {
		this.metadata = false;
	...
	public String getInsertSQLWithoutObjectId() {
		return "INSERT INTO prevencao_mulher_gravida_aux_src_query_ds(`value`) VALUES( ?);";
	}
	...
	public EtlDatabaseObject createACopy() {
		PrevencaoMulherGravidaAuxSrcQueryDsQueryResultVO copy = new PrevencaoMulherGravidaAuxSrcQueryDsQueryResultVO();
	...
	public String generateTableName() {
		return "prevencao_mulher_gravida_aux_src_query_ds";
	}
