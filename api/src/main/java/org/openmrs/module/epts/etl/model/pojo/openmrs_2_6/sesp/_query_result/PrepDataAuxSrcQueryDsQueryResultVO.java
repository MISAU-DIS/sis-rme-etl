...
public class PrepDataAuxSrcQueryDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
...
String valueAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "value", "_" );
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PrepDataAuxSrcQueryDsQueryResultVO){
	    	PrepDataAuxSrcQueryDsQueryResultVO toCopyFromAsPrepDataAuxSrcQueryDsQueryResultVO = (PrepDataAuxSrcQueryDsQueryResultVO)toCopyFrom;
