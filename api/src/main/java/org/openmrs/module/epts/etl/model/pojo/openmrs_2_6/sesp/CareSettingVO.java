...
public class CareSettingVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
	private Field careSettingId = Field.fastCreateWithType("care_setting_id", "INT");
	...
	private Field careSettingType = Field.fastCreateWithType("care_setting_type", "VARCHAR");
	...
	public void setCareSettingId(Field careSettingId){ 
	 	this.careSettingId = careSettingId;
	}

	public void setCareSettingIdValue(Integer value){ 
		this.careSettingId.setValue(value);
	}
 
	public Field getCareSettingId(){ 
	...
	public void setCareSettingType(Field careSettingType){ 
	 	this.careSettingType = careSettingType;
	}

	public void setCareSettingTypeValue(String value){ 
		this.careSettingType.setValue(value);
	}
 
	public Field getCareSettingType(){ 
	...
	public void load(ResultSet rs) throws SQLException{ 
		super.load(rs);
			...
			String careSettingIdAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "care_setting_id", "_" );

		this.careSettingId.setValue(BaseVO.retrieveFieldValue(careSettingIdAttName, "INT", rs));
		...
		this.description.setValue(BaseVO.retrieveFieldValue(descriptionAttName, "VARCHAR", rs));
			...
			String careSettingTypeAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "care_setting_type", "_" );

		this.careSettingType.setValue(BaseVO.retrieveFieldValue(careSettingTypeAttName, "VARCHAR", rs));
	...
	public String getInsertSQLWithObjectId(){ 
 		return "INSERT INTO care_setting(`care_setting_id`, `name`, `description`, `care_setting_type`, `creator`, `date_created`, `retired`, `retired_by`, `date_retired`, `retire_reason`, `changed_by`, `date_changed`, `uuid`) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	@Override
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.name.getValue(), this.description.getValue(), this.careSettingType.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.careSettingId.getValue(), this.name.getValue(), this.description.getValue(), this.careSettingType.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.careSettingId.getValue(), this.name.getValue(), this.description.getValue(), this.careSettingType.getValue(), this.creator.getValue(), this.dateCreated, this.retired.getValue(), this.retiredBy.getValue(), this.dateRetired.getValue(), this.retireReason.getValue(), this.changedBy.getValue(), this.dateChanged, this.uuid, this.careSettingId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE care_setting SET `care_setting_id` = ?, `name` = ?, `description` = ?, `care_setting_type` = ?, `creator` = ?, `date_created` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `changed_by` = ?, `date_changed` = ?, `uuid` = ? WHERE care_setting_1.care_setting_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.careSettingType.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.careSettingType.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.careSettingId.getValue()) + "," + (this.name.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.name.getValue().toString())  +"\"" : null) + "," + (this.description.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.description.getValue().toString())  +"\"" : null) + "," + (this.careSettingType.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.careSettingType.getValue().toString())  +"\"" : null) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.retired.getValue() != null ? "\""+this.retired.getValue()+"\"" : null) + "," + (this.retiredBy.getValue()) + "," + (this.dateRetired.getValue() != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateRetired.getValue())  +"\"" : null) + "," + (this.retireReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.retireReason.getValue().toString())  +"\"" : null) + "," + (this.changedBy.getValue()) + "," + (this.dateChanged != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateChanged)  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public EtlDatabaseObject createACopy(){ 
 		CareSettingVO copy = new CareSettingVO();

		copy.careSettingId = copyGeneratedField(this.careSettingId);
		copy.name = copyGeneratedField(this.name);
		copy.description = copyGeneratedField(this.description);
		copy.careSettingType = copyGeneratedField(this.careSettingType);
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof CareSettingVO){
	    	CareSettingVO toCopyFromAsCareSettingVO = (CareSettingVO)toCopyFrom;

			this.careSettingId = copyGeneratedField(toCopyFromAsCareSettingVO.careSettingId);
			this.name = copyGeneratedField(toCopyFromAsCareSettingVO.name);
			this.description = copyGeneratedField(toCopyFromAsCareSettingVO.description);
			this.careSettingType = copyGeneratedField(toCopyFromAsCareSettingVO.careSettingType);
			this.creator = copyGeneratedField(toCopyFromAsCareSettingVO.creator);
			this.dateCreated = toCopyFromAsCareSettingVO.dateCreated;
			this.retired = copyGeneratedField(toCopyFromAsCareSettingVO.retired);
			this.retiredBy = copyGeneratedField(toCopyFromAsCareSettingVO.retiredBy);
			this.dateRetired = copyGeneratedField(toCopyFromAsCareSettingVO.dateRetired);
			this.retireReason = copyGeneratedField(toCopyFromAsCareSettingVO.retireReason);
			this.changedBy = copyGeneratedField(toCopyFromAsCareSettingVO.changedBy);
			this.dateChanged = toCopyFromAsCareSettingVO.dateChanged;
