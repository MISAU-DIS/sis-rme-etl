...
public class ConceptDatatypeVO extends AbstractGeneratedDatabaseObject {
	...
	public String getUpdateSQL() {
		return "UPDATE concept_datatype SET `concept_datatype_id` = ?, `name` = ?, `hl7_abbreviation` = ?, `description` = ?, `creator` = ?, `date_created` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `uuid` = ? WHERE concept_datatype_20.concept_datatype_id = ? ";
	}
