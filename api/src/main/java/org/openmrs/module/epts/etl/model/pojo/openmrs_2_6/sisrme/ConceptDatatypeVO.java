...
public class ConceptDatatypeVO extends AbstractGeneratedDatabaseObject {
	...
	public void setFieldValue(String fieldName, Object value) {
		if (utilities.equalsFieldsName(fieldName, "concept_datatype_id")) {
			this.conceptDatatypeId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
		...
		if (utilities.equalsFieldsName(fieldName, "hl7_abbreviation")) {
			this.hl7Abbreviation.setValue(value instanceof Field ? ((Field) value).getValue() : value);
			regenerateObjectIdIfKeyField(fieldName);
			return;
		}
		if (utilities.equalsFieldsName(fieldName, "description")) {
	...
	public void loadWithDefaultValues(Connection srcConn, Connection dstConn) throws DBException {
		...
		loadGeneratedFieldWithDefaultValue(this.conceptDatatypeId, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.name, srcConn, dstConn);
		loadGeneratedFieldWithDefaultValue(this.hl7Abbreviation, srcConn, dstConn);
