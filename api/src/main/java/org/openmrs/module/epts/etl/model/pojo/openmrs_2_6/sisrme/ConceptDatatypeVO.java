...
public class ConceptDatatypeVO extends AbstractDatabaseObject implements EtlDatabaseObject {
	...
	public String getUpdateSQL() {
		return "UPDATE concept_datatype SET `concept_datatype_id` = ?, `name` = ?, `hl7_abbreviation` = ?, `description` = ?, `creator` = ?, `date_created` = ?, `retired` = ?, `retired_by` = ?, `date_retired` = ?, `retire_reason` = ?, `uuid` = ? WHERE concept_datatype_2.concept_datatype_id = ? ";
	}
