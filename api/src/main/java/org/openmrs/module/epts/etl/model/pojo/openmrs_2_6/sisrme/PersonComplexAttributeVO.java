...
public class PersonComplexAttributeVO extends AbstractGeneratedDatabaseObject {
	...
	public void tryToReplaceFieldValueWithKeyValue(Key k) {
		if (utilities.equalsFieldsName(k.getName(), "person_complex_attribute_id")) {
			this.personComplexAttributeId.setValue(k.getValue());
		}
	}
	...
	public void setFieldValue(String fieldName, Object value) {
		if (utilities.equalsFieldsName(fieldName, "person_complex_attribute_id")) {
			this.personComplexAttributeId.setValue(value instanceof Field ? ((Field) value).getValue() : value);
	...
	public Object[] getInsertParamsWithoutObjectId() {
		Object[] params = { this.personId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(),
	...
	public Object[] getInsertParamsWithObjectId() {
		Object[] params = { this.personComplexAttributeId.getValue(), this.personId.getValue(), this.creator.getValue(),
	...
	public Object[] getUpdateParams() {
		Object[] params = { this.personComplexAttributeId.getValue(), this.personId.getValue(), this.creator.getValue(),
				this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided,
				this.voidReason.getValue(), this.uuid, this.personComplexAttributeId.getValue() };
		return params;
	}
	...
	public String getUpdateSQL() {
		return "UPDATE person_complex_attribute SET `person_complex_attribute_id` = ?, `person_id` = ?, `creator` = ?, `date_created` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `uuid` = ? WHERE person_complex_attribute_id = ? ";
	}

	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId() {
		return "" + (this.personId.getValue()) + "," + (this.creator.getValue()) + ","
	...
	public String generateInsertValuesWithObjectId() {
		return "" + (this.personComplexAttributeId.getValue()) + "," + (this.personId.getValue()) + ","
