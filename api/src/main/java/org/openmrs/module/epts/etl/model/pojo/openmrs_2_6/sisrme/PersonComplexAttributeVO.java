...
public class PersonComplexAttributeVO extends AbstractDatabaseObject implements EtlDatabaseObject { 
...
String uuidAttName = utilities.concatStringsWithSeparator(this.getRelatedConfiguration().getAlias(), "uuid", "_" );
	...
	public String getInsertSQLWithoutObjectId(){ 
 		return "INSERT INTO person_complex_attribute(`person_id`, `creator`, `date_created`, `voided`, `voided_by`, `date_voided`, `void_reason`, `uuid`) VALUES( ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	@Override
	public String getInsertSQLWithObjectId(){ 
 		return "INSERT INTO person_complex_attribute(`person_complex_attribute_id`, `person_id`, `creator`, `date_created`, `voided`, `voided_by`, `date_voided`, `void_reason`, `uuid`) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?);"; 
	} 
 
	@JsonIgnore
	@Override
	public Object[]  getInsertParamsWithoutObjectId(){ 
 		Object[] params = {this.personId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getInsertParamsWithObjectId(){ 
 		Object[] params = {this.personComplexAttributeId.getValue(), this.personId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid};
		return params; 
	} 
	...
	public Object[]  getUpdateParams(){ 
 		Object[] params = {this.personComplexAttributeId.getValue(), this.personId.getValue(), this.creator.getValue(), this.dateCreated, this.voided.getValue(), this.voidedBy.getValue(), this.dateVoided, this.voidReason.getValue(), this.uuid, this.personComplexAttributeId.getValue()};
		return params; 
	} 
	...
	public String getUpdateSQL(){ 
 		return "UPDATE person_complex_attribute SET `person_complex_attribute_id` = ?, `person_id` = ?, `creator` = ?, `date_created` = ?, `voided` = ?, `voided_by` = ?, `date_voided` = ?, `void_reason` = ?, `uuid` = ? WHERE prep_key_pop_person_complex_attribute_dst_ds.person_complex_attribute_id = ? "; 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithoutObjectId(){ 
 		return ""+(this.personId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public String generateInsertValuesWithObjectId(){ 
 		return ""+(this.personComplexAttributeId.getValue()) + "," + (this.personId.getValue()) + "," + (this.creator.getValue()) + "," + (this.dateCreated != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateCreated)  +"\"" : null) + "," + (this.voided.getValue() != null ? "\""+this.voided.getValue()+"\"" : null) + "," + (this.voidedBy.getValue()) + "," + (this.dateVoided != null ? "\""+ DateAndTimeUtilities.formatToYYYYMMDD_HHMISS((java.util.Date) this.dateVoided)  +"\"" : null) + "," + (this.voidReason.getValue() != null ? "\""+ utilities.scapeQuotationMarks(this.voidReason.getValue().toString())  +"\"" : null) + "," + (this.uuid != null ? "\""+ utilities.scapeQuotationMarks(this.uuid.toString())  +"\"" : null); 
	} 
 
	@JsonIgnore
	@Override
	public EtlDatabaseObject createACopy(){ 
 		PersonComplexAttributeVO copy = new PersonComplexAttributeVO();
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom){ 
 		if (toCopyFrom instanceof PersonComplexAttributeVO){
	    	PersonComplexAttributeVO toCopyFromAsPersonComplexAttributeVO = (PersonComplexAttributeVO)toCopyFrom;

			this.personComplexAttributeId = copyGeneratedField(toCopyFromAsPersonComplexAttributeVO.personComplexAttributeId);
			this.personId = copyGeneratedField(toCopyFromAsPersonComplexAttributeVO.personId);
			this.creator = copyGeneratedField(toCopyFromAsPersonComplexAttributeVO.creator);
			this.dateCreated = toCopyFromAsPersonComplexAttributeVO.dateCreated;
			this.voided = copyGeneratedField(toCopyFromAsPersonComplexAttributeVO.voided);
			this.voidedBy = copyGeneratedField(toCopyFromAsPersonComplexAttributeVO.voidedBy);
			this.dateVoided = toCopyFromAsPersonComplexAttributeVO.dateVoided;
			this.voidReason = copyGeneratedField(toCopyFromAsPersonComplexAttributeVO.voidReason);
	...
	public String generateTableName() {
		return "person_complex_attribute";
	}
