...
public class VitalSignsSrcDsQueryResultVO extends AbstractDatabaseObject implements EtlDatabaseObject {
	...
	public void copyFrom(EtlDatabaseObject toCopyFrom) {
		if (toCopyFrom instanceof VitalSignsSrcDsQueryResultVO) {
			VitalSignsSrcDsQueryResultVO toCopyFromAsVitalSignsSrcDsQueryResultVO = (VitalSignsSrcDsQueryResultVO) toCopyFrom;

			this.temperature = copyGeneratedField(toCopyFromAsVitalSignsSrcDsQueryResultVO.temperature);
			this.bloodPressureSystolic = copyGeneratedField(
					toCopyFromAsVitalSignsSrcDsQueryResultVO.bloodPressureSystolic);
